...
2. resolve matching automations using `normative/execution/dependency-resolution.md`
...
Recovery outcome rule:

- in v1, the reconciler either restores the same executor or marks the run
  `abandoned`
- v1 does not transfer recovery ownership to a different executor
