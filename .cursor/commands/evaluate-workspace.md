...
Execute the workflow in `.harmony/orchestration/workflows/workspace/evaluate-workspace/`.
...
- **Workflow:** `.harmony/orchestration/workflows/workspace/evaluate-workspace/`
