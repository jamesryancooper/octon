...
```text
/use-skill research-synthesizer .scratch/projects/my-research/
```
...
```text
"synthesize my research in .scratch/projects/my-research/"
"consolidate findings from .scratch/projects/api-design/"
```
