# Harmony Agent and Assistant Standard

This document defines the **universal standard for agents and assistants** within the Harmony multi-agent architecture. It establishes portable, framework-agnostic definitions that work across any harness (Cursor, Claude Code, Codex, or custom implementations).

---

## Design Goals

The Harmony agent/assistant standard MUST be:
...
The Harmony architecture establishes a clear hierarchy:
...
```yaml
# .harmony/assistants/registry.yml
schema_version: "1.0"
...
```text
.cursor/agents/planner    → ../../.harmony/agents/planner
.claude/agents/planner    → ../../.harmony/agents/planner
.codex/agents/planner     → ../../.harmony/agents/planner

.cursor/assistants/reviewer  → ../../.harmony/assistants/reviewer
.claude/assistants/reviewer  → ../../.harmony/assistants/reviewer
```
...
| Benefit | Description |
|---------|-------------|
| Single source of truth | Definition lives in `.harmony/` |
...
| Resource | Location |
|----------|----------|
| Agent README | `.harmony/agents/README.md` |
| Agent Registry | `.harmony/agents/registry.yml` |
| Agent Template | `.harmony/agents/_template/agent.md` |
| Assistant README | `.harmony/assistants/README.md` |
| Assistant Registry | `.harmony/assistants/registry.yml` |
| Assistant Template | `.harmony/assistants/_template/assistant.md` |
| Primitives Overview | `.harmony/context/primitives.md` |
