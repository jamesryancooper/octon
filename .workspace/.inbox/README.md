...
|--------------|---------------|
| Persistent research/thinking | `.workspace/.scratch/` |
...
4. MOVE OUT  → Content goes to canonical home (often outside .workspace/)
5. CLEAN UP  → Delete processed items from .inbox/
```

**Key principle:** Items in `.inbox/` are **temporary**. They should eventually move out to their canonical locations, typically outside `.workspace/`.
...
| **Destination** | Usually outside `.workspace/` | Often `.workspace/context/` |

---

## See Also

- [`.workspace/.scratch/README.md`](../.scratch/README.md) — Persistent thinking space
- [`.workspace/START.md`](../START.md) — Boot sequence with visibility rules
- [`.workspace/workflows/promote-from-scratch.md`](../workflows/promote-from-scratch.md) — Publishing workflow
