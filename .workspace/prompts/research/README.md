...
Prompts for human-led research projects in `.scratch/projects/`.
...
- [Research Projects](../../../docs/architecture/workspaces/projects.md) — Full project documentation
- [Scratch Area](../../../docs/architecture/workspaces/scratch.md) — Human-led thinking space
