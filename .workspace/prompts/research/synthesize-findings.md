...
Use this prompt when you have accumulated research notes across multiple sessions and need to consolidate them into coherent insights. Best used mid-research or when preparing for promotion.

## Inputs

- **Project path:** Path to the research project (e.g., `.scratch/projects/auth-patterns/`)
