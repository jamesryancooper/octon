...
description: Ready research findings for promotion to agent-facing workspace locations.
access: human
---
...
Use this prompt when research is mature enough to promote findings to agent-facing workspace locations. Ensures findings are properly distilled and formatted for their destinations.

## Inputs

- **Project path:** Path to the research project
- **Promotion targets:** (Optional) Specific destinations, or derive from `project.md` Promotion Path
...
2. **Review promotion path**
   - Check the Promotion Path checklist in `project.md`
...
```markdown
## Promotion Preparation: [Project name]
...
**Source:** Research project: [project-slug]
```
...
The following stays in `.scratch/projects/[slug]/` for reference:
- Raw research notes
...
- [ ] Note destinations in registry "Promoted To" column
```
