...
description: Publish distilled insights from .scratch/ to agent-facing artifacts.
access: human
---

# Promote from Scratch

When thinking in `.scratch/` matures into actionable knowledge, use this workflow to promote insights to agent-facing locations.
...
Review `.scratch/` for content that is:
...
Mark promoted content in `.scratch/` to avoid re-promoting:
...
**Situation:** Human explored authentication approaches in `.scratch/research.md`

**Before (in `.scratch/research.md`):**
...
- [`.workspace/.scratch/README.md`](../.scratch/README.md) — Scratchpad purpose and rules
- [`.workspace/.inbox/README.md`](../.inbox/README.md) — Inbox staging
