...
into live Octon when they solve a real coordination problem that cannot be
...
- a future proposal asks to add `/.octon/framework/orchestration/runtime/campaigns/`
...
- `/.octon/framework/orchestration/runtime/campaigns/README.md`
- `/.octon/framework/orchestration/runtime/campaigns/manifest.yml`
- `/.octon/framework/orchestration/runtime/campaigns/registry.yml`
- `/.octon/framework/orchestration/runtime/campaigns/<campaign-id>/campaign.yml`
- `/.octon/framework/orchestration/runtime/campaigns/<campaign-id>/log.md`
- `/.octon/framework/orchestration/runtime/campaigns/_ops/scripts/validate-campaigns.sh`
...
- `/.octon/inputs/exploratory/plans/2026-03-10-orchestration-domain-phase9-completion-receipt.md`
...
validator coverage inside live `/.octon/framework/orchestration/` surfaces before
