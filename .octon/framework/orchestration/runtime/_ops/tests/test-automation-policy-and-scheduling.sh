...
EVENT_LAUNCH_SCRIPT=".octon/framework/orchestration/runtime/_ops/scripts/launch-automation-run.sh"
...
case_binding_failure_blocks_launch() {
  ...
  cat > "$fixture_root/.octon/framework/orchestration/runtime/automations/runtime-contract-drift-remediation/bindings.yml" <<'EOF'
event_to_param_map:
  target_path:
