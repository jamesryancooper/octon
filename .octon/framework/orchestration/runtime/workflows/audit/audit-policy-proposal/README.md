...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/audit/audit-policy-proposal`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/audit/audit-policy-proposal/workflow.yml`.
...
- `policy_proposal_workflow_summary` -> `/.octon/state/evidence/validation/analysis/{{date}}-audit-policy-proposal.md`: Top-level workflow summary for policy proposal validation
- `policy_proposal_workflow_bundle` -> `/.octon/state/evidence/runs/workflows/{{date}}-audit-policy-proposal-{{slug}}/`: Workflow bundle containing validation metadata and outputs
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/audit/audit-policy-proposal/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/audit/audit-policy-proposal/stages/`
