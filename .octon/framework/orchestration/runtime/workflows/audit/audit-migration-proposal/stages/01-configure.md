---
name: configure
title: Configure Migration Proposal Audit
description: Resolve target proposal, mode, bundle paths, and expected stage set.
---

# Step 1: Configure Migration Proposal Audit
...
- `summary_root` (optional, default `.octon/state/evidence/validation/analysis`)
- `bundle_root` (optional, default `.octon/state/evidence/runs/workflows`)
