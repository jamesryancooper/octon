...
Assess whether lifecycle, retention, lineage, and policy controls remain aligned with continuous operation.
...
- `.octon/state/evidence/validation/analysis/YYYY-MM-DD-data-governance-audit-<run-id>.md` (if run)
