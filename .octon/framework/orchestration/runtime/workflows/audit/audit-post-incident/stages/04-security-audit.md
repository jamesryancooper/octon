...
# Step 4: Run Security Compliance Audit

## Purpose

Assess whether control, access, and sensitive-data safeguards are sufficient after incident remediation.
...
- `.octon/state/evidence/validation/analysis/YYYY-MM-DD-security-compliance-audit-<run-id>.md` (if run)
