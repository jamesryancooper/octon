...
2. **Wait for completion:**
   ...
   The skill writes `.octon/state/evidence/validation/analysis/YYYY-MM-DD-freshness-and-supersession-audit.md`.
...
4. **Record outcome:**
   ...
   Report: .octon/state/evidence/validation/analysis/{{date}}-freshness-and-supersession-audit.md
...
- [ ] `.octon/state/evidence/validation/analysis/YYYY-MM-DD-freshness-and-supersession-audit.md` exists
