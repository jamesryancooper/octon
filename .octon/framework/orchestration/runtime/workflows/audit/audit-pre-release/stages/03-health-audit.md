...
2. **Wait for completion:**
   ...
   The skill writes `.octon/state/evidence/validation/analysis/YYYY-MM-DD-subsystem-health-audit.md`.
...
4. **Record outcome:**
   ...
   Report: .octon/state/evidence/validation/analysis/{{date}}-subsystem-health-audit.md
...
- [ ] `.octon/state/evidence/validation/analysis/YYYY-MM-DD-subsystem-health-audit.md` exists
