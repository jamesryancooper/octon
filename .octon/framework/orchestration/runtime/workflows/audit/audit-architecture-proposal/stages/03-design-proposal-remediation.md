...
title: Run Short-Mode Architecture Proposal Remediation
description: Execute the short-mode remediation prompt and capture package deltas.
---

# Step 3: Run Short-Mode Architecture Proposal Remediation
...
3. Update the target proposal directly when possible.
