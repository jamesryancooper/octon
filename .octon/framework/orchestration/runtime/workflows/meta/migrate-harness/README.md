...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/meta/migrate-harness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/meta/migrate-harness/workflow.yml`.
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/meta/migrate-harness/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/meta/migrate-harness/stages/`
