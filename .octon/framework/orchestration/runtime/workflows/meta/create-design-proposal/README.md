...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/meta/create-design-proposal`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/meta/create-design-proposal/workflow.yml`.

## Parameters

- `proposal_id` (text, required=true): Kebab-case design proposal id and directory name under .octon/inputs/exploratory/proposals/design/
...
- `create_design_proposal_workflow_summary` -> `../../../../../.octon/state/evidence/validation/{{date}}-create-design-proposal.md`: Top-level workflow summary with proposal identity, selected modules, validator outcome, and next steps
- `create_design_proposal_workflow_bundle` -> `../../../../../.octon/state/evidence/runs/workflows/{{date}}-create-design-proposal-{{proposal_id}}/`: Workflow execution bundle containing stage receipts, validation state, scaffold inventory, and validator evidence
- `create_design_proposal_validator_log` -> `../../../../../.octon/state/evidence/runs/workflows/{{date}}-create-design-proposal-{{proposal_id}}/standard-validator.log`: Captured stdout and stderr from the proposal validator stack
- `design_proposal_root` -> `../../../../../.octon/inputs/exploratory/proposals/design/{{proposal_id}}/`: Scaffolded standard-governed design proposal
- `proposal_manifest` -> `../../../../../.octon/inputs/exploratory/proposals/design/{{proposal_id}}/proposal.yml`: Root manifest for the scaffolded design proposal
- `design_proposal_manifest` -> `../../../../../.octon/inputs/exploratory/proposals/design/{{proposal_id}}/design-proposal.yml`: Subtype manifest for the scaffolded design proposal
...
- [ ] scaffolded proposal directory exists under .octon/inputs/exploratory/proposals/design/
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/meta/create-design-proposal/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/meta/create-design-proposal/stages/`
