...
1. Always include the core template:
   `.octon/framework/scaffolding/runtime/templates/design-proposal-core/`
2. Include exactly one class overlay:
   - `design-proposal-domain-runtime/`, or
   - `design-proposal-experience-product/`
...
5. Resolve the final `selected_modules` list recorded in `design-proposal.yml`.
