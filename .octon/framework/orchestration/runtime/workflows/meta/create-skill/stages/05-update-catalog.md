...
Update `.octon/instance/bootstrap/catalog.md` Skills section table:
...
|-------|----------|-------------|
| [<skill-id>](/.octon/framework/capabilities/runtime/skills/<group>/<skill-id>/SKILL.md) | `/<skill-id>` | [TODO: Description] |
```
