...
Add to `.octon/framework/capabilities/runtime/skills/manifest.yml` under `skills:` array:
...
Add to `.octon/framework/capabilities/runtime/skills/registry.yml` under `skills:` map:
