...
- Gap requirements from `.octon/instance/cognition/context/shared/workflow-gaps.md`
- Quality requirements from `.octon/instance/cognition/context/shared/workflow-quality.md`
...
6. **Check harness integration gaps (if access: human):**
   ```text
   If access is "human":
     - [ ] Command file exists in .octon/framework/capabilities/runtime/commands/ or .octon/framework/capabilities/runtime/commands/
