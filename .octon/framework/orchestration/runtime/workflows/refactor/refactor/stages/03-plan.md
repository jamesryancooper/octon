...
1. Create a todo item for each file requiring changes:
   ...
   - [ ] `.octon/instance/bootstrap/START.md` (4 occurrences)
   - [ ] `.octon/framework/orchestration/runtime/workflows/example.md` (1 occurrence)
...
- [ ] `.octon/framework/orchestration/runtime/workflows/promote-from-scratch.md` (rename + 3 changes)
- [ ] [... remaining files ...]
