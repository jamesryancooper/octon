---
id: "verify"
description: "Canonical verification stage for a pipeline."
---
...
Validate that the pipeline satisfied its done-gate checks.

## Inputs

- prior stage artifacts
- `done_gate` criteria from `workflow.yml`

## Stage Instructions

1. Evaluate each done-gate criterion.
2. Record pass/fail status.
3. Emit a final verification artifact.
...
- fail closed if any done-gate criterion is unmet
