...
AUDIT_SCRIPT=".octon/framework/orchestration/runtime/workflows/_ops/scripts/audit-workflow-system.sh"
VALIDATE_SCRIPT=".octon/framework/orchestration/runtime/workflows/_ops/scripts/validate-workflows.sh"
...
create_fixture_repo() {
  ...
  cp -R "$REPO_ROOT/.octon/framework/orchestration" "$fixture_root/.octon/"
  mkdir -p "$fixture_root/.octon/framework/cognition/runtime"
  cp -R "$REPO_ROOT/.octon/instance/cognition/context/shared" "$fixture_root/.octon/framework/cognition/runtime/"
  cp -R "$REPO_ROOT/.octon/instance/cognition/context/shared/audits" "$fixture_root/.octon/framework/cognition/runtime/"
  mkdir -p "$fixture_root/.octon/framework/assurance/runtime/_ops/scripts"
  cp "$REPO_ROOT/.octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh" \
    "$fixture_root/.octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh"
  mkdir -p "$fixture_root/.octon/state/evidence/validation/audits" "$fixture_root/.octon/generated/.tmp"
  cp "$REPO_ROOT/.octon/state/evidence/validation/audits/README.md" \
    "$fixture_root/.octon/state/evidence/validation/audits/README.md"
...
case_score_directory_workflow() {
  (
    cd "$REPO_ROOT"
    bash "$AUDIT_SCRIPT" --mode score-workflow --target ".octon/framework/orchestration/runtime/workflows/refactor/refactor/" \
...
case_score_single_file_workflow() {
  (
    cd "$REPO_ROOT"
    bash "$AUDIT_SCRIPT" --mode score-workflow --target ".octon/framework/orchestration/runtime/workflows/tasks/onboard-new-developer.md" \
...
case_duplicate_trigger_fails_validator() {
  ...
  local manifest="$fixture_root/.octon/framework/orchestration/runtime/workflows/manifest.yml"
  local tmp_file
...
case_missing_required_outcome_fails_scenario_pack() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  local workflow_file="$fixture_root/.octon/framework/orchestration/runtime/workflows/projects/create-project/README.md"
  local tmp_file
...
case_dependency_cycle_fails_validator() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  local registry="$fixture_root/.octon/framework/orchestration/runtime/workflows/registry.yml"
  yq -i '
...
case_execution_controls_boolean_is_allowed() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  local workflow="$fixture_root/.octon/framework/orchestration/runtime/workflows/meta/create-workflow/workflow.yml"
  yq -i '
...
case_legacy_authoring_guide_ref_fails_validator() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  local stage_file="$fixture_root/.octon/framework/orchestration/runtime/workflows/meta/create-workflow/stages/03-select-template.md"
...
case_capability_map_gap_is_reported() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  local capability_map="$fixture_root/.octon/framework/orchestration/governance/capability-map-v1.yml"
  ...
  grep -F "capability map is missing classification for 'create-workflow'" \
    "$fixture_root/.octon/generated/.tmp/workflow-system-audit/findings.yml"
}
...
case_full_mode_emits_bundle() {
  ...
  [[ -f "$fixture_root/.octon/state/evidence/validation/audits/$run_id/bundle.yml" ]]
  [[ -f "$fixture_root/.octon/state/evidence/validation/audits/$run_id/findings.yml" ]]
  [[ -f "$fixture_root/.octon/state/evidence/validation/audits/$run_id/scores.yml" ]]
  [[ -f "$fixture_root/.octon/state/evidence/validation/audits/$run_id/scenarios.yml" ]]
  [[ -f "$fixture_root/.octon/instance/cognition/context/shared/audits/$run_id/plan.md" ]]
  [[ -f "$fixture_root/.octon/instance/cognition/context/shared/audits/$run_id/evidence.md" ]]
}
