...
Manages evolution candidates, classification, simulations, labs, proposal compilation, amendment requests, promotion, recertification, rollback, retirement, and ledger inspection without self-authorization.

## Boundary

This note explains the product boundary for `self-evolution-runtime`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
