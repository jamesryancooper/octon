# Runtime Effective Publication and Capability Routing

## Purpose

Publishes freshness-checked generated-effective support matrices, pack routes, runtime route bundles, extension state, capability routing, host projections, locks, handles, and evidence receipts.

## Boundary

This note explains the product boundary for `runtime-effective-publication-and-routing`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
