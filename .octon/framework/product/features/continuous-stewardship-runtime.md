...
Runs stewardship programs, epochs, trigger observation, admission/idle/renewal decisions, ledgers, continuity, and evidence snapshots.

## Boundary

This note explains the product boundary for `continuous-stewardship-runtime`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
