# Workflow Statechart and Task Harness

## Purpose

Defines workflow statechart contracts, task-specific execution harness compilation, replay/idempotency/compensation posture, and workflow authority derivation checks.

## Boundary

This note explains the product boundary for `workflow-statechart-task-harness`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
