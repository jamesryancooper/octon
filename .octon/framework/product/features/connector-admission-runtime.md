...
Admits, validates, stages, quarantines, retires, and evidences connector operations without letting connectors bypass run authorization.

## Boundary

This note explains the product boundary for `connector-admission-runtime`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
