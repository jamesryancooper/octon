...
Declares and validates native runtime services, service manifests, schemas, independence boundaries, generated implementation metadata, and retained service run records.

## Boundary

This note explains the product boundary for `native-service-runtime-and-catalog`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
