# Mission Autonomy and Mission Plan Compiler

## Purpose

Manages mission-scoped autonomy windows, mission plans, continuation decisions, leases, budgets, queue slices, and run-contract candidate handoff.

## Boundary

This note explains the product boundary for `mission-autonomy-and-planning`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
