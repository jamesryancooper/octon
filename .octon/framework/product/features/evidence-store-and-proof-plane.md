...
Defines retained evidence-store, proof-plane completeness, executable proof bundles, evidence disclosure tiers, proof coverage reports, and negative controls for support and disclosure claims.

## Boundary

This note explains the product boundary for `evidence-store-and-proof-plane`. The machine-readable catalog entry remains navigation-only and does not mint runtime authority, support claims, generated-effective state, or retained execution evidence.
