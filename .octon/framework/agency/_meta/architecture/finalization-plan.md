...
description: Phased plan to finalize the .octon/framework/agency specification and architecture and integrate it across the harness.
---
...
Deliver a finalized agency subsystem for `.octon/framework/agency` that:
...
- `.octon/framework/agency/runtime/agents/registry.yml` (normalized)
- `.octon/framework/agency/runtime/assistants/registry.yml` (normalized)
- `.octon/framework/agency/runtime/teams/registry.yml` + team template/spec files
- migration/deprecation treatment for `.octon/framework/agency/subagents/`
...
1. Add `.octon/framework/agency/manifest.yml`.
...
1. Remove `.octon/framework/agency/subagents/` from active topology.
