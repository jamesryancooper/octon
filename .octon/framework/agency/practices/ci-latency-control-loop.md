...
- Shared policy: `.octon/framework/agency/practices/standards/ci-latency-policy.json`
- Shared wrapper: `.octon/framework/agency/_ops/scripts/ci/audit-ci-latency.sh`
