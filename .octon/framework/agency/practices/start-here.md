...
→ **CLI Documentation**: See `.octon/instance/bootstrap/catalog.md` for full command reference.
...
→ See [RISK-TIERS.md](/.octon/instance/cognition/context/shared/risk-tiers.md) for details.
...
| 2 | [RISK-TIERS.md](/.octon/instance/cognition/context/shared/risk-tiers.md) | 5 min | When to pay close attention |
...
→ See [/.octon/instance/cognition/context/shared/glossary.md](/.octon/instance/cognition/context/shared/glossary.md) for complete glossary.
→ See [Kits Reference](/.octon/framework/capabilities/runtime/services/_meta/docs/kits-reference.md) for kit CLI quick reference.
...
2. **Want to understand risk?** → [RISK-TIERS.md](/.octon/instance/cognition/context/shared/risk-tiers.md)
...
- **CLI Reference**: `.octon/instance/bootstrap/catalog.md` — Full command docs, options, integration points
- **Kit CLIs**: [Kits Reference](/.octon/framework/capabilities/runtime/services/_meta/docs/kits-reference.md) — Quick reference for using kit CLIs directly
- **Kit Technical Docs**: `/.octon/framework/capabilities/runtime/services/_meta/docs/kits-reference.md` — Full kit documentation
- **Prompt Library**: `.octon/framework/scaffolding/practices/prompts/README.md` — Canonical prompts with schemas and validation
