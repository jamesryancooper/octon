...
- Create or update a migration plan from `/.octon/framework/scaffolding/runtime/templates/migrations/template.clean-break-migration.md`
  at `/.octon/instance/cognition/context/shared/migrations/<YYYY-MM-DD>-<slug>/plan.md`
- Update `/.octon/framework/cognition/practices/methodology/migrations/legacy-banlist.md` when legacy surfaces are removed.
- Provide verification evidence in `/.octon/state/evidence/migration/<YYYY-MM-DD>-<slug>/`
...
- `/.octon/framework/cognition/practices/methodology/migrations/exceptions.md`
