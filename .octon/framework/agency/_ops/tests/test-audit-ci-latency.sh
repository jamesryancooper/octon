...
WRAPPER="$REPO_ROOT/.octon/framework/agency/_ops/scripts/ci/audit-ci-latency.sh"
CONTROL_PLANE="$REPO_ROOT/.octon/framework/agency/practices/standards/github-control-plane-contract.json"
