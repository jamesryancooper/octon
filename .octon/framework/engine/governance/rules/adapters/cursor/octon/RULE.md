...
|-------|------------------|
| **Harness structure** | `.octon/instance/bootstrap/START.md` |
| **Artifact taxonomy** | `.octon/framework/cognition/_meta/architecture/taxonomy.md` |
| **Commands** | `.octon/framework/capabilities/_meta/architecture/commands.md` |
| **Workflows** | `.octon/framework/orchestration/_meta/architecture/workflows.md` |
| **Prompts** | `.octon/framework/scaffolding/_meta/architecture/prompts.md` |
| **Scripts** | `.octon/framework/capabilities/services/README.md` |
...
See `.octon/instance/bootstrap/catalog.md#ide-integration-decision` for detailed decision guidance.
...
**Decision guidance:** See `.octon/instance/bootstrap/catalog.md#decision-guidance`

**This harness's operations:** See `.octon/instance/bootstrap/catalog.md`

---

## Canonical Structure

See `.octon/instance/bootstrap/START.md` for the full structure reference, including:
...
|----------|------|---------|
| Base harness | `.octon/framework/scaffolding/templates/octon/` | Repo-root harness bootstrap |
| Cursor command | `.octon/framework/scaffolding/templates/cursor-command.md` | Cursor command wrappers (local) |
| Document | `.octon/framework/scaffolding/templates/document.md` | General documents (local) |

> **Note:** Base templates live in `.octon/` (shared). Project-specific templates stay in `.octon/framework/scaffolding/templates/`.
...
See `.octon/instance/bootstrap/START.md` for full documentation.
