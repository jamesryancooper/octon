...
.octon/framework/engine/governance/rules/_ops/scripts/validate-harness-rules.sh

# Create/update symlinks in .cursor/rules and .codex/rules
.octon/framework/engine/governance/rules/_ops/scripts/setup-harness-rule-links.sh

# Re-render generated adapter content
.octon/framework/engine/governance/rules/_ops/scripts/render-harness-rules.sh approval-prompts
```
...
.octon/framework/engine/governance/rules/_ops/scripts/validate-harness-rules.sh --check-links
