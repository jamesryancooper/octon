...
- The server enforces a max line length (default 1 MiB) in `.octon/framework/engine/runtime/crates/core/src/jsonlines.rs`.
...
- Runtime tier files are now implemented at:
  ...
  - `.octon/framework/capabilities/runtime/services/registry.runtime.yml`
- `octon validate` enforces:
