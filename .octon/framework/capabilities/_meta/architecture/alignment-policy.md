...
- Reuse existing `skill_sets`, `capabilities`, and capability-to-reference mappings in `.octon/framework/capabilities/runtime/skills/capabilities.yml`.
...
- `create-skill` skill flow (`.octon/framework/capabilities/runtime/skills/meta/create-skill/`)
- Skills creation docs (`.octon/framework/capabilities/_meta/architecture/creation.md`)
- Skills validation docs (`.octon/framework/capabilities/_meta/architecture/validation.md`)
