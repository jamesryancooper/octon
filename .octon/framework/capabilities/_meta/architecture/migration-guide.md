...
```bash
mv .octon/framework/capabilities/runtime/skills/my-skill/references/<legacy-phases-file> \
   .octon/framework/capabilities/runtime/skills/my-skill/references/phases.md
```
