...
For the complete list of all 7 Octon primitives (including Commands, Checklists, and Templates), see `.octon/framework/cognition/runtime/context/reference/primitives.md`.
...
- `.octon/framework/cognition/runtime/context/reference/primitives.md` — All Octon primitives
