...
| `summary`, `triggers`, `tags`, `display_name` | `.octon/framework/capabilities/runtime/skills/manifest.yml` | SKILL.md |
| `version`, `commands`, `parameters`, `composition` | `.octon/framework/capabilities/runtime/skills/registry.yml` | SKILL.md, io-contract.md |
| **Input/output paths** | **`.octon/framework/capabilities/runtime/skills/registry.yml`** | SKILL.md (summary only), io-contract.md (summary only) |
...
**Validation:** Run `.octon/framework/capabilities/runtime/skills/_ops/scripts/validate-skills.sh` to detect issues.
...
.octon/framework/capabilities/runtime/skills/_ops/scripts/validate-skills.sh my-skill

# Auto-scaffold missing entries
.octon/framework/capabilities/runtime/skills/_ops/scripts/validate-skills.sh --fix

# Strict mode (treat trigger duplicates as errors)
.octon/framework/capabilities/runtime/skills/_ops/scripts/validate-skills.sh --strict
```
...
- [ ] Skill entry exists in `.octon/framework/capabilities/runtime/skills/registry.yml` (extended metadata)
- [ ] `version` is defined in `.octon/framework/capabilities/runtime/skills/registry.yml` (not in SKILL.md)
...
- [ ] I/O mappings exist in `.octon/framework/capabilities/runtime/skills/registry.yml`
