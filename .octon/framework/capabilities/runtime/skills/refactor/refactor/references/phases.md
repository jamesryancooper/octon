...
2. **Record results:**
   ...
   - `.octon/framework/orchestration/runtime/workflows/example.md` (1 match)
...
4. **Consolidate and deduplicate:**
   ...
   |------|-------------|----------------|
   | `.octon/instance/bootstrap/START.md` | 4 | `old-name`, `/old-name/` |
   | `.octon/framework/orchestration/runtime/workflows/example.md` | 1 | `old-name` |
...
1. **Create prioritized manifest:**
   ...
   **Total changes:** 47
   ...
   - [ ] Rename `.octon/inputs/exploratory/ideation/.scratch/` → `.octon/inputs/exploratory/ideation/scratchpad/`

   ### Phase 2: Config Files
   - [ ] `package.json` (1 change)

   ### Phase 3: Documentation & Code
   - [ ] `.octon/instance/bootstrap/START.md` (4 changes)
...
1. **Execute physical changes first:**
   ...
   ```bash
   mv .octon/inputs/exploratory/ideation/.scratch .octon/inputs/exploratory/ideation/scratchpad
   ```
...
4. **Execute continuity artifacts (APPEND ONLY):**
   ...
   **Completed:**
   - Renamed `.octon/inputs/exploratory/ideation/.scratch/` to `.octon/inputs/exploratory/ideation/scratchpad/`
...
2. **Generate suggested commit message:**
   ...
   - Updated 47 references across 12 files
   - Renamed directory `.octon/inputs/exploratory/ideation/.scratch/` → `.octon/inputs/exploratory/ideation/scratchpad/`
