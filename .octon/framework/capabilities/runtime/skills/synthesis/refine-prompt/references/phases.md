  ...
  phases:
    - name: "Context Analysis"
      steps:
        ...
        - "Load project constraints from .octon/instance/cognition/context/shared/constraints.md"
...
3. **Load constraints**
   - Read `.octon/instance/cognition/context/shared/constraints.md` if present
