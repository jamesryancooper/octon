...
checkpoints:
  strategy: phase
  storage: ".octon/framework/capabilities/runtime/skills/_ops/state/runs/refine-prompt/{{run-id}}/"
  retention: session
...
- Checkpoints live in `.octon/framework/capabilities/runtime/skills/_ops/state/runs/refine-prompt/{{run-id}}/`.
