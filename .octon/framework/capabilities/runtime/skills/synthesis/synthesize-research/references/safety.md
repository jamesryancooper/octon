...
| Tier | Path | Purpose |
|------|------|---------|
| **Tier 1** | `.octon/inputs/exploratory/syntheses/**` | Synthesis documents (deliverables) |
...
- Write only to .octon/inputs/exploratory/syntheses/ and /.octon/state/evidence/runs/skills/ directories
