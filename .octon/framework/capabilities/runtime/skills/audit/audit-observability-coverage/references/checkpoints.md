...
checkpoints:
  strategy: phase
  storage: ".octon/framework/capabilities/runtime/skills/_ops/state/logs/audit-observability-coverage/{{run_id}}.md"
  retention: session
...
recovery:
  ...
  on_input_change: "If scope, artifact globs, or baseline source changes, restart from configuration."
