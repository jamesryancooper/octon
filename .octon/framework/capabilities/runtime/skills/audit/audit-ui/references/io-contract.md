...
> **Authoritative Source:** Parameter definitions and output paths live in `.octon/framework/capabilities/runtime/skills/registry.yml`.
...
- `.octon/state/evidence/validation/analysis/YYYY-MM-DD-ui-audit.md`
