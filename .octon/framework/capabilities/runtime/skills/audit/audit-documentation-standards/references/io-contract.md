...
Defined in `.octon/framework/capabilities/runtime/skills/registry.yml`.

| Parameter | Type | Required | Default | Description |
| --------- | ---- | -------- | ------- | ----------- |
| `docs_root` | folder | Yes | -- | Root documentation directory to audit |
| `template_root` | folder | No | `.octon/framework/scaffolding/runtime/templates/docs/documentation-standards` | Canonical documentation template root |
| `policy_doc` | file | No | `.octon/framework/cognition/governance/principles/documentation-is-code.md` | Canonical docs-as-code policy document |
...
- `.octon/state/evidence/validation/analysis/YYYY-MM-DD-documentation-standards-audit.md`
