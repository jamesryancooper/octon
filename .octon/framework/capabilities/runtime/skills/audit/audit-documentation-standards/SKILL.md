...
description: >
  Bounded docs-as-code audit that checks documentation against Octon policy,
...
Run a docs-as-code compliance audit for a documentation root against Octon's canonical policy and template guidance.
...
```text
/audit-documentation-standards docs_root="docs" template_root=".octon/framework/scaffolding/runtime/templates/docs/documentation-standards" policy_doc=".octon/framework/cognition/governance/principles/documentation-is-code.md"
```
...
- `.octon/state/evidence/validation/analysis/YYYY-MM-DD-documentation-standards-audit.md` -- Human-readable findings report
- `.octon/state/evidence/validation/audits/YYYY-MM-DD-<run-id>/` -- Authoritative bounded-audit bundle
- `/.octon/state/evidence/runs/skills/audit-documentation-standards/` -- Execution logs with index
