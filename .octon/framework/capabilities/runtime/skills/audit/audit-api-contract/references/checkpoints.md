...
checkpoints:
  strategy: phase
  storage: ".octon/framework/capabilities/runtime/skills/_ops/state/logs/audit-api-contract/{{run_id}}.md"
  retention: session
  ...
  schema:
    ...
    - name: coverage_layers_complete
      ...
      contains:
        - contract_spec_findings
        - implementation_compatibility_findings
        - versioning_evidence_findings
        - coverage_ledger
