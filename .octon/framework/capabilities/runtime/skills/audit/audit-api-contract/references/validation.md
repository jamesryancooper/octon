...
- `Contract Definition and Specification Coverage` findings must be grounded in contract and spec artifacts.
- `Implementation and Compatibility Conformance` findings must cite implementation and compatibility evidence.
- `Versioning, Deprecation, and Evidence Readiness` findings must cite lifecycle governance and release-evidence artifacts.
