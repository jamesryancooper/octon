...
- Successor principles charter path
  `.octon/framework/cognition/governance/principles/principles-v2026-02-24.md` was
...
- Canonical methodology discovery was tightened by removing phased/advisory
  artifacts from `.octon/framework/cognition/practices/methodology/index.yml`.
...
- Methodology hub sections in
  `.octon/framework/cognition/practices/methodology/README.md` were further
  summarize-and-link compressed to reduce duplicated operational detail.
- Flow-tier duplication in
  `.octon/framework/cognition/practices/methodology/flow-and-wip-policy.md` was
