...
**Subsystem**
: A self-contained component of the harness with its own config files, definition files, and conventions. Example: `.octon/framework/capabilities/runtime/skills/` is the skills subsystem.
