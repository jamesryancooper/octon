...
```text
/architecture-readiness-audit target_path=".octon"
```

With bounded-domain scope:

```text
/architecture-readiness-audit target_path=".octon/framework/capabilities" severity_threshold="high"
```

With strict post-remediation gate:

```text
/architecture-readiness-audit target_path=".octon" post_remediation=true convergence_k="3"
```
...
- `/.octon/state/evidence/runs/skills/architecture-readiness-audit/`
