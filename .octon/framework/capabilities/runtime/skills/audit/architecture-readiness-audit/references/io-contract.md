...
io:
  ...
  outputs:
    ...
    - name: run_log
      path: "/.octon/state/evidence/runs/skills/architecture-readiness-audit/{{run_id}}.md"
      format: markdown
      determinism: unique
      description: "Execution log for this readiness audit run"
    - name: log_index
      path: "/.octon/state/evidence/runs/skills/architecture-readiness-audit/index.yml"
      format: yaml
