...
- `Policy and Control Coverage` findings must be grounded in policy and control artifacts.
- `Secrets and Access Safeguards` findings must cite safeguards and enforcement evidence.
- `Dependency and Evidence Readiness` findings must cite dependency assurance artifacts or explicit absences.
