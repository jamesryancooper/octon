...
```text
/audit-security-compliance scope=".octon" policy_baseline_ref=".octon/framework/assurance/practices/standards/security-and-privacy.md" control_baseline_ref=".octon/framework/cognition/practices/methodology/security-baseline.md"
```
...
```text
/audit-security-compliance scope=".octon/framework/capabilities/runtime/services" post_remediation=true severity_threshold="high" convergence_k="3"
```
