...
checkpoints:
  strategy: phase
  storage: ".octon/framework/capabilities/runtime/skills/_ops/state/logs/audit-test-quality/{{run_id}}.md"
  retention: session
  ...
  schema:
    ...
    - name: coverage_layers_complete
      ...
      contains:
        - test_strategy_coverage_findings
        - contract_integration_findings
        - determinism_gate_evidence_findings
        - coverage_ledger
