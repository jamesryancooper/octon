...
decisions:
  - id: baseline-selection
    ...
    question: "Which baseline should this run use for testing intent and gate policy?"
    branches:
      - condition: "testing_baseline_ref and/or quality_gate_baseline_ref exists and is readable"
        label: explicit_baseline
        next_phase: "Use referenced baselines for expected test-quality checks"
  ...
  - id: scope-discovery-strategy
    point: "Phase 1: Configure"
    question: "How are in-scope test-quality surfaces discovered?"
    branches:
...
default_path:
  [
    "Configure",
    "Test Strategy and Coverage Topology",
    "Contract and Integration Assurance",
    "Determinism, Flake Control, and Gate Evidence",
    "Self-Challenge",
    "Report",
  ]
---
...
- Prefer explicit testing and gate-policy baselines when available.
