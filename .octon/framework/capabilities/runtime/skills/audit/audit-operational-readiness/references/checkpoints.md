...
checkpoints:
  strategy: phase
  storage: ".octon/framework/capabilities/runtime/skills/_ops/state/logs/audit-operational-readiness/{{run_id}}.md"
  retention: session
  ...
  schema:
    ...
    - name: coverage_layers_complete
      ...
      contains:
        - ownership_objectives_findings
        - runbook_incident_findings
        - resilience_evidence_findings
        - coverage_ledger
