...
```text
/audit-charter charter_path=".octon/framework/cognition/governance/CHARTER.md"
```

With narrowed reporting:

```text
/audit-charter charter_path=".octon/framework/cognition/governance/CHARTER.md" severity_threshold="medium" include_rewrites=true
```
