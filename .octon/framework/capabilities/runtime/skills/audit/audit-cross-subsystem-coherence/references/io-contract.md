...
| `docs` | folder | No | `.octon/framework/cognition/_meta/architecture` | Companion architecture docs root for cross-reference checks |
...
- `.octon/state/evidence/validation/analysis/YYYY-MM-DD-cross-subsystem-coherence-audit.md`
