...
**Verb vocabulary:** See [Verb Vocabulary](/.octon/framework/capabilities/practices/design-conventions.md#verb-vocabulary) for the full list with semantic definitions, boundaries, and retired verbs.
...
- Write only to designated paths (`.octon/framework/capabilities/runtime/skills/`, outputs, logs)
