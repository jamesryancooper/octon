...
- If validation passes, run `.octon/framework/capabilities/runtime/skills/_ops/scripts/setup-harness-links.sh <skill_name>` to refresh host adapter links when needed.
