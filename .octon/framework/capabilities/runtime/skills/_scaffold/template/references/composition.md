...
#
# See: .octon/framework/capabilities/_meta/architecture/reference-artifacts.md#compositionmd
#
composition:
...
{{skill-3}} (sink)
     ...
     │ Output: Final report written to .octon/state/evidence/validation/analysis/
```
