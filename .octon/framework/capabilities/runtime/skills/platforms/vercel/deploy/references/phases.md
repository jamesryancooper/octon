...
1. Write execution log to `/.octon/state/evidence/runs/skills/vercel-deploy/{run_id}.md`:
   ```markdown
   ...
   ```
2. Update `/.octon/state/evidence/runs/skills/vercel-deploy/index.yml` and `/.octon/state/evidence/runs/skills/index.yml`
