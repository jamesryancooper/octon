...
checkpoints:
  strategy: phase
  storage: ".octon/framework/capabilities/runtime/skills/_ops/state/runs/vercel-deploy/{{run-id}}/"
  retention: session
...
- State is stored under `.octon/framework/capabilities/runtime/skills/_ops/state/runs/vercel-deploy/{{run-id}}/`.
