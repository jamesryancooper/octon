...
# Creates symlinks from harness skill folders to skills in .octon/framework/capabilities/runtime/skills/
#
...
create_skill_link() {
    ...
    local target="../../.octon/framework/capabilities/runtime/skills/$skill_path"
