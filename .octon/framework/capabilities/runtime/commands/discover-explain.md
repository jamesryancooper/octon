...
```bash
.octon/framework/engine/runtime/run tool interfaces/filesystem-discovery discover.explain --json \
  '{"query":"<text>","candidate_node_ids":["file:.octon/instance/bootstrap/START.md"]}'
```
