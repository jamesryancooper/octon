...
Execute the workflow in `.octon/framework/orchestration/runtime/workflows/refactor/refactor/`.
...
When updating `/.octon/state/continuity/repo/log.md`, `decisions/*.md`, or similar historical records:
...
- **Checklist:** `.octon/framework/assurance/practices/complete.md`
- **Conventions:** `.octon/instance/bootstrap/conventions.md`
