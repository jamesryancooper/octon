...
- Loads workflows from `.octon/framework/orchestration/runtime/workflows/`
...
- **Runtime launcher:** `.octon/framework/engine/runtime/run`
- **Kernel studio command:** `.octon/framework/engine/runtime/crates/kernel/src/main.rs`
- **Studio crate:** `.octon/framework/engine/runtime/crates/studio/`
