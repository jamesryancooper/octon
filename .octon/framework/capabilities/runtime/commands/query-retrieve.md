...
```bash
bash .octon/framework/capabilities/runtime/services/retrieval/query/impl/query.sh < /tmp/query-retrieve.json
```
...
- **Service:** `.octon/framework/capabilities/runtime/services/retrieval/query/`
- **Input schema:** `.octon/framework/capabilities/runtime/services/retrieval/query/schema/input.schema.json`
- **Output schema:** `.octon/framework/capabilities/runtime/services/retrieval/query/schema/output.schema.json`
