...
/context-budget --limit <int> --used <int> --report .octon/state/evidence/validation/analysis/<date>-context-budget.md
```
...
- **Service:** `.octon/framework/capabilities/runtime/services/interfaces/agent-platform/`
