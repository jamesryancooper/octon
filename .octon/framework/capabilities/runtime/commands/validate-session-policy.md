...
```text
/validate-session-policy --file .octon/framework/capabilities/runtime/services/interfaces/agent-platform/fixtures/native-session-policy.json
```
...
- **Schema:** `.octon/framework/capabilities/runtime/services/interfaces/agent-platform/schema/session-policy.schema.json`
- **Contract:** `.octon/instance/cognition/context/shared/agent-platform-interop.md`
