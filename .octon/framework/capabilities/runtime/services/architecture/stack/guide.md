...
- **Purpose:** Defines and governs the tech stack from AI‑grounded evidence, emitting a codified `stack.yml` and ADRs other services consume under Octon gates.
...
- **Octon alignment:** advances interoperability via consistent profiles/ADRs consumed across services; exposes governance hooks so stack decisions are policy‑ and eval‑gated.
