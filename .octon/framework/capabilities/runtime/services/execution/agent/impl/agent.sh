...
PROFILE_RESOLVER=".octon/framework/capabilities/_ops/scripts/policy-profile-resolve.sh"
BUDGET_METER=".octon/framework/capabilities/_ops/scripts/policy-budget-meter.sh"
ACP_REQUEST_BUILDER=".octon/framework/capabilities/_ops/scripts/policy-acp-request.sh"
ACP_EVAL=".octon/framework/capabilities/_ops/scripts/policy-acp-eval.sh"
RECEIPT_WRITER=".octon/framework/capabilities/_ops/scripts/policy-receipt-write.sh"
REVERSIBLE_PRIMITIVES_SCRIPT=".octon/framework/capabilities/_ops/scripts/policy-reversible-primitives.sh"
BREAKER_ACTIONS_SCRIPT=".octon/framework/capabilities/_ops/scripts/policy-circuit-breaker-actions.sh"
