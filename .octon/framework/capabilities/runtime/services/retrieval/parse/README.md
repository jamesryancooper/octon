...
| Contracts (normative)| `.octon/framework/capabilities/runtime/services/retrieval/parse/schema/input.schema.json`, `.octon/framework/capabilities/runtime/services/retrieval/parse/schema/output.schema.json` |
...
```bash
cd .octon/framework/capabilities/runtime/services/retrieval/parse
...
- Inputs: `.octon/framework/capabilities/runtime/services/retrieval/parse/schema/input.schema.json`
- Outputs: `.octon/framework/capabilities/runtime/services/retrieval/parse/schema/output.schema.json`
