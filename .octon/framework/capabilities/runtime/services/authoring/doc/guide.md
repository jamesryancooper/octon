...
{
  "paths": ["docs/**"],
  "template_root": ".octon/framework/scaffolding/runtime/templates/docs/documentation-standards",
  "mode": "update",
  "validate_links": true
}
```
...
{
  "docs_root": "docs",
  "policy_doc": ".octon/framework/cognition/governance/principles/documentation-is-code.md",
  "template_root": ".octon/framework/scaffolding/runtime/templates/docs/documentation-standards"
}
```
