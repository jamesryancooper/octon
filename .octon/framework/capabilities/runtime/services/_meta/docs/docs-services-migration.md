...
- Target: `.octon/framework/capabilities/runtime/services`
...
- Full markdown content deleted from `docs/services/**` has been integrated under `.octon/framework/capabilities/runtime/services/**`.
- Canonical references were updated from `docs/services/...` to `.octon/framework/capabilities/runtime/services/...` in active harness docs.
