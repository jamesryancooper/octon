...
```markdown
<!-- Source: /.octon/instance/cognition/decisions/<adr-file>.md -->
...
```markdown
<!-- Reference: .octon/framework/cognition/_meta/architecture/overview.md -->
We use PostgreSQL as our primary data store
(see `ADR-0001` in `.octon/instance/cognition/decisions/` for rationale).
```
...
In Octon harnesses, each type of knowledge has a designated home:
...
| Decisions | `/.octon/instance/cognition/decisions/` | `/.octon/generated/cognition/summaries/decisions.md` |
