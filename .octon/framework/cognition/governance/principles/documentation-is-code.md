...
- Template guidance:
  `.octon/framework/scaffolding/runtime/templates/documentation-standards.md`
- Template bundle:
  `.octon/framework/scaffolding/runtime/templates/docs/documentation-standards/`
- Operational service guide:
  `.octon/framework/capabilities/runtime/services/authoring/doc/guide.md`
- Enforcement:
...
- workflow command: `/audit-documentation`
  (`.octon/framework/orchestration/runtime/workflows/audit/audit-documentation/README.md`)
- audit command: `/audit-documentation-standards`
  (`.octon/framework/capabilities/runtime/skills/audit/audit-documentation-standards/SKILL.md`)

Live enforcement binding:

- ACP promotion evaluation consumes docs-gate evidence from policy at
  `.octon/framework/capabilities/governance/policy/deny-by-default.v2.yml#acp.docs_gate`.
...
- CI must run governance lint and docs promotion fail-closed contract tests
  ...
  and
  `.octon/framework/cognition/_ops/principles/scripts/test-docs-promotion-fail-closed.sh`.
...
- `.octon/framework/cognition/practices/methodology/spec-first-planning.md`
- `.octon/framework/scaffolding/governance/patterns/adr-policy.md`
- `.octon/framework/scaffolding/runtime/templates/documentation-standards.md`
- `.octon/framework/orchestration/runtime/workflows/audit/audit-documentation/README.md`
- `.octon/framework/capabilities/runtime/skills/audit/audit-documentation-standards/SKILL.md`
- `.octon/framework/cognition/governance/pillars/direction.md`
