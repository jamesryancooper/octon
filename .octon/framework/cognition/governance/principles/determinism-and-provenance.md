...
- `.octon/framework/cognition/governance/principles/idempotency.md`
- `.octon/framework/cognition/governance/principles/determinism.md`
- `.octon/framework/cognition/practices/methodology/README.md`
- `.octon/framework/capabilities/runtime/services/_meta/docs/platform-overview.md`
- `.octon/framework/cognition/governance/pillars/trust.md`
- `.octon/framework/cognition/governance/pillars/insight.md`
