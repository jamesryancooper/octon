...
In Octon, this principle applies at multiple levels:
...
Octon's skill system implements progressive disclosure through four tiers:
...
The `.octon/instance/bootstrap/START.md` pattern implements progressive disclosure for harness orientation:
