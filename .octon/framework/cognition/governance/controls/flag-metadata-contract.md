...
- data file: `.octon/framework/capabilities/governance/policy/flags.metadata.json`
- schema: `.octon/framework/capabilities/governance/policy/flags.metadata.schema.json`
- validator: `.octon/framework/capabilities/_ops/scripts/validate-flag-metadata.sh`
