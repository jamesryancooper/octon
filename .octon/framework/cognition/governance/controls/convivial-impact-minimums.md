...
This contract operationalizes Octon's Convivial Purpose by defining minimum
...
Applies to:
- `.octon/framework/cognition/practices/methodology/templates/spec-tier2.yaml`
- `.octon/framework/cognition/practices/methodology/templates/spec-tier3.yaml`
