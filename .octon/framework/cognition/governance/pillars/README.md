...
description: Octon's six pillars organize the complete development lifecycle into three phases — PLAN, SHIP, LEARN — forming a closed feedback loop that serves the Convivial Purpose.
---

# The Six Pillars

Octon's six pillars organize the complete development lifecycle into three phases, forming a closed feedback loop that serves our [Convivial Purpose](../purpose/convivial-purpose.md).
...
Octon is written **solo-first**: one developer working with AI (agents + automation), following a pillar-guided lifecycle. If/when you have collaborators, the same pillars still apply.
...
> "Octon has six pillars in three phases:
>
...
| # | Pillar | Phase | Developer Receives | Octon Provides |
|---|--------|-------|-------------------|------------------|
...
> **Octon gives developers:**
>
> **Direction through Validated Discovery** — Know what to build because every feature is validated before investment.
>
> **Focus through Absorbed Complexity** — Build calmly because Octon handles infrastructure, process, and boundaries.
>
...
The pillars serve Octon's Convivial Purpose: *Technology that expands capability, respects attention, fosters connection, and resists extraction.*
...
- [Kit Documentation](/.octon/framework/capabilities/runtime/services/_meta/docs/kits-reference.md) — Tools that implement the pillars
