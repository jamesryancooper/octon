...
| **Octon Provides** | Governed Determinism — typed contracts, bounded agents, security policies, reversibility |
| **Phase** | SHIP |
...
Bounded agents in Octon operate within explicit constraints:
