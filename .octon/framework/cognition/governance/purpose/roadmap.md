...
| Spec template CIA section | `.octon/framework/cognition/practices/methodology/templates/spec-tier*.yaml` | Not added |
...
```text
.octon/framework/cognition/governance/principles/purpose/
