...
Direct edits to
`/.octon/framework/cognition/governance/principles/principles.md` under
...
- Policy contract source:
  `.octon/framework/capabilities/governance/policy/deny-by-default.v2.yml#governance_overrides`
- Schema source:
  `.octon/framework/capabilities/governance/policy/deny-by-default.v2.schema.json#/$defs/governanceOverrides`
