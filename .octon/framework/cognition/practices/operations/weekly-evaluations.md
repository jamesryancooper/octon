...
Produce weekly scorecard evaluations under `/.octon/framework/cognition/runtime/evaluations/digests/` from deterministic evidence sources.

## Inputs

- `/.octon/instance/cognition/context/shared/metrics-scorecard.md`
- CI artifacts and quality-gate outputs
- Observability traces and Knowledge Plane references

## Procedure

1. Create a weekly digest artifact under `/.octon/framework/cognition/runtime/evaluations/digests/`.
