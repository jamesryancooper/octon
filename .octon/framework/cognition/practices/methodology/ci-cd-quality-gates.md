...
Reference: Use the PatchKit PR Template (canonical) in `.octon/framework/capabilities/runtime/services/delivery/patch/guide.md` to standardize PR bodies, determinism/provenance notes, and tier information.
