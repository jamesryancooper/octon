...
description: Comprehensive AI-facing documentation for Octon's three-tier risk classification system, including criteria, gates, responsibilities, and automation logic.
...
This document provides the complete specification for Octon's risk tier system. It is designed for AI agents to use when classifying changes, generating specs, and applying appropriate rigor.
...
Every change in Octon is classified into one of three risk tiers:
...
The risk tier system operationalizes Octon's [Six Pillars](../../governance/pillars/README.md), with each tier emphasizing different pillars based on the nature and risk of the change.
...
```yaml
tier_bump_down:
  command: "octon tier-down <id> --reason '<reason>'"
