...
4. Runtime indexes (`/.octon/framework/cognition/runtime/**/index.yml`) provide centralized discovery across decisions and migrations.
...
|---|---|---|---|
| `/.octon/framework/cognition/practices/methodology/` | `README.md`, `implementation-guide.md` | `README.index.yml`, `implementation-guide.index.yml` | `index.yml` |
| `/.octon/framework/cognition/_meta/architecture/` | `README.md`, `resources.md` | `README.index.yml`, `resources.index.yml` | `index.yml` |
...
- Structure validation: `/.octon/framework/assurance/runtime/_ops/scripts/validate-harness-structure.sh`
- Skill alignment validation: `/.octon/framework/assurance/runtime/_ops/scripts/validate-audit-subsystem-health-alignment.sh`
