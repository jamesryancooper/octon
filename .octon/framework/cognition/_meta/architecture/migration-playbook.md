...
- Accessibility baseline
  ...
  - Optional: use `.octon/framework/cognition/_meta/architecture/a11ykit.md` to centralize CI accessibility checks and surface results as policy/evaluation gates with Knowledge Plane provenance.
- Feature flags
...
- Monorepo Layout: `.octon/framework/cognition/_meta/architecture/monorepo-layout.md`
- Repository Blueprint: `.octon/framework/cognition/_meta/architecture/repository-blueprint.md`
...
- Tooling Integration: `.octon/framework/cognition/_meta/architecture/tooling-integration.md`
- Governance Model: `.octon/framework/cognition/_meta/architecture/governance-model.md`
- Kaizen Subsystem: `.octon/framework/cognition/_meta/architecture/kaizen-subsystem.md`
