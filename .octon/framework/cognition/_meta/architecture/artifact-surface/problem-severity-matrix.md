...
|  # | Core problem                                       | Final severity for Octon | Why (Octon context)                                                             | HAS mitigation                                                                                  |
| -: | -------------------------------------------------- | -------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
|  1 | Editorial interfaces without git knowledge         | **Non-issue** (default)    | Octon's primary editors are devs + agents; non-git SMEs are edge cases.         | GitHub web editor; agent-mediated edits; optional git-backed UI later.                          |
...
|  5 | Multi-destination publishing                       | **Significant hurdle**     | Octon explicitly needs web/app/email/agent outputs; "markdown=page" breaks.     | IR compiled once → destination renderers.                                                       |
