...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [agent roles](./agent-roles.md), [kaizen subsystem](./kaizen-subsystem.md), [knowledge plane](../../runtime/knowledge/knowledge.md), [contracts registry](./contracts-registry.md), [python runtime workspace example](/.octon/framework/scaffolding/practices/examples/stack-profiles/python-runtime-workspace.md)
