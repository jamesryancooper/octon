...
description: Curated external references that complement `.octon/framework/cognition/architecture`, with brief annotations and cross-references.
---

# Architecture Suggested Resources

Use this page to curate external references that deepen or complement topics covered in `.octon/framework/cognition/architecture`. Keep entries short, annotated, and directly actionable.
...
- Related docs: [overview](./overview.md), [repository blueprint](./repository-blueprint.md), [monorepo layout](./monorepo-layout.md), [contracts registry](./contracts-registry.md), [python runtime workspace example](/.octon/framework/scaffolding/practices/examples/stack-profiles/python-runtime-workspace.md)
...
- Level: Intermediate
- Last reviewed: 2025-11-12
- Related docs: [implementation profile example](/.octon/framework/scaffolding/practices/examples/stack-profiles/nextjs-astro-vercel.md)
