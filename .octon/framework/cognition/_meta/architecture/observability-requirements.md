...
- No PII/PHI in logs/traces: enforce via Guard/Redaction layer (cross‑cutting; see `.octon/framework/cognition/_meta/architecture/slices-vs-layers.md`) at log/write boundaries; fail checks on violations.
