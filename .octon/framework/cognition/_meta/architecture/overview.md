...
- Enforce internal module boundaries and stable coupling rules to prevent cross‑slice entanglement; design seams to allow reversible extraction when warranted.
  See also: `.octon/framework/cognition/_meta/architecture/repository-blueprint.md`, `.octon/framework/cognition/_meta/architecture/monorepo-layout.md`, and `.octon/framework/cognition/_meta/architecture/feature-unit-taxonomy.md` (non‑normative examples) for structure, boundaries, enforcement details, and illustrative feature mappings.
