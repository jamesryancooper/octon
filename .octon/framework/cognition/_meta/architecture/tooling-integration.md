...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [overview](./overview.md), [runtime architecture](./runtime-architecture.md), [knowledge plane](../../runtime/knowledge/knowledge.md), [observability requirements](./observability-requirements.md), [runtime policy](./runtime-policy.md), [contracts registry](./contracts-registry.md), [python runtime workspace example](/.octon/framework/scaffolding/practices/examples/stack-profiles/python-runtime-workspace.md)
