...
RUNNER=".octon/framework/engine/runtime/policy"
...
stage_receipt=".octon/state/evidence/runs/docs-gate-stage-only/receipt.latest.json"
...
deny_receipt=".octon/state/evidence/runs/docs-gate-deny/receipt.latest.json"
