...
description: Boilerplate files for creating new content stored in .octon/framework/scaffolding/runtime/templates/
---

# Harness Templates

Templates are **boilerplate files** stored in `.octon/framework/scaffolding/runtime/templates/`. They provide starting points for creating new reusable content within the harness's domain.

Bootstrap assets used by `/init` are not part of this surface. They live under `.octon/framework/scaffolding/runtime/bootstrap/`.
...
A JSON schema is available at `.octon/framework/scaffolding/runtime/templates/manifest.schema.json`.
...
|------|---------|----------|
| **Template** | Starting point to copy and customize | `.octon/framework/scaffolding/runtime/templates/` |
| **Example** | Reference to study and learn from | `.octon/framework/scaffolding/practices/examples/` |
