...
See `.octon/framework/cognition/practices/methodology/README.md` for Octon's six pillars.
...
- Comparative landscape: `.octon/framework/cognition/_meta/architecture/comparative-landscape.md`
- Repository blueprint: `.octon/framework/cognition/_meta/architecture/repository-blueprint.md`
- Overview: `.octon/framework/cognition/_meta/architecture/overview.md`
...
- Slices vs layers: `.octon/framework/cognition/_meta/architecture/slices-vs-layers.md`
