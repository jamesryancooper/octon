...
```text
Human: "Use .octon/framework/scaffolding/practices/prompts/research/synthesize-findings.md to consolidate
...
- [Projects](/.octon/framework/cognition/_meta/architecture/inputs/exploratory/ideation/projects.md) — Full project documentation
