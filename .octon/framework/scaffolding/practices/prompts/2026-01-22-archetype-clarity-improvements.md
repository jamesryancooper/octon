...
See [validation.md template](./../../../.octon/framework/capabilities/runtime/skills/_scaffold/template/references/validation.md) for the standard format.
```
...
### File: `.octon/framework/capabilities/runtime/skills/README.md`
...
### File: `.octon/framework/capabilities/runtime/skills/_scaffold/template/SKILL.md`
...
- [ ] `.octon/framework/capabilities/runtime/skills/README.md` selection matrix uses new phrasing
