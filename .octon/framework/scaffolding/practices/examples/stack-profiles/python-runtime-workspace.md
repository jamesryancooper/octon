...
Related docs: [Monorepo polyglot (normative)](/.octon/framework/cognition/_meta/architecture/monorepo-polyglot.md), [Architecture overview](/.octon/framework/cognition/_meta/architecture/overview.md), [Monorepo layout](/.octon/framework/cognition/_meta/architecture/monorepo-layout.md), [Repository blueprint](/.octon/framework/cognition/_meta/architecture/repository-blueprint.md), [Tooling integration](/.octon/framework/cognition/_meta/architecture/tooling-integration.md), [Contracts registry](/.octon/framework/cognition/_meta/architecture/contracts-registry.md), [Agent roles](/.octon/framework/cognition/_meta/architecture/agent-roles.md), [Runtime architecture](/.octon/framework/cognition/_meta/architecture/runtime-architecture.md), [Runtime policy](/.octon/framework/cognition/_meta/architecture/runtime-policy.md)

This document provides an example Python runtime workspace profile for Octon’s polyglot monorepo: how uv workspaces, `agents/*`, and the shared LangGraph-based **platform flow runtime service** under `platform/runtimes/flow-runtime/**` can fit together under a contracts-first, Turborepo+pnpm+uv model.
