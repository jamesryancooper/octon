...
Related docs: [Architecture overview](/.octon/framework/cognition/_meta/architecture/overview.md), [Monorepo polyglot (normative)](/.octon/framework/cognition/_meta/architecture/monorepo-polyglot.md), [Monorepo layout](/.octon/framework/cognition/_meta/architecture/monorepo-layout.md), [Repository blueprint](/.octon/framework/cognition/_meta/architecture/repository-blueprint.md), [Runtime architecture](/.octon/framework/cognition/_meta/architecture/runtime-architecture.md), [Runtime policy](/.octon/framework/cognition/_meta/architecture/runtime-policy.md), [Observability requirements](/.octon/framework/cognition/_meta/architecture/observability-requirements.md), [Tooling integration](/.octon/framework/cognition/_meta/architecture/tooling-integration.md), [Contracts registry](/.octon/framework/cognition/_meta/architecture/contracts-registry.md), [Python runtime workspace example](./python-runtime-workspace.md)

This profile applies the Octon Structural Paradigm (HSP) to the Next.js/Astro/Vercel stack. It does not change HSP’s architectural decisions; it provides concrete practices for this stack using the canonical polyglot monorepo layout (`apps/*`, `packages/*`, `packages/kits/*`, `agents/*`, `contracts/`, `platform/*`, `ci-pipeline/`), with a **platform-centric runtime model** under `platform/runtimes/*-runtime/` as described in `runtime-architecture.md`.

Version note: this profile targets **Next.js 16 with React 19**. Some referenced resources (see `/.octon/framework/cognition/_meta/architecture/resources.md`) describe the introduction of caching and Partial Prerendering (PPR) behavior in Next.js 15; the architectural guidance here assumes those semantics as carried forward into 16+.
