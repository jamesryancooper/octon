...
- Policy: `.octon/framework/cognition/governance/principles/documentation-is-code.md`
- Template bundle: `.octon/framework/scaffolding/runtime/templates/docs/documentation-standards/`
- Operational tooling: `.octon/framework/capabilities/runtime/services/authoring/doc/guide.md`
