...
- Policy weights: `.octon/framework/assurance/governance/weights/weights.yml`
- Override declarations: `.octon/framework/assurance/governance/overrides.yml`
- Override governance: `.octon/framework/assurance/governance/SUBSYSTEM_OVERRIDE_POLICY.md`
- Subsystem classes: `.octon/framework/assurance/governance/subsystem-classes.yml`
- Runtime tie-breaker contract: `.octon/framework/cognition/_meta/architecture/specification.md` (`OCTON-SPEC-016`)

## Enforcement Surfaces

- Local/CI computation: `.octon/framework/assurance/runtime/_ops/scripts/compute-assurance-score.sh`
- Local/CI gating: `.octon/framework/assurance/runtime/_ops/scripts/assurance-gate.sh`
- Runtime tool: `.octon/framework/engine/runtime/crates/assurance_tools/src/main.rs`
