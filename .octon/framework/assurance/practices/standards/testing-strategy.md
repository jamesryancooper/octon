...
- Governance gates: `.octon/framework/cognition/_meta/architecture/governance-model.md`
- Monorepo layout (tests): `.octon/framework/cognition/_meta/architecture/monorepo-layout.md`
