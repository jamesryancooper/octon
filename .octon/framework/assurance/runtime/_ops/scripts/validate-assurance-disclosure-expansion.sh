...
RUN_CARD="$OCTON_DIR/state/evidence/disclosure/runs/run-wave3-runtime-bridge-20260327/run-card.yml"
...
HARNESS_CARD="$OCTON_DIR/state/evidence/disclosure/releases/archive-wave4-assurance-disclosure-20260327/harness-card.yml"
SCENARIO_PROOF="$OCTON_DIR/state/evidence/lab/scenarios/scn-wave4-assurance-disclosure-20260327/scenario-proof.yml"
BENCHMARK_CARD="$OCTON_DIR/state/evidence/disclosure/releases/archive-wave4-benchmark-disclosure-20260327/harness-card.yml"
...
MIGRATION_PLAN="$OCTON_DIR/instance/cognition/context/shared/migrations/2026-03-30-unified-execution-constitution-atomic-cutover/plan.md"
...
DISCLOSURE_RECEIPT="$OCTON_DIR/instance/cognition/context/shared/migrations/2026-03-30-unified-execution-constitution-atomic-cutover/plan.md"
...
main() {
  ...
  require_yq '.profile_selection_receipt_ref == ".octon/instance/cognition/context/shared/migrations/2026-03-30-unified-execution-constitution-atomic-cutover/plan.md"' "$ASSURANCE_FAMILY" "assurance family points to the live atomic selector"
  require_yq '.activation_lineage_refs[] | select(. == ".octon/instance/cognition/context/shared/migrations/2026-03-29-unified-execution-constitution-phase4-proof-evaluation-lab-expansion/plan.md")' "$ASSURANCE_FAMILY" "assurance family preserves the Phase 4 receipt as lineage"
  require_yq '.profile_selection_receipt_ref == ".octon/instance/cognition/context/shared/migrations/2026-03-30-unified-execution-constitution-atomic-cutover/plan.md"' "$DISCLOSURE_FAMILY" "disclosure family points to the disclosure receipt"
  ...
  require_text "state/evidence/disclosure/**" "$STATE_EVIDENCE_README" "state evidence README documents canonical disclosure evidence"
  require_text "assurance/" "$RUNS_README" "run evidence README documents assurance root"
  require_text "state/evidence/disclosure/runs/<run-id>/" "$RUNS_README" "run evidence README documents canonical run disclosure root"
