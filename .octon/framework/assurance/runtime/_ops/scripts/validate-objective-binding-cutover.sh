...
MIGRATION_PLAN="$OCTON_DIR/instance/cognition/context/shared/migrations/2026-04-03-uec-clean-break-packet-implementation/plan.md"
...
main() {
  ...
  [[ "$(frontmatter_field "$WORKSPACE_BRIEF_FILE" "profile_selection_receipt_ref")" == ".octon/instance/cognition/context/shared/migrations/2026-04-03-uec-clean-break-packet-implementation/plan.md" ]] \
    && pass "workspace charter narrative points to the packet implementation receipt" \
    || fail "workspace charter narrative must point to the packet implementation receipt"
  ...
  require_yq '.profile_selection_receipt_ref == ".octon/instance/cognition/context/shared/migrations/2026-04-03-uec-clean-break-packet-implementation/plan.md"' "$WORKSPACE_MACHINE_FILE" "workspace charter machine points to the packet implementation receipt"
