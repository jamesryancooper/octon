...
main() {
  ...
  require_yq '.profile_selection_receipt_ref == ".octon/instance/cognition/context/shared/migrations/2026-03-30-unified-execution-constitution-atomic-cutover/plan.md"' "$FAMILY_FILE" "objective family points to the live atomic selector"
