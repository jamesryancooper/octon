...
VALIDATE_SCRIPT=".octon/framework/assurance/runtime/_ops/scripts/validate-design-proposal.sh"
...
create_fixture_repo() {
  ...
  cp "$REPO_ROOT/.octon/framework/assurance/runtime/_ops/scripts/validate-design-proposal.sh" \
    "$fixture_root/.octon/framework/assurance/runtime/_ops/scripts/validate-design-proposal.sh"
  printf '%s\n' "$fixture_root"
}
...
create_full_domain_runtime_proposal() {
  ...
  local proposal_dir="$fixture_root/.octon/inputs/exploratory/proposals/design/$proposal_id"
...
validation:
  ...
  conformance_validator_path: ".octon/inputs/exploratory/proposals/design/runtime-proposal/conformance/validate_scenarios.py"
EOF
...
create_legacy_archive_proposal() {
  local fixture_root="$1"
  local proposal_dir="$fixture_root/.octon/inputs/exploratory/proposals/.archive/design/legacy-proposal"
...
case_valid_proposal_passes() {
  ...
  run_validator_in_fixture "$fixture_root" ".octon/inputs/exploratory/proposals/design/runtime-proposal"
}
...
case_missing_required_file_fails() {
  ...
  fixture_root="$(create_fixture_repo)"
  create_full_domain_runtime_proposal "$fixture_root" runtime-proposal
  proposal_dir="$fixture_root/.octon/inputs/exploratory/proposals/design/runtime-proposal"
...
case_legacy_archive_passes() {
  ...
  run_validator_in_fixture "$fixture_root" ".octon/inputs/exploratory/proposals/.archive/design/legacy-proposal"
}
