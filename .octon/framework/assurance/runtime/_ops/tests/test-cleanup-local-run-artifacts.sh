...
assert_output_contains "$dry_run_output" "dry-run did not summarize local run cleanup candidates" "cleanup_local_run_residue:"
assert_output_contains "$dry_run_output" "dry-run did not summarize stale publication cleanup candidates" "cleanup_stale_unreferenced_publication_attempt:"
assert_output_contains "$dry_run_output" "dry-run did not summarize local metadata cleanup candidates" "cleanup_local_filesystem_metadata:"
assert_output_contains "$dry_run_output" "dry-run did not summarize protected retained evidence" "protected_retained_evidence:"
assert_output_contains "$dry_run_output" "dry-run did not summarize protected control state" "protected_control_state:"
assert_output_contains "$dry_run_output" "dry-run did not summarize protected continuity state" "protected_continuity_state:"
assert_output_contains "$dry_run_output" "dry-run did not summarize manual-review retained evidence" "manual_review_retained_evidence:"
assert_output_contains "$dry_run_output" "dry-run did not summarize manual-review control state" "manual_review_control_state:"
assert_output_contains "$dry_run_output" "dry-run did not summarize manual-review continuity state" "manual_review_continuity_state:"
