...
create_fixture_repo() {
  ...
  mkdir -p "$fixture_root/.octon/framework/assurance/runtime/_ops/scripts" "$fixture_root/.octon/inputs/exploratory/proposals/.archive/design"
  ...
  cp -R "$REPO_ROOT/.octon/inputs/exploratory/proposals/.archive/design/orchestration-domain-design-package" \
    "$fixture_root/.octon/inputs/exploratory/proposals/.archive/design/"
...
case_missing_schema_fails() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  rm "$fixture_root/.octon/inputs/exploratory/proposals/.archive/design/orchestration-domain-design-package/contracts/schemas/decision-record.schema.json"
  run_validator_in_fixture "$fixture_root"
}
...
case_missing_coverage_marker_fails() {
  ...
  perl -0pi -e 's/`contracts\/decision-record-contract\.md` — `schema-backed` via `contracts\/schemas\/decision-record\.schema\.json`/`contracts\/decision-record-contract.md`/' \
    "$fixture_root/.octon/inputs/exploratory/proposals/.archive/design/orchestration-domain-design-package/normative/assurance/implementation-readiness.md"
  run_validator_in_fixture "$fixture_root"
}
...
case_invalid_fixture_that_passes_is_detected() {
  ...
  fixture_root="$(create_fixture_repo)"
  cp \
    "$fixture_root/.octon/inputs/exploratory/proposals/.archive/design/orchestration-domain-design-package/contracts/fixtures/valid/decision-record.valid.json" \
    "$fixture_root/.octon/inputs/exploratory/proposals/.archive/design/orchestration-domain-design-package/contracts/fixtures/invalid/decision-record.invalid.json"
  run_validator_in_fixture "$fixture_root"
}
