...
VALIDATE_SCRIPT=".octon/framework/assurance/runtime/_ops/scripts/validate-audit-design-proposal-workflow.sh"
...
create_fixture_repo() {
  ...
  mkdir -p \
    ...
    "$fixture_root/.octon/framework/orchestration/runtime/workflows/audit" \
    "$fixture_root/.octon/framework/orchestration/governance"
  cp "$REPO_ROOT/.octon/framework/assurance/runtime/_ops/scripts/validate-audit-design-proposal-workflow.sh" \
    "$fixture_root/.octon/framework/assurance/runtime/_ops/scripts/validate-audit-design-proposal-workflow.sh"
  ...
  cp "$REPO_ROOT/.octon/framework/orchestration/governance/capability-map-v1.yml" \
    "$fixture_root/.octon/framework/orchestration/governance/capability-map-v1.yml"
  cp -R "$REPO_ROOT/.octon/framework/orchestration/runtime/workflows/audit/audit-design-proposal" \
    "$fixture_root/.octon/framework/orchestration/runtime/workflows/audit/"
  printf '%s\n' "$fixture_root"
}
...
case_missing_stage_fails() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  rm "$fixture_root/.octon/framework/orchestration/runtime/workflows/audit/audit-design-proposal/stages/03-design-proposal-remediation.md"
  run_validator_in_fixture "$fixture_root"
}
...
case_missing_design_validator_fails() {
  local fixture_root
  fixture_root="$(create_fixture_repo)"
  python3 - "$fixture_root/.octon/framework/orchestration/runtime/workflows/audit/audit-design-proposal/stages/12-verify.md" <<'PY'
...
main() {
  ...
  assert_failure_contains \
    ...
    "missing file: .octon/framework/orchestration/runtime/workflows/audit/audit-design-proposal/stages/03-design-proposal-remediation.md" \
    case_missing_stage_fails
