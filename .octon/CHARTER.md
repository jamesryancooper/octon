...
| `objective brief` | The human-readable objective statement stored at `/.octon/OBJECTIVE.md`. It explains goals, scope, constraints, and acceptance context for the workspace. |
| `intent contract` | The machine-readable artifact stored at `/.octon/cognition/runtime/context/intent.contract.yml`. It is the runtime authority for evaluating scope, binding execution, and validating autonomous material runs. |
...
| `approved workspace conventions` | The effective workspace-local conventions artifact allowed by Section 6. By default this is `/.octon/conventions.md` unless higher-precedence governance explicitly approves another artifact in the same slot. |
...
| 6     | Domain `practices/` documents and workspace adoption artifacts such as `/.octon/scope.md`, `/.octon/conventions.md`, and `/.octon/OBJECTIVE.md` | Supply local operating values and standards within the slots allowed by higher-precedence rules.                                                   |
...
| --------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Objective brief | `/.octon/OBJECTIVE.md`                                  | Human-readable objective source for goals, scope, constraints, and acceptance context. |
| Intent contract | `/.octon/cognition/runtime/context/intent.contract.yml` | Machine-readable runtime authority for binding and evaluating material autonomy.       |
...
- scoped updates to `.octon/scope.md` for local boundary exclusions and human-led zones,
- scoped updates to `.octon/conventions.md` for local standards, support targets, compatibility constraints, and any measurement records required by Section 13.
...
This charter does not override the protected change-control rules for `/.octon/cognition/governance/principles/principles.md`.
...
| `/.octon/cognition/governance/domain-profiles.yml`                                                                              | Machine-readable mirror of the domain classifications in Section 11         | Use the classifications in this charter and block automated reclassification.            |
| `/.octon/engine/runtime/spec/intent-contract-v1.schema.json`                                                                    | Validator for the intent contract                                           | Block material runs that require schema validation. Manual review MAY support read-only planning, but it is not sufficient for material execution. |
...
| `/.octon/cognition/governance/principles/principles.md`                                                                         | Protected constitutional principles authority                               | Protected-governance edits remain disallowed unless explicit human override is provided. Missing or inaccessible principles text does not expand authority for unrelated non-governance execution. |
