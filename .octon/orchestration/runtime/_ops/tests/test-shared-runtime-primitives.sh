...
DISCOVERY_SCRIPT=".octon/orchestration/runtime/_ops/scripts/load-orchestration-discovery.sh"
DECISION_SCRIPT=".octon/orchestration/runtime/_ops/scripts/write-decision.sh"
RUN_SCRIPT=".octon/orchestration/runtime/_ops/scripts/write-run.sh"
LOCK_SCRIPT=".octon/orchestration/runtime/_ops/scripts/manage-coordination-lock.sh"
QUEUE_SCRIPT=".octon/orchestration/runtime/_ops/scripts/manage-queue.sh"
RUNTIME_VALIDATE=".octon/orchestration/runtime/_ops/scripts/validate-orchestration-runtime.sh"
