...
LAUNCH_SCRIPT=".octon/orchestration/runtime/_ops/scripts/launch-automation-run.sh"
RECONCILE_SCRIPT=".octon/orchestration/runtime/_ops/scripts/reconcile-orchestration-runtime.sh"
...
case_first_slice_round_trip() {
  ...
  run_file="$fixture_root/.octon/orchestration/runtime/runs/run-runtime-contract-drift-remediation-evt-first-slice-001.yml"
  [[ -f "$run_file" ]]
