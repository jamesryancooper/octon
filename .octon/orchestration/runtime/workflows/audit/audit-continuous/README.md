...
This README summarizes the canonical workflow unit at `.octon/orchestration/runtime/workflows/audit/audit-continuous`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/orchestration/runtime/workflows/audit/audit-continuous/workflow.yml`.
...
- Canonical contract: `.octon/orchestration/runtime/workflows/audit/audit-continuous/workflow.yml`
- Canonical stages: `.octon/orchestration/runtime/workflows/audit/audit-continuous/stages/`
