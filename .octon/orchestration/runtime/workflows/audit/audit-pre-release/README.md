...
This README summarizes the canonical workflow unit at `.octon/orchestration/runtime/workflows/audit/audit-pre-release`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/orchestration/runtime/workflows/audit/audit-pre-release/workflow.yml`.
...
- [ ] Consolidated report exists at `.octon/output/reports/analysis/YYYY-MM-DD-audit-pre-release.md`
- [ ] Pre-release bundle exists at `.octon/output/reports/audits/YYYY-MM-DD-<slug>/`
...
- Canonical contract: `.octon/orchestration/runtime/workflows/audit/audit-pre-release/workflow.yml`
- Canonical stages: `.octon/orchestration/runtime/workflows/audit/audit-pre-release/stages/`
