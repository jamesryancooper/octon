...
2. **Wait for completion:**
   ...
   The skill writes `.octon/output/reports/analysis/YYYY-MM-DD-freshness-and-supersession-audit.md`.
...
4. **Record outcome:**
   ...
   Report: .octon/output/reports/analysis/{{date}}-freshness-and-supersession-audit.md
...
- [ ] `.octon/output/reports/analysis/YYYY-MM-DD-freshness-and-supersession-audit.md` exists
