...
2. **Wait for completion:**
   ...
   The skill writes `.octon/output/reports/analysis/YYYY-MM-DD-subsystem-health-audit.md`.
...
4. **Record outcome:**
   ...
   Report: .octon/output/reports/analysis/{{date}}-subsystem-health-audit.md
...
- [ ] `.octon/output/reports/analysis/YYYY-MM-DD-subsystem-health-audit.md` exists
