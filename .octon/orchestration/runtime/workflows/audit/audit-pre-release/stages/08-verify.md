...
- [ ] Alignment validator passes:
  ...
  - `bash .octon/assurance/runtime/_ops/scripts/validate-developer-context-policy.sh`
  - `bash .octon/assurance/runtime/_ops/scripts/validate-context-overhead-budget.sh`
