...
This README summarizes the canonical workflow unit at `.octon/orchestration/runtime/workflows/audit/audit-architecture-readiness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/orchestration/runtime/workflows/audit/audit-architecture-readiness/workflow.yml`.
...
- [ ] Bounded-audit bundle exists at `.octon/output/reports/audits/YYYY-MM-DD-<slug>/`
...
- Canonical contract: `.octon/orchestration/runtime/workflows/audit/audit-architecture-readiness/workflow.yml`
- Canonical stages: `.octon/orchestration/runtime/workflows/audit/audit-architecture-readiness/stages/`
