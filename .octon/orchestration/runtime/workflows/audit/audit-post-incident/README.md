...
This README summarizes the canonical workflow unit at `.octon/orchestration/runtime/workflows/audit/audit-post-incident`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/orchestration/runtime/workflows/audit/audit-post-incident/workflow.yml`.
...
- Canonical contract: `.octon/orchestration/runtime/workflows/audit/audit-post-incident/workflow.yml`
- Canonical stages: `.octon/orchestration/runtime/workflows/audit/audit-post-incident/stages/`
