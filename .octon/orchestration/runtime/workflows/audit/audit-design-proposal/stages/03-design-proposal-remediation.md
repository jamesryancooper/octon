---
name: design-proposal-remediation
...
- `bundle/plan.md`
- `bundle/reports/01-design-proposal-audit.md`
...
1. Load prompt `02-design-proposal-remediation.md`.
2. Pass the Design Audit Report inline.
3. Update the target package directly when possible.
4. Persist `bundle/reports/02-design-proposal-remediation.md`.
...
- `bundle/reports/02-design-proposal-remediation.md`
