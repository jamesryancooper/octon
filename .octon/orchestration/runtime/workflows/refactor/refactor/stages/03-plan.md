...
1. Create a todo item for each file requiring changes:
   ...
   - [ ] `.octon/START.md` (4 occurrences)
   - [ ] `.octon/orchestration/runtime/workflows/example.md` (1 occurrence)
...
- [ ] `.octon/orchestration/runtime/workflows/promote-from-scratch.md` (rename + 3 changes)
- [ ] [... remaining files ...]
