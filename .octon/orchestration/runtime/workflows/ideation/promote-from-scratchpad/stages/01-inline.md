...
touch .octon/continuity/next.md
```
...
- [`.octon/ideation/scratchpad/README.md`](../../../../ideation/scratchpad/README.md) — Human-led zone (includes inbox, archive, projects)
- [`.octon/START.md`](../../../../START.md) — Visibility rules and routing
