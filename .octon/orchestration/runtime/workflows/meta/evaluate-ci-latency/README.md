...
This README summarizes the canonical workflow unit at `.octon/orchestration/runtime/workflows/meta/evaluate-ci-latency`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/orchestration/runtime/workflows/meta/evaluate-ci-latency/workflow.yml`.
...
- `policy_path` (file, required=false), default=`.octon/agency/practices/standards/ci-latency-policy.json`: Policy contract defining thresholds, window sizes, and issue semantics.
...
- Canonical contract: `.octon/orchestration/runtime/workflows/meta/evaluate-ci-latency/workflow.yml`
- Canonical stages: `.octon/orchestration/runtime/workflows/meta/evaluate-ci-latency/stages/`
