...
This README summarizes the canonical workflow unit at `.octon/orchestration/runtime/workflows/meta/create-architecture-proposal`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/orchestration/runtime/workflows/meta/create-architecture-proposal/workflow.yml`.
...
- `create_architecture_proposal_workflow_summary` -> `../../../../../.octon/output/reports/{{date}}-create-architecture-proposal.md`: Top-level workflow summary with proposal identity, validator outcome, and next steps
- `create_architecture_proposal_workflow_bundle` -> `../../../../../.octon/output/reports/workflows/{{date}}-create-architecture-proposal-{{proposal_id}}/`: Workflow execution bundle containing stage receipts, validation state, scaffold inventory, and validator evidence
- `create_architecture_proposal_validator_log` -> `../../../../../.octon/output/reports/workflows/{{date}}-create-architecture-proposal-{{proposal_id}}/standard-validator.log`: Captured stdout and stderr from the proposal validator stack
...
- Canonical contract: `.octon/orchestration/runtime/workflows/meta/create-architecture-proposal/workflow.yml`
- Canonical stages: `.octon/orchestration/runtime/workflows/meta/create-architecture-proposal/stages/`
