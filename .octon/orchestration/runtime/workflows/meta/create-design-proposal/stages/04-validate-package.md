...
1. Run:
   `bash .octon/assurance/runtime/_ops/scripts/validate-proposal-standard.sh --package ".proposals/design/<proposal_id>"`
2. Run:
   `bash .octon/assurance/runtime/_ops/scripts/validate-design-proposal.sh --package ".proposals/design/<proposal_id>"`
