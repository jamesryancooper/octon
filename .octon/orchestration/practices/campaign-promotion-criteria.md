...
- a future proposal asks to add `/.octon/orchestration/runtime/campaigns/`
...
- `/.octon/orchestration/runtime/campaigns/README.md`
- `/.octon/orchestration/runtime/campaigns/manifest.yml`
- `/.octon/orchestration/runtime/campaigns/registry.yml`
- `/.octon/orchestration/runtime/campaigns/<campaign-id>/campaign.yml`
- `/.octon/orchestration/runtime/campaigns/<campaign-id>/log.md`
- `/.octon/orchestration/runtime/campaigns/_ops/scripts/validate-campaigns.sh`
...
validator coverage inside live `/.octon/orchestration/` surfaces before
