...
- **`.octon/capabilities/services/<category>/<service>/`** is the unit of deployment for a service: one folder per service, containing its WASM artifact + runtime manifest (`service.json` — format defined in [spec-bundle.md §1](spec-bundle.md)).
...
- `.octon/capabilities/services/**/service.wasm`
- `.octon/capabilities/services/**/service.json`
...
- `.octon/continuity/**` (progress, tasks, session state)
