...
Audited all files under `.octon/framework/capabilities/skills/` across 14 dimensions from the audit plan.

Execution highlights:

- Ran baseline validator: `bash .octon/framework/capabilities/skills/scripts/validate-skills.sh` (exit `0`, "All checks passed")
...
- Affected files:
  - `.octon/framework/capabilities/skills/foundations/python-api/contract-first-api/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/python-api/contributor-guide/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/python-api/dev-toolchain/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/python-api/infra-manifest/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/python-api/test-harness/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/cli-interface/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/contributor-guide/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/daemon-service/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/data-layer/SKILL.md`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md`
...
- Affected files:
  - `.octon/framework/capabilities/skills/registry.yml:654`
  - `.octon/framework/capabilities/skills/registry.yml:655`
  - `.octon/framework/capabilities/skills/registry.yml:656`
  - `.octon/framework/capabilities/skills/registry.yml:657`
  - `.octon/framework/capabilities/skills/registry.yml:908`
  - `.octon/framework/capabilities/skills/registry.yml:909`
  - `.octon/framework/capabilities/skills/registry.yml:910`
  - `.octon/framework/capabilities/skills/registry.yml:911`
- Remediation:
...
- Affected paths:
  - `.octon/framework/capabilities/skills/runs/research-synthesizer/`
  - `.octon/framework/capabilities/skills/configs/research-synthesizer/`
- Remediation:
...
- Affected files:
  - `.octon/framework/capabilities/skills/logs/FORMAT.md:33`
  - `.octon/framework/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness.md:1`
  - `.octon/framework/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness-rerun.md:1`
- Remediation:
...
- Affected files:
  - `.octon/framework/capabilities/skills/README.md:47`
  - `.octon/framework/capabilities/skills/README.md:48`
  - `.octon/framework/capabilities/skills/README.md:150`
  - `.octon/framework/capabilities/skills/README.md:151`
  - `.octon/framework/capabilities/skills/README.md:152`
- Remediation:
...
- Affected files:
  - `.octon/framework/capabilities/skills/foundations/python-api/SKILL.md:43`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/SKILL.md:46`
- Notes:
...
1. Update `.octon/framework/capabilities/skills/README.md` to current architecture and schema terms.
