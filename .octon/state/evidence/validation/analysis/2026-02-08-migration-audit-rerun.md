...
| Line | 128 |
| Reference | `.octon/framework/orchestration/workflows/refactor/00-overview.md` |
| Correct path | `.octon/framework/orchestration/workflows/refactor(x)/00-overview.md` |
| Severity | MEDIUM |
...
| `.octon/state/evidence/validation/` | Historical output | 3 |
| `.octon/framework/capabilities/skills/archive/` | Archived content | 10+ |
