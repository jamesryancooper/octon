...
- **File:** `.octon/state/continuity/repo/tasks.json`
...
- **File:** `.octon/state/continuity/repo/entities.json`
...
### Clean files
- `.octon/state/continuity/repo/next.md` — clean
- `.octon/state/evidence/validation/` — clean (audit report uses correct paths)
...
All `.cursor/commands/` symlinks correctly resolve to `.octon/framework/capabilities/commands/`.
...
| E3 | `.cursor/commands/synthesize-research.md` | 34 | `.octon/drafts/` → doesn't exist | → `.octon/inputs/exploratory/drafts/` |
...
| E5 | `.cursor/commands/use-skill.md` | 32 | `.octon/framework/capabilities/skills/outputs/` → doesn't exist | → `.octon/inputs/exploratory/drafts/` |
...
- `synthesize-research.md`: `.octon/drafts/` → `.octon/inputs/exploratory/drafts/`, `skills.md` → `skills/README.md`
