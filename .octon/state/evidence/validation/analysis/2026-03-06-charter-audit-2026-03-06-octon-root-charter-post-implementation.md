...
- Method: Post-implementation charter rerun using only `.octon/framework/cognition/governance/CHARTER.md`
...
| --- | --- | --- | --- | --- |
| What | Octon is a governed autonomous engineering harness inside a managed filesystem boundary. | Sections 1, 2, 5 (`.octon/framework/cognition/governance/CHARTER.md:27-62`, `.octon/framework/cognition/governance/CHARTER.md:166-186`) | No | Identity and scope remain consistent. |
| Does | Octon binds material execution to explicit objective contracts and routing decisions before side effects. | Sections 8 and 9 (`.octon/framework/cognition/governance/CHARTER.md:244-314`) | No | The evidence model is now more explicit. |
| Why | Octon exists to deliver speed with governance integrity, bounded autonomy, durable continuity, privacy, and portability. | Section 3 and Section 13 (`.octon/framework/cognition/governance/CHARTER.md:64-117`, `.octon/framework/cognition/governance/CHARTER.md:384-414`) | No | Core claims now have matching success-signal hooks. |
| How | Octon resolves authority through precedence, accountability, bootstrap controls, artifact requirements, and normative fallbacks. | Sections 6, 7, 8, 10, 14, 15 (`.octon/framework/cognition/governance/CHARTER.md:188-234`, `.octon/framework/cognition/governance/CHARTER.md:251-327`, `.octon/framework/cognition/governance/CHARTER.md:417-457`) | No | The control path is closed-book operable. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `.octon/framework/cognition/governance/CHARTER.md:142-145` | MUST | Same-change and linked approval evidence now govern divergence and equivalent reviews. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:149-155` | MUST | Routing prerequisites, blocked-state evidence, measurement records, and approved workspace conventions are defined. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:215-233` | MUST | Accountability map includes materiality classification and equivalent governance review selection. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:251-281` | MUST | Baseline artifact fields, blocked-state evidence, and continuity append-only behavior are required. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:296-314` | MUST | Divergence handling, same-change evidence, and routing-marker proof are explicit. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:318-331` | MUST | `alignment-check` and equivalent assurance entrypoints have a minimum required check set. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:386-414` | MUST | Success signals now define scope, owner, method, reporting artifact, and signal-specific checks. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:424-434` | MUST | Change control now explicitly governs equivalent governance review substitution. | Yes | Yes | Low | None |
| `.octon/framework/cognition/governance/CHARTER.md:453-457` | MUST / MAY | Dependency fallback text now distinguishes planning-only fallback from material execution. | Yes | Yes | Low | None |
...
| `/.octon/framework/engine/runtime/spec/intent-contract-v1.schema.json` | Intent-contract validation | High | Material execution that requires schema validation blocks; planning-only fallback remains allowed. | Already provided in `§15`. |
| `/.octon/framework/agency/governance/delegation-boundaries-v1.yml` and schema | Deterministic routing support | High | Material execution that requires deterministic routing blocks; planning-only fallback remains allowed. | Already provided in `§15`. |
| `/.octon/framework/cognition/governance/principles/principles.md` | Protected constitutional principles authority | Medium | Protected-governance edits remain blocked; unrelated authority does not expand. | Already provided in `§15`. |
