...
- `docs/services/<path>.md` -> `.octon/framework/capabilities/services/<path>.md`
- `docs/services/README.md` -> `.octon/framework/capabilities/services/_meta/docs/platform-overview.md`
...
Active harness docs now reference `.octon/framework/capabilities/services/**` (not deleted `docs/services/**`).
...
- `.octon/framework/cognition/principles/README.md`
- `.octon/framework/cognition/pillars/README.md`
- `.octon/framework/cognition/purpose/README.md`

## Notes

Historical records under `.octon/generated/**` and ideation artifacts under `.octon/inputs/exploratory/ideation/**` may still reference old `docs/...` paths for provenance. These were intentionally not rewritten in this audit.
