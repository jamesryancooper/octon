...
**Scope:** 89 manifest lines (88 unique files) across `.octon/framework/assurance`, `.octon/runtime/crates/assurance_tools`, `.github`, `.octon/generated/assurance`, and ADR `018-assurance-umbrella-chain-migration.md`  
...
1. `.octon/framework/cognition/decisions/018-assurance-umbrella-chain-migration.md:10`  
   Old chain appears as historical baseline in migration ADR.
2. `.octon/framework/assurance/CHANGELOG.md:12`  
...
- Two extracted tokens were symbolic prose references, not filesystem targets:
  - `.octon/framework/assurance/DOCTRINE.md:5` -> `quality/` (historical naming context)
  - `.octon/framework/assurance/governance/SUBSYSTEM_OVERRIDE_POLICY.md:52` -> `weights.yml` (generic file-name mention)
...
- `.octon/framework/assurance/standards/weights/weights.md`
- `.octon/framework/assurance/README.md`
- `.octon/framework/assurance/DOCTRINE.md`
- `.octon/framework/assurance/governance/SUBSYSTEM_OVERRIDE_POLICY.md`
...
- `bash .octon/framework/assurance/_ops/scripts/alignment-check.sh --profile weights` -> **PASS** (compute + gate)
...
- `.octon/runtime/crates/assurance_tools/src/main.rs`
- `.octon/framework/assurance/standards/weights/weights.yml`
- `.octon/framework/assurance/_ops/scripts/alignment-check.sh`
- `.github/workflows/assurance-weight-gates.yml`
- `.octon/generated/assurance/**` (legacy fields not present)
...
- `.archive/**`
- `.octon/inputs/exploratory/packages/2026-02-18-quality-charter-qge-integration/**`
