...
1. `legacy quality subsystem root` -> `.octon/framework/assurance/`
2. `legacy quality tools crate` -> `.octon/framework/engine/runtime/crates/assurance_tools`
3. `legacy quality weight-gates workflow` -> `.github/workflows/assurance-weight-gates.yml`
4. `legacy quality output root` -> `.octon/generated/assurance/`
...
- `.octon/inputs/exploratory/ideation/**` (human-led by contract)
- `.archive/**`
- `.octon/state/evidence/validation/**` (historical continuity)
- `.octon/inputs/exploratory/plans/**` (historical planning artifacts)
- `.octon/runtime/crates/target/**` (build outputs)
- `.octon/runtime/_ops/state/**` (runtime mutable state)
- `.octon/framework/capabilities/services/_ops/state/**` (service mutable state)
- `.git/**`
...
1. `.octon/framework/capabilities/services/retrieval/parse/README.md:39` -> `.octon/framework/capabilities/services/retrieval/parse/schema/input.schema.json`
2. `.octon/framework/capabilities/services/retrieval/parse/README.md:39` -> `.octon/framework/capabilities/services/retrieval/parse/schema/output.schema.json`
3. `.octon/framework/capabilities/services/retrieval/parse/README.md:152` -> `.octon/framework/capabilities/services/retrieval/parse/schema/input.schema.json`
4. `.octon/framework/capabilities/services/retrieval/parse/README.md:153` -> `.octon/framework/capabilities/services/retrieval/parse/schema/output.schema.json`
5. `.octon/framework/capabilities/skills/foundations/python-api/contributor-guide/SKILL.md:109` -> `.github/workflows/ci.yml`
6. `.octon/framework/capabilities/skills/foundations/swift-macos-app/test-harness/SKILL.md:137` -> `.github/workflows/ci.yml`
7. `.octon/framework/capabilities/skills/platforms/deploy-status/SKILL.md:61` -> `.octon/framework/capabilities/skills/_ops/state/logs/deploy-status/`
8. `.octon/framework/cognition/_meta/architecture/README.md:722` -> `.octon/framework/capabilities/skills/synthesize-research/`
9. `.octon/framework/cognition/principles/README.md:107` -> `.octon/framework/cognition/principles/pillars/README.md`
