...
- Step 12 (regression guardrails): PASS
  - Added `/.octon/framework/assurance/runtime/_ops/scripts/validate-framing-alignment.sh`.
...
- Step 13 (final convergence): PASS
  ...
  - `bash .octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh --profile harness` -> PASS (`errors=0`)
  - `bash .octon/framework/assurance/runtime/_ops/scripts/compute-assurance-score.sh --weights .octon/framework/assurance/governance/weights/weights.yml --scores .octon/framework/assurance/governance/scores/scores.yml` -> PASS
...
1. `/.octon/instance/cognition/decisions/009-manifest-discovery-and-validation.md`
2. `/.octon/instance/cognition/decisions/017-assurance-clean-break-migration.md`
