...
### 1. `.octon/instance/bootstrap/catalog.md` — Broken relative paths (6 instances) — FIXED
...
|------|---------|-----------|
| 70 | `[create-workflow.md](../.octon/framework/capabilities/commands/create-workflow.md)` | `[create-workflow.md](./capabilities/commands/create-workflow.md)` |
| 71 | `[evaluate-workflow.md](../.octon/framework/capabilities/commands/evaluate-workflow.md)` | `[evaluate-workflow.md](./capabilities/commands/evaluate-workflow.md)` |
| 72 | `[update-workflow.md](../.octon/framework/capabilities/commands/update-workflow.md)` | `[update-workflow.md](./capabilities/commands/update-workflow.md)` |
| 106 | `[create-workflow](../.octon/framework/orchestration/workflows/workflows/create-workflow/00-overview.md)` | `[create-workflow](./orchestration/workflows/workflows/create-workflow/00-overview.md)` |
| 107 | `[evaluate-workflow](../.octon/framework/orchestration/workflows/workflows/evaluate-workflow/00-overview.md)` | `[evaluate-workflow](./orchestration/workflows/workflows/evaluate-workflow/00-overview.md)` |
| 108 | `[update-workflow](../.octon/framework/orchestration/workflows/workflows/update-workflow/00-overview.md)` | `[update-workflow](./orchestration/workflows/workflows/update-workflow/00-overview.md)` |

### 2. `.octon/framework/cognition/context/primitives.md` — Stale `.octon/missions/` paths (3 instances) — FIXED

| Line | Current | Should Be |
|------|---------|-----------|
| 113 | `.octon/missions/<mission-id>/mission.yml` | `.octon/framework/orchestration/missions/<mission-id>/mission.yml` |
| 568 | `.octon/missions/registry.yml` | `.octon/framework/orchestration/missions/registry.yml` |
| 568 | `.octon/missions/_template/` | `.octon/framework/orchestration/missions/_template/` |

### 3. `.octon/framework/orchestration/workflows/skills(x)/create-skill/05-update-catalog.md` — Old filename convention (2 instances) — FIXED
...
### 4. `.octon/framework/orchestration/workflows/workspace/create-workspace/07-verify.md` — Old directory name — FIXED
...
### 6. `.octon/framework/cognition/analyses/workflows-vs-skills-analysis.md` — Stale `.octon/missions/` (4 instances) — FIXED

This is an analysis document (not operational) but is referenced from other active files.

| Line | Current | Should Be |
|------|---------|-----------|
| 604 | `Location: .octon/missions/` | `Location: .octon/framework/orchestration/missions/` |
| 820 | `Missions ... .octon/missions/` | `.octon/framework/orchestration/missions/` |
| 874 | `.octon/missions/_template/` | `.octon/framework/orchestration/missions/_template/` |
| 642 | `# .octon/missions/auth-migration/mission.yml` | `.octon/framework/orchestration/missions/auth-migration/mission.yml` |

### 7. `.octon/framework/orchestration/workflows/workflows/create-workflow/00-overview.md` — Wrong directory names (1 instance) — FIXED

| Line | Current | Should Be |
|------|---------|-----------|
| 95 | `.octon/framework/orchestration/workflows/refactor/`, `.../skills/create-skill/` | `.octon/framework/orchestration/workflows/refactor(x)/`, `.../skills(x)/create-skill/` |

### 8. `.octon/framework/orchestration/workflows/projects/create-project.md` — Broken relative paths (3 instances) — FIXED
...
### 9. `.octon/framework/agency/agents/software-architect/audit-agent.md` — Broken markdown link (1 instance) — FIXED

| Line | Current | Should Be |
|------|---------|-----------|
| 3 | `[agent.md](.octon/framework/agency/agents/software-architect/agent.md)` | `[agent.md](./agent.md)` |
...
### 10. `.octon/inputs/exploratory/ideation/scratchpad/inbox/README.md` — 8 stale `.workspace/` references — FIXED

| Line | Current | Should Be |
|------|---------|-----------|
| 28 | `.workspace/projects/` | `.octon/inputs/exploratory/ideation/projects/` |
| 29 | `.workspace/context/decisions.md` | `.octon/framework/cognition/context/decisions.md` |
| 30 | `Parent directory (outside .workspace/)` | `Parent directory (outside .octon/)` |
| 95 | `.workspace/context/decisions.md` | `.octon/framework/cognition/context/decisions.md` |
| 114 | `.workspace/.scratchpad/README.md` | `.octon/inputs/exploratory/ideation/scratchpad/README.md` |
| 115 | `.workspace/.scratchpad/brainstorm/README.md` | `.octon/inputs/exploratory/ideation/scratchpad/brainstorm/README.md` |
| 116 | `.workspace/projects/README.md` | `.octon/inputs/exploratory/ideation/projects/README.md` |
| 117 | `.workspace/START.md` | `.octon/instance/bootstrap/START.md` |

### 11. `.octon/inputs/exploratory/ideation/scratchpad/README.md` — Diagram showing old structure — FIXED

| Line | Current | Should Be |
|------|---------|-----------|
| 33 | `.scratchpad/ ... .workspace/` | `.scratchpad/ ... .octon/` |

### 12. `.octon/framework/capabilities/skills/refactor/references/phases.md` — Example uses old paths (4 instances) — FIXED

Lines 246, 304, 335, 525 updated from `.workspace/.scratch/` to `.octon/inputs/exploratory/ideation/.scratch/` (source paths in refactoring example).
...
### `.octon/framework/orchestration/workflows/workspace/migrate-workspace/` (3 instances)
...
- `.octon/inputs/exploratory/ideation/scratchpad/archive/` — Archived analysis documents
- `.octon/framework/capabilities/skills/archive/v1-archetype-model/` — Archived skill template model
- `.octon/framework/cognition/decisions/` — ADRs documenting the migration (intentional historical references)
