...
- Dataset: '/Users/jamesryancooper/Projects/octon/.octon/framework/capabilities/services/retrieval/query/fixtures/eval-routes.jsonl'
...
|---|---|---:|---:|---|---|---:|---:|---:|
| `route-hierarchical-001` | `hierarchical` | `0` | `1` | `success` | `success` | `1` | `224` | `243` |
| `route-graph-global-001` | `graph_global` | `0` | `1` | `success` | `success` | `1` | `185` | `235` |
