...
- `.octon/inputs/exploratory/packages/2026-02-19-ae-umbrella-clean-break`
...
- **Files:**
  - `.octon/inputs/exploratory/packages/2026-02-19-ae-umbrella-clean-break/AE_TEST_PLAN.md:27`
  - `.octon/inputs/exploratory/packages/2026-02-19-ae-umbrella-clean-break/AE_TEST_PLAN.md:42`
...
- **Files:**
  - `.octon/inputs/exploratory/packages/2026-02-19-ae-umbrella-clean-break/AE_DOCS_PATCH.md:81`
  - `.octon/inputs/exploratory/packages/2026-02-19-ae-umbrella-clean-break/AE_IMPLEMENTATION_PATCHLIST.md:202`
- **Evidence:** References like `.octon/framework/assurance/**` and `.octon/generated/assurance/**` are glob shorthand, not literal resolvable paths.
...
- `.octon/framework/assurance/standards/weights/weights.yml`
- `.octon/runtime/crates/assurance_tools/src/main.rs`
- `.github/workflows/assurance-weight-gates.yml`
- `.octon/generated/effective/assurance/repo-octon__run-mode-ci__maturity-beta__profile-ci-reliability.md`
- `.octon/generated/assurance/results/repo-octon__run-mode-ci__maturity-beta__profile-ci-reliability.md`
- `.octon/generated/assurance/policy/deviations/repo-octon__run-mode-ci__maturity-beta__profile-ci-reliability.md`
...
- `.octon/inputs/exploratory/packages/2026-02-18-quality-charter-qge-integration/**` (historical pre-migration report set)
