...
- `.octon/framework/orchestration/workflows/meta/create-skill(x)/**`
...
Evidence:
- `.octon/framework/capabilities/skills/README.md:5`
- `.octon/framework/capabilities/skills/README.md:74`
- `.octon/framework/capabilities/skills/README.md:107`
- `.octon/framework/capabilities/skills/README.md:240`
- `.octon/framework/capabilities/skills/README.md:455`
- `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:335`
- `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:336`
- `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:337`
- `.octon/framework/capabilities/skills/synthesis/refine-prompt/references/errors.md:206`
- `.octon/framework/capabilities/skills/synthesis/synthesize-research/references/errors.md:251`
...
Evidence:
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:13`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:130`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:141`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:172`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:236`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:310`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:338`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:393`
- `.octon/framework/capabilities/skills/meta/create-skill/references/phases.md:249`
- `.octon/framework/capabilities/skills/_template/references/checkpoints.md:238`
- `.octon/framework/orchestration/workflows/meta/create-skill(x)/02-copy-template.md:23`
- `.octon/framework/orchestration/workflows/meta/create-skill(x)/03-initialize-skill.md:30`
- `.octon/framework/orchestration/workflows/meta/create-skill(x)/06-report-success.md:29`

Observed drift:
- Uses flat skill path examples (`.octon/framework/capabilities/skills/{{skill_name}}/`) instead of grouped paths.
...
Evidence:
- Validator overlap notes count: 81 pair overlaps from `.octon/state/evidence/validation/.tmp/validate.normal.out`.
...
Evidence:
- Specified pattern: `.octon/framework/capabilities/skills/_state/logs/{{skill_id}}/{{timestamp}}-{{skill_id}}.md` at `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:20`
- Specified timestamp format: `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:23`
- Observed files:
  - `.octon/framework/capabilities/skills/_state/logs/audit-migration/2026-02-08-workspace-to-harness.md`
  - `.octon/framework/capabilities/skills/_state/logs/audit-migration/2026-02-08-workspace-to-harness-rerun.md`
...
- Machine-readable findings: `.octon/state/evidence/validation/analysis/2026-02-11-skills-bounded-audit-findings.yml`
- Raw intermediate data: `.octon/state/evidence/validation/.tmp/`
