...
- Dataset: '/Users/jamesryancooper/Projects/octon/.octon/framework/capabilities/services/retrieval/query/fixtures/eval-baseline.jsonl'
...
- Run records emitted to '.octon/framework/capabilities/services/_ops/state/runs/query/' include span evidence:
  - 'service.query.ask'
