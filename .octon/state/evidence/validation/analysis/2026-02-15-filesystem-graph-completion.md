...
- `bash .octon/framework/capabilities/services/interfaces/filesystem-graph/impl/snapshot-build.sh --root . --set-current true`
...
- `discover.expand` from `dir:.octon/framework/cognition/context`
