...
- Validator baseline: `.octon/framework/capabilities/skills/_scripts/validate-skills.sh` and `--strict` both passed
...
- **Files:**
  ...
  - `.octon/framework/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md:7`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md:7`
...
- **Severity:** important
- **Files:**
  - `.octon/framework/capabilities/skills/meta/create-skill/SKILL.md:73`
  - `.octon/framework/capabilities/skills/meta/create-skill/SKILL.md:74`
  - `.octon/framework/capabilities/skills/meta/create-skill/references/io-contract.md:32`
  - `.octon/framework/capabilities/skills/meta/create-skill/references/io-contract.md:52`
  - `.octon/framework/capabilities/skills/meta/create-skill/references/io-contract.md:78`
  - `.octon/framework/capabilities/skills/registry.yml:1083`
...
- **Severity:** important
- **Files:**
  - `.octon/framework/capabilities/skills/_scripts/validate-skills.sh:14`
  - `.octon/framework/capabilities/skills/_scripts/validate-skills.sh:42`
  - `.octon/framework/capabilities/skills/_scripts/validate-skills.sh:2424`
  - `.octon/framework/capabilities/skills/_scripts/validate-skills.sh:2428`
  - `.octon/framework/capabilities/skills/_scripts/validate-skills.sh:1469`
...
- **Severity:** critical
- **Files:**
  - `.octon/framework/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/python-api/contract-first-api/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/python-api/test-harness/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/python-api/dev-toolchain/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/python-api/infra-manifest/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/python-api/contributor-guide/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/data-layer/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/cli-interface/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/daemon-service/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/test-harness/SKILL.md:10`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/contributor-guide/SKILL.md:10`
  - `.octon/framework/capabilities/skills/meta/build-mcp-server/SKILL.md:18`
...
- **Severity:** important
- **Files:**
  - `.octon/framework/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md:18`
  - `.octon/framework/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md:18`
...
- **Severity:** minor
- **Files:**
  - `.octon/framework/capabilities/skills/foundations/react/composition-patterns/references/rules.md:1`
  - `.octon/framework/capabilities/skills/foundations/react/best-practices/references/rules.md:1`
  - `.octon/framework/capabilities/skills/foundations/react-native/best-practices/references/rules.md:1`
  - `.octon/framework/capabilities/skills/foundations/postgres/best-practices/references/rules.md:1`
...
- **Severity:** critical
- **Files:**
  - `.octon/framework/capabilities/skills/_scripts/setup-harness-links.sh:13`
  - `.octon/framework/capabilities/skills/_scripts/setup-harness-links.sh:16`
  - `.octon/framework/capabilities/skills/_scripts/setup-harness-links.sh:39`
  - `.octon/framework/capabilities/skills/_scripts/setup-harness-links.sh:58`
  - `.octon/framework/capabilities/skills/_scripts/setup-harness-links.sh:97`
- **Description:** Script computes repo root incorrectly and assumes flat skill directories.
- **Evidence:** Running script reports skills path as `.../.octon/.octon/framework/capabilities/skills` and discovers none; single-skill mode fails for `create-skill`.
...
- **Severity:** important
- **Files:**
  - `.octon/framework/capabilities/skills/_scripts/generate-reference-headers.sh:191`
  - `.octon/framework/capabilities/skills/_scripts/generate-reference-headers.sh:205`
  - `.octon/framework/capabilities/skills/_scripts/generate-reference-headers.sh:250`
...
- **Severity:** important
- **Files:**
  - `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:20`
  - `.octon/framework/capabilities/skills/_state/logs/FORMAT.md:183`
  - `.octon/framework/capabilities/skills/_state/logs/index.yml:10`
  - `.octon/framework/capabilities/skills/_state/logs/index.yml:13`
...
- **Severity:** important
- **Files:**
  - `.octon/framework/orchestration/workflows/meta/create-skill(x)/00-overview.md:68`
  - `.octon/framework/orchestration/workflows/meta/create-skill(x)/00-overview.md:82`
  - `.octon/framework/orchestration/workflows/meta/create-skill(x)/02-copy-template.md:21`
  - `.octon/framework/orchestration/workflows/meta/create-skill(x)/02-copy-template.md:32`
  - `.octon/framework/orchestration/workflows/meta/create-skill(x)/03-initialize-skill.md:51`
  - `.octon/framework/orchestration/workflows/meta/create-skill(x)/06-report-success.md:27`
...
- **Severity:** important
- **Files:**
  - `.octon/framework/cognition/analyses/workflows-vs-skills-analysis.md:190`
  - `.octon/framework/cognition/analyses/workflows-vs-skills-analysis.md:558`
  - `.octon/framework/cognition/context/decisions.md:53`
  - `.octon/framework/cognition/decisions/001-octon-shared-foundation.md:59`
...
1. Fix `.octon/framework/capabilities/skills/_scripts/setup-harness-links.sh` for correct root + manifest-path discovery.
...
1. Fix `.octon/framework/capabilities/skills/_scripts/generate-reference-headers.sh` grouped-path resolution.
