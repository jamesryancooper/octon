...
Source plan: `.octon/inputs/exploratory/proposals/.git-github-workflow/autonomy-first-patch-plan.md`
...
17. `.octon/framework/agency/_ops/scripts/git/git-wt-new.sh`: **covered**

18. `.octon/framework/agency/_ops/scripts/git/git-pr-open.sh`: **covered**

19. `.octon/framework/agency/_ops/scripts/git/git-pr-ship.sh`: **covered**

20. `.octon/framework/agency/_ops/scripts/github/sync-github-labels.sh`: **covered**

21. `.octon/framework/agency/practices/git-autonomy-playbook.md`: **covered**
...
- Metrics baseline run captured in:
  `.octon/state/evidence/validation/analysis/2026-03-03-week4-stabilization-baseline.md`
