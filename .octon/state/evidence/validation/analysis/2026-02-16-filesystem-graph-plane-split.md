...
- `.octon/framework/capabilities/services/manifest.runtime.yml`
- `.octon/framework/capabilities/services/registry.runtime.yml`
...
- `.octon/framework/capabilities/services/capabilities.yml` (adds `interfaces` category)
...
- `bash .octon/framework/capabilities/services/_ops/scripts/validate-services.sh`
- `bash .octon/framework/capabilities/services/_ops/scripts/validate-service-independence.sh --mode services-core`
- `.octon/runtime/run validate`
- `bash .octon/framework/capabilities/services/_ops/scripts/validate-filesystem-graph.sh`
- `bash .octon/framework/capabilities/services/_ops/scripts/test-filesystem-graph-determinism.sh`
- `bash .octon/framework/capabilities/services/_ops/scripts/test-filesystem-graph-integration.sh`
- `bash .octon/framework/capabilities/services/_ops/scripts/test-filesystem-graph-slo.sh --profile ci --no-report`
- `bash .octon/framework/capabilities/services/_ops/scripts/test-filesystem-graph-perf-regression.sh --profile ci --no-report`
- `FILESYSTEM_GRAPH_VALIDATE_SLO=1 FILESYSTEM_GRAPH_VALIDATE_PERF=1 bash .octon/framework/capabilities/services/_ops/scripts/validate-filesystem-graph.sh`
