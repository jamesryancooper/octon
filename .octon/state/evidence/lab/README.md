...
`state/evidence/lab/**` stores retained behavioral and support-claim evidence
that does not belong to one run root only.

Canonical families:

- `scenarios/**` for scenario proof bundles and replay-facing exercises
- `replays/**` for retained replay bundles
