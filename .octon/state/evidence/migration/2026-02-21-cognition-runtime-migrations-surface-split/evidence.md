...
- Dated migration records under:
  - `/.octon/framework/cognition/practices/methodology/migrations/<YYYY-MM-DD>-<slug>/`
- Root-level migration evidence reports under:
  - `/.octon/state/evidence/validation/<YYYY-MM-DD>-<slug>/evidence.md` (migration evidence class)

Canonical replacement:

- Runtime migration records under:
  - `/.octon/instance/cognition/context/shared/migrations/<YYYY-MM-DD>-<slug>/`
...
```bash
find .octon/framework/cognition/practices/methodology/migrations \
...
rg -n "cognition/practices/methodology/migrations/20|output/reports/[0-9]{4}-[0-9]{2}-[0-9]{2}.*evidence\.md" .octon \
  ...
  --glob '!.octon/framework/cognition/practices/methodology/migrations/legacy-banlist.md' || true
```
