...
```bash
git mv .octon/framework/cognition/_meta/architecture/content-plane \
  .octon/framework/cognition/_meta/architecture/artifact-surface

git mv .octon/framework/cognition/_meta/architecture/artifact-surface/runtime-content-layer.md \
  .octon/framework/cognition/_meta/architecture/artifact-surface/runtime-artifact-layer.md
```
...
git diff --check -- \
  .octon/framework/cognition/_meta/architecture/artifact-surface \
  .octon/instance/cognition/context/shared/knowledge-plane/knowledge-plane.md \
