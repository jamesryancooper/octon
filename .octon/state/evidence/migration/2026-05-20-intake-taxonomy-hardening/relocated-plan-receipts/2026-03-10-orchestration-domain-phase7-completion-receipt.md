...
- added continuity-owned approval artifact location guidance:
  - `.octon/state/evidence/decisions/repo/approvals/README.md`
- added runtime approval verification:
  - `.octon/framework/orchestration/runtime/_ops/scripts/verify-approval-artifact.sh`
...
- added the live runtime incidents surface:
  - `.octon/framework/orchestration/runtime/incidents/README.md`
  - `.octon/framework/orchestration/runtime/incidents/index.yml`
- added runtime incident lifecycle operations:
  - `.octon/framework/orchestration/runtime/_ops/scripts/manage-incident.sh`
- strengthened incident validation:
  - `.octon/framework/orchestration/runtime/incidents/_ops/scripts/validate-incidents.sh`
...
- `bash -n .octon/framework/orchestration/runtime/_ops/scripts/verify-approval-artifact.sh`
- `bash -n .octon/framework/orchestration/runtime/_ops/scripts/manage-incident.sh`
- `bash -n .octon/framework/orchestration/runtime/_ops/tests/test-incident-approval-control.sh`
