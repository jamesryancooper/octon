...
POLICY_FILE="$REPO_ROOT/.octon/agency/practices/standards/ci-latency-policy.json"
DEFAULT_OUT_DIR="$REPO_ROOT/.octon/output/reports"
...
cargo run --quiet \
  --manifest-path "$REPO_ROOT/.octon/engine/runtime/crates/Cargo.toml" \
