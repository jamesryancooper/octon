...
- Shared policy: `.octon/agency/practices/standards/ci-latency-policy.json`
- Shared wrapper: `.octon/agency/_ops/scripts/ci/audit-ci-latency.sh`
...
- No `.octon/orchestration/runtime/automations/*` entry yet; GitHub Actions is the periodic executor in this phase
