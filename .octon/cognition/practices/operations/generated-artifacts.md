...
- `/.octon/cognition/runtime/projections/materialized/cognition-runtime-surface-map.latest.yml`
- `/.octon/cognition/runtime/evidence/index.yml`
- `/.octon/cognition/runtime/evaluations/digests/index.yml`
- `/.octon/cognition/runtime/evaluations/actions/open-actions.yml`
- `/.octon/cognition/runtime/knowledge/graph/nodes.yml`
- `/.octon/cognition/runtime/knowledge/graph/edges.yml`
- `/.octon/cognition/runtime/knowledge/sources/ingestion-receipts.yml`

## Canonical Tooling

- Sync/apply: `bash .octon/cognition/_ops/runtime/scripts/sync-runtime-artifacts.sh`
- Drift check: `bash .octon/cognition/_ops/runtime/scripts/sync-runtime-artifacts.sh --check`
- Targeted decisions sync: `bash .octon/cognition/_ops/runtime/scripts/generate-runtime-decisions.sh`
- Targeted projections sync: `bash .octon/cognition/_ops/runtime/scripts/generate-runtime-projections.sh`
- Targeted evidence sync: `bash .octon/cognition/_ops/runtime/scripts/generate-runtime-evidence.sh`
- Targeted evaluations sync: `bash .octon/cognition/_ops/runtime/scripts/generate-runtime-evaluations.sh`
- Targeted knowledge sync: `bash .octon/cognition/_ops/runtime/scripts/generate-runtime-knowledge.sh`
- Full validator: `bash .octon/cognition/_ops/runtime/scripts/validate-generated-runtime-artifacts.sh`
- Fixture tests: `bash .octon/cognition/_ops/runtime/scripts/test-sync-runtime-artifacts-fixtures.sh`
