...
description: How to run Octon's spec-first planning loop end-to-end, including tiered spec templates, the feature story pattern, and AI-assisted workflow.
...
This guide details Octon's spec-first planning loop and AI-assisted workflow. It expands the methodology overview with concrete steps, templates, and prompts. For the high-level lifecycle diagram and context, see the main Octon Methodology overview.
...
Octon uses a **three-tier risk classification** to right-size specs and reviews. AI agents determine the tier and select the appropriate template automatically.
...
```bash
octon spec "description of what you want"
# or
octon fix "bug description or issue number"
```
