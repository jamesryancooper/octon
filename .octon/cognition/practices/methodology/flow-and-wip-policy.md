...
description: Octon's Kanban policy for a solo developer, including board columns, WIP limits, tiered risk classification, and Definitions of Ready/Done/Safe/Small.
...
This document expands the brief flow and WIP guidance in the Octon Methodology overview. Use it as the canonical reference for board columns, WIP limits, Definitions of Ready/Done/Safe/Small, and the tiered risk classification system.

---

## Risk Tiers Overview

Octon uses a **three-tier risk classification** that determines spec detail, gates, and human review requirements.
...
The flow and WIP policy serves Octon's [Six Pillars](../../governance/pillars/README.md) by operationalizing key principles from the PLAN and SHIP phases.
