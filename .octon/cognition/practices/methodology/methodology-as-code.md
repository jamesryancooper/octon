...
- name: Validate methodology alignment
  run: bash .octon/assurance/runtime/_ops/scripts/alignment-check.sh --profile harness,framing
```
...
4. **Methodology discovery contracts**
   ...
   - `/.octon/cognition/practices/methodology/*/*.yml` index surfaces
5. **Tier and workflow contracts**
   - `/.octon/cognition/practices/methodology/templates/spec-tier*.yaml`
   - `/.octon/cognition/practices/methodology/migrations/*`
   - `/.octon/cognition/practices/methodology/audits/*`
6. **Narrative methodology docs**
   - `/.octon/cognition/practices/methodology/*.md`
