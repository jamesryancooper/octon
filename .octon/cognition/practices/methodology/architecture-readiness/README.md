...
description: Clean-break methodology for evaluating Octon whole-harness and bounded-surface domain architecture readiness.
...
This methodology defines how Octon evaluates architecture readiness as a
bounded audit, without force-fitting the framework onto unsupported domain
profiles.

## Supported Targets

- `/.octon/` as `whole-harness`
