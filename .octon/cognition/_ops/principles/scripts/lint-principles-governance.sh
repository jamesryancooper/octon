...
REFERENCE_LINT="${REFERENCE_LINT_OVERRIDE:-.octon/cognition/_ops/principles/scripts/reference-lint.sh}"
OVERRIDE_LEDGER="${PRINCIPLES_OVERRIDE_LEDGER_OVERRIDE:-.octon/cognition/governance/exceptions/principles-charter-overrides.md}"
PRINCIPLES_INDEX="$PRINCIPLES_DIR/index.yml"
CHARTER_MAP="$PRINCIPLES_DIR/charter-map.yml"
CONTROLS_DIR=".octon/cognition/governance/controls"
...
TIER2_TEMPLATE=".octon/cognition/practices/methodology/templates/spec-tier2.yaml"
TIER3_TEMPLATE=".octon/cognition/practices/methodology/templates/spec-tier3.yaml"
...
check_contraction_finalize_glossary() {
  local glossary=".octon/cognition/governance/controls/ra-acp-glossary.md"
