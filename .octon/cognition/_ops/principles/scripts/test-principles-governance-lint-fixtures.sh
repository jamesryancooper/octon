...
PRINCIPLES_DIR=".octon/cognition/governance/principles"
LINT_SCRIPT=".octon/cognition/_ops/principles/scripts/lint-principles-governance.sh"
...
assert_lint_fails_with_fixture "stale-reference" \
  "Legacy path: .octon/cognition/principles/pillars/trust.md"
