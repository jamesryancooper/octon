...
- When arbitration is applied, write an append-only decision record (for example ADR under `.octon/cognition/runtime/decisions/`).
- Include arbitration rationale and affected rule IDs in run receipts/digests (for example `.octon/continuity/runs/*/receipt.json` note fields).
...
- `.octon/cognition/governance/principles/charter-map.yml`
- `.octon/cognition/governance/principles/arbitration-and-precedence.md`
- `.octon/cognition/governance/controls/convivial-impact-minimums.md`
