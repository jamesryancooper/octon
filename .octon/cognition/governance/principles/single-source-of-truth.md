...
```markdown
<!-- Source: /.octon/cognition/runtime/decisions/<adr-file>.md -->
...
```markdown
<!-- Reference: .octon/cognition/_meta/architecture/overview.md -->
We use PostgreSQL as our primary data store
(see `ADR-0001` in `.octon/cognition/runtime/decisions/` for rationale).
```
