...
`/.octon/cognition/governance/principles/principles.md` made under explicit
human override.
...
- exception_log_ref: ADR-042 (`/.octon/cognition/runtime/decisions/042-principles-charter-human-override-direct-edit-policy.md`)
...
- exception_log_ref: OVR-2026-03-04-001 (this append-only record), authorized under ADR-042 (`/.octon/cognition/runtime/decisions/042-principles-charter-human-override-direct-edit-policy.md`)
- authorized_by: repository policy author
- authorization_source: explicit human override request in active session
- break_glass: false
- status: active
...
- exception_log_ref: OVR-2026-03-13-001 (this append-only record), authorized under ADR-042 (`/.octon/cognition/runtime/decisions/042-principles-charter-human-override-direct-edit-policy.md`)
- authorized_by: repository policy author
- authorization_source: explicit human override request in active session
- break_glass: false
- status: active
