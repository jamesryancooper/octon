...
|------|---------------|------------------|----------|
| `.octon/orchestration/runtime/workflows/_scaffold/template/` | 00-overview.md, 01-step.md, NN-verify.md, README.md | Scaffolding template | Draft |
| `.octon/orchestration/runtime/workflows/workspace/create-workspace/` | 00-overview.md + 6 step files | Scaffold new .octon directory | Draft/Functional |
| `.octon/orchestration/runtime/workflows/workspace/update-workspace/` | 00-overview.md + 5 step files | Align workspace with canonical definition | Draft/Functional |
| `.octon/orchestration/runtime/workflows/workspace/evaluate-workspace/` | 00-overview.md + 3 step files | Assess token efficiency | Draft/Functional |
| `.octon/orchestration/runtime/workflows/workspace/migrate-workspace/` | 00-overview.md + 4 step files | Migrate workspace structure | Draft |
| `.octon/orchestration/runtime/workflows/workflows/create-workflow/` | 00-overview.md + 8 step files | Scaffold new workflow | Draft/Meta |
| `.octon/orchestration/runtime/workflows/workflows/update-workflow/` | 00-overview.md + 5 step files | Modify existing workflow | Draft/Meta |
| `.octon/orchestration/runtime/workflows/workflows/evaluate-workflow/` | 00-overview.md + 5 step files | Assess workflow quality | Draft/Meta |
| `.octon/orchestration/runtime/workflows/refactor/` | 00-overview.md + 6 step files | Execute verified codebase refactor | Draft/Functional |
| `.octon/orchestration/runtime/workflows/missions/create-mission/` | 00-overview.md | Scaffold new mission | Draft |
| `.octon/orchestration/runtime/workflows/missions/complete-mission/` | 00-overview.md | Archive completed mission | Draft |
| `.octon/orchestration/runtime/workflows/skills/create-skill/` | 00-overview.md + 6 step files | Scaffold new skill | Draft/Functional |
| `.octon/orchestration/runtime/workflows/promote-from-scratchpad.md` | Single file | Promote scratchpad content | Placeholder |
...
```yaml
# In .octon/capabilities/runtime/skills/registry.yml
skills:
  refactor-skill:
    outputs:
...
**Evidence:** Workflow frontmatter includes `checkpoints.storage: ".octon/continuity/checkpoints/"` - this pattern can be adopted by skills.
...
- Deprecate the workflows primitive (`.octon/orchestration/runtime/workflows/`)
...
1. **Create `refactor` skill** - Migrate `.octon/orchestration/runtime/workflows/refactor/` to `.octon/capabilities/runtime/skills/refactor/`
...
4. **Deprecate `.octon/orchestration/runtime/workflows/`** - Move templates to `.octon/capabilities/runtime/skills/_scaffold/template/`
...
|------|-------------|-------------|
| `.octon/capabilities/_meta/architecture/comparison.md` | Update | Remove "workflows" from comparison table; note consolidation |
| `docs/architecture/workspaces/workflows.md` | Deprecate | Add deprecation notice, point to skills |
| `.octon/capabilities/_meta/architecture/README.md` | Update | Add "workflow skills" archetype section |
| `.octon/capabilities/_meta/architecture/archetypes.md` | Create | Document different skill archetypes (transform, workflow, etc.) |
| `.octon/capabilities/runtime/skills/manifest.yml` | Update | Add new skills as they're migrated |
| `.octon/capabilities/runtime/skills/registry.yml` | Update | Add new skill metadata |
...
- `.octon/capabilities/runtime/skills/manifest.yml` - Current skill definitions
- `.octon/capabilities/runtime/skills/registry.yml` - Extended skill metadata
- `.octon/capabilities/runtime/skills/synthesis/refine-prompt/SKILL.md` - Example multi-phase skill
- `.octon/capabilities/runtime/skills/synthesis/refine-prompt/references/phases.md` - Detailed phase documentation
- `.octon/orchestration/runtime/workflows/refactor/` - Example workflow (candidate for migration)
- `.octon/capabilities/_meta/architecture/` - Skills documentation
...
│                                                                 │
│  Location: .octon/orchestration/runtime/missions/                      │
...
│                                                                 │
│  Location: .octon/capabilities/runtime/skills/                                     │
...
```yaml
# .octon/orchestration/runtime/missions/auth-migration/mission.yml
name: auth-migration
...
|------------------|------------|-----------|
| `.octon/orchestration/runtime/workflows/refactor/` | `.octon/capabilities/runtime/skills/refactor/` | Single-session, clear phases |
| `.octon/orchestration/runtime/workflows/workspace/create-workspace/` | `.octon/capabilities/runtime/skills/create-workspace/` | Single-session scaffolding |
| `.octon/orchestration/runtime/workflows/workspace/update-workspace/` | `.octon/capabilities/runtime/skills/update-workspace/` | Single-session update |
| `.octon/orchestration/runtime/workflows/workspace/evaluate-workspace/` | `.octon/capabilities/runtime/skills/evaluate-workspace/` | Single-session analysis |
| `.octon/orchestration/runtime/workflows/skills/create-skill/` | `.octon/capabilities/runtime/skills/create-skill/` | Single-session scaffolding |
...
| Deprecate | Reason |
|-----------|--------|
| `.octon/orchestration/runtime/workflows/workflows/create-workflow/` | No longer creating workflows |
| `.octon/orchestration/runtime/workflows/workflows/update-workflow/` | No longer maintaining workflows |
| `.octon/orchestration/runtime/workflows/workflows/evaluate-workflow/` | No longer evaluating workflows |
| `.octon/orchestration/runtime/workflows/_scaffold/template/` | Move to `.octon/capabilities/runtime/skills/_scaffold/template/` |
...
|---------------|--------------|
| `.octon/orchestration/runtime/workflows/missions/` (draft) | `.octon/orchestration/runtime/missions/` (production) |
...
4. **State Persistence**
   ...
   ```
   .octon/orchestration/runtime/missions/<mission-id>/
...
|-----------|---------|----------|
| **Skills** | Single-session composable capabilities | `.octon/capabilities/runtime/skills/` |
| **Missions** | Durable multi-session orchestration | `.octon/orchestration/runtime/missions/` |
| ~~Workflows~~ | **Deprecated** - consolidated into skills | ~~`.octon/orchestration/runtime/workflows/`~~ |
...
6. Deprecate `.octon/orchestration/runtime/workflows/` (except missions/)
...
| File | Change |
|------|--------|
| `.octon/capabilities/_meta/architecture/comparison.md` | Add missions comparison |
...
| `.octon/orchestration/runtime/missions/_scaffold/template/` | **Create** - Mission template |
