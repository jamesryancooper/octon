...
Related docs: [Foundational Planes Integration](/.octon/continuity/_meta/architecture/three-planes-integration.md), [Continuity Plane](/.octon/continuity/_meta/architecture/continuity-plane.md), [Cognition Governance](/.octon/cognition/governance/README.md), [Cognition Runtime](/.octon/cognition/runtime/README.md), [monorepo polyglot (normative)](../../_meta/architecture/monorepo-polyglot.md), [runtime architecture](/.octon/cognition/_meta/architecture/runtime-architecture.md), [tooling integration](../../_meta/architecture/tooling-integration.md), [observability requirements](../../_meta/architecture/observability-requirements.md), [governance model](../../_meta/architecture/governance-model.md), [contracts registry](../../_meta/architecture/contracts-registry.md), [Artifact Surface](/.octon/cognition/_meta/architecture/artifact-surface/README.md)
...
See [Foundational Planes Integration](/.octon/continuity/_meta/architecture/three-planes-integration.md) for complete boundary definitions.
...
The following belong to the **Continuity Plane** (see [Continuity Plane](/.octon/continuity/_meta/architecture/continuity-plane.md)):
...
- Manage prompts close to agent configurations initially; a dedicated prompt‑templating layer (cross‑cutting; see `.octon/cognition/_meta/architecture/slices-vs-layers.md`) can be added later if prompt complexity or reuse demands it.
