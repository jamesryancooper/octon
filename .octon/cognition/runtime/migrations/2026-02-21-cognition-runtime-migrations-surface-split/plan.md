...
- Dated migration plan records under policy surface:
  - `/.octon/cognition/practices/methodology/migrations/<YYYY-MM-DD>-<slug>/plan.md`
- Root-level migration evidence reports in output reports root:
  - `/.octon/output/reports/migrations/<YYYY-MM-DD>-<slug>/evidence.md` (legacy migration evidence class before bundle isolation)
...
- [x] No migration evidence reports remain in `/.octon/output/reports/` root.
