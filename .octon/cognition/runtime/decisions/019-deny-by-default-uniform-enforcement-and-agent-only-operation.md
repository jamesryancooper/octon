...
Octon commits to deny-by-default as a core safety and trust invariant.
...
Octon also needs policy behavior that supports both ACP-gated and fully
...
5. Exception leases are tracked in
   `.octon/capabilities/_ops/state/deny-by-default-exceptions.yml` and CI
