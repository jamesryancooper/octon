...
The existing workflow architecture in `.octon/orchestration/workflows/` was reviewed against eight quality dimensions: efficiency, scalability, performance, reliability, maintainability, adaptability, usability, and robustness.
...
checkpoints:
  enabled: true
  storage: ".octon/continuity/checkpoints/"
...
Created `.octon/orchestration/workflows/workflows/` containing:
...
- `.octon/orchestration/workflows/_scaffold/template/` — Canonical templates with gap fix fields
...
- `.octon/capabilities/commands/` — Trigger commands (`create-workflow`, `evaluate-workflow`, `update-workflow`)
...
```bash
.cursor/commands/<cmd>.md -> ../../.octon/capabilities/commands/<cmd>.md
.claude/commands/<cmd>.md -> ../../.octon/capabilities/commands/<cmd>.md
```
...
- Checkpoint files will accumulate in `.octon/continuity/checkpoints/` (can be periodically cleaned)
...
- Gap remediation guide: `.octon/cognition/context/workflow-gaps.md`
- Quality criteria: `.octon/cognition/context/workflow-quality.md`
- Create workflow: `.octon/orchestration/workflows/workflows/create-workflow/`
- Evaluate workflow: `.octon/orchestration/workflows/workflows/evaluate-workflow/`
- Update workflow: `.octon/orchestration/workflows/workflows/update-workflow/`
