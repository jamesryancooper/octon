...
- `.octon/capabilities/services/interfaces/agent-platform/`
...
- Phase 0.5 baseline report:
  - `.octon/output/reports/analysis/2026-02-14-platform-coupling-baseline.md`
- Core schemas:
  - `.octon/capabilities/services/interfaces/agent-platform/schema/capabilities.schema.json`
  - `.octon/capabilities/services/interfaces/agent-platform/schema/session-policy.schema.json`
- Enforcement script extension:
  - `.octon/capabilities/services/_ops/scripts/validate-service-independence.sh`
