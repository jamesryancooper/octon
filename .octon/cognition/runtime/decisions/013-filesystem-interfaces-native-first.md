...
`.octon/capabilities/services/interfaces/filesystem-snapshot/`,
`.octon/capabilities/services/interfaces/filesystem-discovery/`, and
`.octon/capabilities/services/interfaces/filesystem-watch/`, with these rules:
...
- Context contract:
  - `.octon/cognition/context/filesystem-interfaces-interop.md`
- Service contracts:
  - `.octon/capabilities/services/interfaces/filesystem-snapshot/`
  - `.octon/capabilities/services/interfaces/filesystem-discovery/`
  - `.octon/capabilities/services/interfaces/filesystem-watch/`
- Plan:
  - Historical execution plan in `.octon/output/plans/`
