...
Move `projects/` from `.scratchpad/projects/` to `.octon/ideation/projects/`:
...
- `.octon/ideation/projects/README.md` — Projects overview with funnel
- `.octon/ideation/projects/registry.md` — Project tracking
- `.octon/ideation/projects/_scaffold/template/*` — Project templates
- `.octon/ideation/scratchpad/brainstorm/README.md` — Brainstorm template
- `.octon/orchestration/workflows/projects/create-project.md` — Project creation workflow

### Updated

- `.octon/START.md` — Added projects, funnel, updated visibility rules
- `.octon/catalog.md` — Changed workflow reference
- `.octon/cognition/context/glossary.md` — Added Project, Brainstorm, The Funnel terms
- `.workspace/agent-autonomy-guard.globs` — Added projects pattern
- `.octon/ideation/scratchpad/README.md` — Removed projects, added brainstorm, added funnel
- `.octon/ideation/scratchpad/ideas/README.md` — Updated graduation paths
- `.octon/ideation/scratchpad/inbox/README.md` — Updated destination references
- `.octon/capabilities/skills/registry.yml` — Updated input paths
- `.octon/orchestration/workflows/README.md` — Updated workflow references
...
- `.octon/scaffolding/prompts/research/README.md` — Updated paths
- `.octon/scaffolding/prompts/research/synthesize-findings.md` — Updated paths
- `.octon/scaffolding/prompts/research/prepare-promotion.md` — Updated paths
- `.octon/capabilities/skills/synthesize-research/README.md` — Updated examples
- `.octon/capabilities/skills/synthesize-research/SKILL.md` — Updated paths
- `.octon/scaffolding/templates/workspace/progress/next.md` — Updated description
- `.octon/orchestration/workflows/workspace/migrate-workspace/02-structure-migration.md` — Added migration step
...
- `.octon/ideation/scratchpad/projects/` — Moved to `.octon/ideation/projects/`
- `.octon/orchestration/workflows/scratchpad/` — Replaced with `.octon/orchestration/workflows/projects/`
