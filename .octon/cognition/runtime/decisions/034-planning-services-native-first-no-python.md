...
That coupling weakens Octon's portability goals across host stacks and operating systems.

Octon requires a planning/execution stack that:
...
- Keeps Octon as the source of truth for planning and execution semantics.
