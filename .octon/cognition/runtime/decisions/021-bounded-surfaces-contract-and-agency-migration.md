...
Adopt the bounded-surfaces contract for applicable subsystems and apply it first to `/.octon/agency/` as a clean-break migration.

Agency canonical surfaces:

- runtime artifacts: `/.octon/agency/actors/`
