...
Implement a 10-phase refinement pipeline in `.octon/capabilities/skills/prompt-refiner/`:
...
```
.octon/capabilities/skills/prompt-refiner/SKILL.md   ← Source of truth
...
- `.octon/capabilities/skills/prompt-refiner/SKILL.md` — Full skill definition (v2.1.1)
- `.octon/capabilities/skills/prompt-refiner/templates/` — Template directory (empty)
- `.octon/capabilities/skills/prompt-refiner/reference/` — Reference directory (empty)
- `.octon/capabilities/skills/prompt-refiner/scripts/` — Scripts directory (empty)
...
- `.octon/capabilities/skills/registry.yml` — Added prompt-refiner entry
- `.octon/catalog.md` — Added skill to catalog table
- `.octon/cognition/context/decisions.md` — Added D021-D024 entries
