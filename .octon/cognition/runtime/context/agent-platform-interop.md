...
1. `interop_contract_version`
  - Location: `.octon/cognition/runtime/context/agent-platform-interop.md`
  - Scope: governance semantics and boundaries
2. `adapter_schema_version`
  - Location: `.octon/capabilities/runtime/services/interfaces/agent-platform/schema/*.json`
  - Scope: machine-readable interop schema
3. `adapter_version`
  - Location: `.octon/capabilities/runtime/services/interfaces/agent-platform/adapters/<id>/adapter.yml`
