...
Within autonomous execution, `.octon/capabilities/runtime/` defines four
capability surfaces:
...
**Location:** `.octon/agency/runtime/agents/<agent-name>/AGENT.md` + `.octon/agency/runtime/agents/<agent-name>/SOUL.md`

**Cross-agent overlays:** `.octon/agency/governance/CONSTITUTION.md`, `.octon/agency/governance/DELEGATION.md`, `.octon/agency/governance/MEMORY.md`

**Registry:** `.octon/agency/runtime/agents/registry.yml`
...
**Location:** `.octon/orchestration/runtime/missions/<mission-id>/mission.yml`
...
**Location:** `.octon/capabilities/runtime/skills/<skill-id>/SKILL.md`
...
- Writes only to `.octon/capabilities/runtime/skills/outputs/**` and `_ops/state/logs/**`
...
See `.octon/capabilities/runtime/skills/_scaffold/template/SKILL.md`

---

## Commands

**Location:** `.octon/capabilities/runtime/commands/<command>.md`
...
- `/refactor` → delegates to `.octon/orchestration/runtime/workflows/refactor/`
...
**Former Location:** `.octon/orchestration/runtime/workflows/<workflow-name>/`
...
See `.octon/capabilities/_meta/architecture/` for migration guidance.

---

## Assistants

**Location:** `.octon/agency/runtime/assistants/<assistant-name>/assistant.md`

**Registry:** `.octon/agency/runtime/assistants/registry.yml`
...
**Location:** `.octon/assurance/<checklist>.md`
...
**Location:** `.octon/scaffolding/practices/prompts/<prompt>.md` or `.octon/scaffolding/practices/prompts/<category>/<prompt>.md`
...
**Location:** `.octon/scaffolding/runtime/templates/<template-name>/`
...
|-----------|----------|----------|---------------|
| Agents | `.octon/agency/runtime/agents/registry.yml` | `.octon/agency/runtime/agents/_scaffold/template/` | `.octon/agency/_meta/architecture/README.md` |
| Teams | `.octon/agency/runtime/teams/registry.yml` | `.octon/agency/runtime/teams/_scaffold/template/` | `.octon/agency/_meta/architecture/architecture.md` |
| Missions | `.octon/orchestration/runtime/missions/registry.yml` | `.octon/orchestration/runtime/missions/_scaffold/template/` | `.octon/orchestration/_meta/architecture/missions.md` |
| Skills | `.octon/capabilities/runtime/skills/registry.yml` | `.octon/capabilities/runtime/skills/_scaffold/template/` | `.octon/capabilities/_meta/architecture/` |
| Assistants | `.octon/agency/runtime/assistants/registry.yml` | `.octon/agency/runtime/assistants/_scaffold/template/` | `.octon/agency/_meta/architecture/README.md` |
| Commands | — | — | `.octon/capabilities/_meta/architecture/commands.md` |
| Checklists | — | — | `.octon/assurance/_meta/architecture/checklists.md` |
| Prompts | — | — | `.octon/scaffolding/_meta/architecture/prompts.md` |
| Templates | — | `.octon/scaffolding/runtime/templates/` | `.octon/scaffolding/_meta/architecture/templates.md` |
