...
description: Canonical contracts/ layout and workflows for OpenAPI/JSON Schema and generated TypeScript/Python clients in the Octon polyglot monorepo.
---
...
The `contracts/` directory is the **canonical contracts registry** for Octon’s polyglot monorepo. It is the single source of truth for cross-slice and cross-language interfaces, powering generated clients for both TypeScript (control plane and apps) and Python (agents and runtimes).
