...
description: Guidance for building, scanning, and running container images for Octon apps, agents, and platform runtimes, including conventions and CI integration.
---

# Containerization Profile

This document defines how to **containerize Octon runtime components**—apps, agents, and platform runtimes—so that they can be:
...
Octon’s monorepo layout already defines **runtime planes** which map directly to container boundaries:
...
The following conventions SHOULD apply across all Octon runtime images:
