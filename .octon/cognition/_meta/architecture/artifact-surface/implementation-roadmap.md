...
- Ensure `/.octon/continuity/` canonical continuity artifacts exist per continuity contract.
...
- Add lifecycle checks for `/.octon/continuity/log.md` append-first behavior and `/.octon/continuity/runs/` retention contract conformance.
