...
7. **Runtime layer trigger criteria**: What specific metrics or events should trigger the escalation from build-only to runtime layers? (See [runtime-artifact-layer.md](./runtime-artifact-layer.md) and [boundary-conditions.md](./boundary-conditions.md) for framework.)
