...
Move `projects/` from `.scratchpad/projects/` to `.octon/inputs/exploratory/ideation/projects/`:
...
- `.octon/inputs/exploratory/ideation/projects/README.md` — Projects overview with funnel
- `.octon/inputs/exploratory/ideation/projects/registry.md` — Project tracking
- `.octon/inputs/exploratory/ideation/projects/_scaffold/template/*` — Project templates
- `.octon/inputs/exploratory/ideation/scratchpad/brainstorm/README.md` — Brainstorm template
- `.octon/framework/orchestration/workflows/projects/create-project.md` — Project creation workflow

### Updated

- `.octon/instance/bootstrap/START.md` — Added projects, funnel, updated visibility rules
- `.octon/instance/bootstrap/catalog.md` — Changed workflow reference
- `.octon/framework/cognition/context/glossary.md` — Added Project, Brainstorm, The Funnel terms
- `.workspace/agent-autonomy-guard.globs` — Added projects pattern
- `.octon/inputs/exploratory/ideation/scratchpad/README.md` — Removed projects, added brainstorm, added funnel
- `.octon/inputs/exploratory/ideation/scratchpad/ideas/README.md` — Updated graduation paths
- `.octon/inputs/exploratory/ideation/scratchpad/inbox/README.md` — Updated destination references
- `.octon/framework/capabilities/skills/registry.yml` — Updated input paths
- `.octon/framework/orchestration/workflows/README.md` — Updated workflow references
...
- `.octon/README.md` — Removed promote-from-scratchpad reference
- `.octon/framework/scaffolding/prompts/research/README.md` — Updated paths
- `.octon/framework/scaffolding/prompts/research/synthesize-findings.md` — Updated paths
- `.octon/framework/scaffolding/prompts/research/prepare-promotion.md` — Updated paths
- `.octon/framework/capabilities/skills/synthesize-research/README.md` — Updated examples
- `.octon/framework/capabilities/skills/synthesize-research/SKILL.md` — Updated paths
- `.octon/framework/scaffolding/templates/workspace/progress/next.md` — Updated description
- `.octon/framework/orchestration/workflows/workspace/migrate-workspace/02-structure-migration.md` — Added migration step
...
- `.octon/inputs/exploratory/ideation/scratchpad/projects/` — Moved to `.octon/inputs/exploratory/ideation/projects/`
- `.octon/framework/orchestration/workflows/scratchpad/` — Replaced with `.octon/framework/orchestration/workflows/projects/`
