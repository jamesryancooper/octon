...
- `/.octon/framework/cognition/runtime/` for runtime cognition artifacts
- `/.octon/framework/cognition/governance/` for normative cognition contracts
- `/.octon/framework/cognition/practices/` for operating methodology
- `/.octon/framework/cognition/_ops/` for mutable cognition operational scripts/state
- `/.octon/framework/cognition/_meta/` for non-structural architecture/reference documentation
