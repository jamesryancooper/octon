...
The existing workflow architecture in `.octon/framework/orchestration/workflows/` was reviewed against eight quality dimensions: efficiency, scalability, performance, reliability, maintainability, adaptability, usability, and robustness.
...
Created `.octon/framework/orchestration/workflows/workflows/` containing:
...
- `.octon/framework/orchestration/workflows/_scaffold/template/` — Canonical templates with gap fix fields
...
- `.octon/framework/capabilities/commands/` — Trigger commands (`create-workflow`, `evaluate-workflow`, `update-workflow`)
...
```bash
.cursor/commands/<cmd>.md -> ../../.octon/framework/capabilities/commands/<cmd>.md
.claude/commands/<cmd>.md -> ../../.octon/framework/capabilities/commands/<cmd>.md
```
...
- Checkpoint files will accumulate in `.octon/state/control/workflows/checkpoints/` (can be periodically cleaned)
...
- Gap remediation guide: `.octon/framework/cognition/context/workflow-gaps.md`
- Quality criteria: `.octon/framework/cognition/context/workflow-quality.md`
- Create workflow: `.octon/framework/orchestration/workflows/workflows/create-workflow/`
- Evaluate workflow: `.octon/framework/orchestration/workflows/workflows/evaluate-workflow/`
- Update workflow: `.octon/framework/orchestration/workflows/workflows/update-workflow/`
