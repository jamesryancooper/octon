...
- Related:
  ...
  - `/.octon/framework/scaffolding/runtime/templates/octon/scaffolding/runtime/bootstrap/`
  - `/AGENTS.md`
  - `/CLAUDE.md`
...
4. Repo-root `AGENTS.md` and `CLAUDE.md` are ingress adapters to
   ...
   fallback copies.
5. The human-readable objective brief lives only at `/.octon/instance/bootstrap/OBJECTIVE.md`.
