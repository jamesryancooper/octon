...
- Canonical principle: `/.octon/framework/cognition/governance/principles/complexity-calibration.md`
...
- `.octon/framework/capabilities/skills/manifest.yml` - Tier 1 discovery index
- `.octon/framework/capabilities/skills/registry.yml` - Tier 2 extended metadata
- `.octon/framework/capabilities/skills/scripts/validate-skills.sh` - Validation tooling
