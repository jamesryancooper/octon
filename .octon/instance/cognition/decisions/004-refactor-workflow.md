...
Implement a 6-step workflow in `.octon/framework/orchestration/workflows/refactor/` with mandatory verification:
...
Create commands in `.octon/framework/capabilities/commands/` and symlink from harness directories:

```
.octon/framework/capabilities/commands/refactor.md           ← Source of truth
.cursor/commands/refactor.md  → ../../.octon/framework/capabilities/commands/refactor.md
.claude/commands/refactor.md  → ../../.octon/framework/capabilities/commands/refactor.md
```
...
Following the skills pattern (`.octon/framework/capabilities/skills/` with symlinks), commands can be defined once and used across all harnesses. This reduces duplication and ensures consistency.
...
- `.octon/framework/orchestration/workflows/refactor/00-overview.md` — Workflow overview
- `.octon/framework/orchestration/workflows/refactor/01-define-scope.md` — Pattern definition step
- `.octon/framework/orchestration/workflows/refactor/02-audit.md` — Exhaustive search step
- `.octon/framework/orchestration/workflows/refactor/03-plan.md` — Change manifest step
- `.octon/framework/orchestration/workflows/refactor/04-execute.md` — Systematic execution step
- `.octon/framework/orchestration/workflows/refactor/05-verify.md` — Mandatory verification step
- `.octon/framework/orchestration/workflows/refactor/06-document.md` — Documentation step
- `.octon/framework/capabilities/commands/refactor.md` — Universal command definition
