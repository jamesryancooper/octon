...
```
.octon/framework/capabilities/skills/<skill-name>/
...
- `.octon/framework/capabilities/skills/_scaffold/template/` - Updated skill template
- `.octon/framework/orchestration/workflows/skills/create-skill/` - Updated workflow (v2.0.0)
