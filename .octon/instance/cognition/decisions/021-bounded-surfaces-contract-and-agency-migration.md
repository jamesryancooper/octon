...
Adopt the bounded-surfaces contract for applicable subsystems and apply it first to `/.octon/framework/agency/` as a clean-break migration.

Agency canonical surfaces:

- runtime artifacts: `/.octon/framework/agency/actors/`
