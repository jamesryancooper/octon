...
Adopt `/.octon/framework/engine/` as the top-level domain and enforce these canonical surfaces:

- `/.octon/framework/engine/runtime/` for executable authority
- `/.octon/framework/engine/governance/` for normative runtime policy/contracts
- `/.octon/framework/engine/practices/` for operating standards
- `/.octon/framework/engine/_ops/` for mutable operational assets
- `/.octon/framework/engine/_meta/` for architecture/evidence documentation
