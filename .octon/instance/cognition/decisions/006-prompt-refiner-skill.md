...
Implement a 10-phase refinement pipeline in `.octon/framework/capabilities/skills/prompt-refiner/`:
...
```
.octon/framework/capabilities/skills/prompt-refiner/SKILL.md   ← Source of truth
...
- `.octon/framework/capabilities/skills/prompt-refiner/SKILL.md` — Full skill definition (v2.1.1)
- `.octon/framework/capabilities/skills/prompt-refiner/templates/` — Template directory (empty)
- `.octon/framework/capabilities/skills/prompt-refiner/reference/` — Reference directory (empty)
- `.octon/framework/capabilities/skills/prompt-refiner/scripts/` — Scripts directory (empty)
...
- `.octon/framework/capabilities/skills/registry.yml` — Added prompt-refiner entry
- `.octon/instance/bootstrap/catalog.md` — Added skill to catalog table
- `.octon/framework/cognition/context/decisions.md` — Added D021-D024 entries
