...
Octon needs stronger agent-side retrieval, impact tracing, and progressive discovery
...
`.octon/framework/capabilities/services/interfaces/filesystem-snapshot/`,
`.octon/framework/capabilities/services/interfaces/filesystem-discovery/`, and
`.octon/framework/capabilities/services/interfaces/filesystem-watch/`, with these rules:
...
- Context contract:
  - `.octon/framework/cognition/context/filesystem-interfaces-interop.md`
- Service contracts:
  - `.octon/framework/capabilities/services/interfaces/filesystem-snapshot/`
  - `.octon/framework/capabilities/services/interfaces/filesystem-discovery/`
  - `.octon/framework/capabilities/services/interfaces/filesystem-watch/`
- Plan:
  - Historical execution plan in `.octon/inputs/exploratory/plans/`
