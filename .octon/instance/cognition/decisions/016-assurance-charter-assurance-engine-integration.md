...
## Decision
Make `/Users/jamesryancooper/Projects/octon/.octon/framework/assurance/CHARTER.md` canonical and enforceable by:

- adding an explicit `charter` contract block in `/Users/jamesryancooper/Projects/octon/.octon/framework/assurance/standards/weights/weights.yml`,
