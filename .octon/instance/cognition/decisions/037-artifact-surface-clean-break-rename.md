...
- Supersedes: `/.octon/framework/cognition/_meta/architecture/content-plane/` naming and path authority
...
- Directory rename:
  - `/.octon/framework/cognition/_meta/architecture/content-plane/`
  - ->
