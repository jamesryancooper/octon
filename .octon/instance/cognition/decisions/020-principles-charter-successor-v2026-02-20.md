...
`.octon/framework/cognition/principles/principles.md` was treated as intentionally
...
`.octon/framework/cognition/principles/principles-v2026-02-20.md` that preserves the
...
- Immutable charter:
  `.octon/framework/cognition/principles/principles.md`
- Versioned successor:
  `.octon/framework/cognition/principles/principles-v2026-02-20.md`
- Principles index:
