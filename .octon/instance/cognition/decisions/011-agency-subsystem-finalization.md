...
description: Finalize actor taxonomy and contracts for .octon/framework/agency by consolidating subagents into the canonical model.
status: accepted
date: 2026-02-11
---
...
- New canonical discovery path: `.octon/framework/agency/manifest.yml`.
