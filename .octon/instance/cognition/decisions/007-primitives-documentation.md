...
Create `.octon/framework/cognition/context/primitives.md` as the central reference for all Octon primitives.
...
- `.octon/framework/cognition/context/primitives.md` - The reference document
- `.octon/README.md` - Structure overview (references primitives.md)
- `.octon/framework/capabilities/skills/registry.yml` - Skills registry
- `.octon/framework/agency/assistants/registry.yml` - Assistants registry
