...
|-----------|---------|----------|
| Canonical Harness Docs | Authoritative harness definition | `.octon/framework/cognition/_meta/architecture/` |
| Harness Templates | Boilerplate for new harnesses | `.octon/framework/scaffolding/runtime/templates/octon/` |
| Cursor Commands | IDE integration entry points | `.cursor/commands/` |
| Engine Governance Rules | Canonical cross-harness rule policy packs | `.octon/framework/engine/governance/rules/` |
