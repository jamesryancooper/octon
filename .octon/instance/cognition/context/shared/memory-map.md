...
| Session continuity and active work state | `.octon/state/continuity/repo/{log.md,tasks.json,entities.json,next.md}` | Operational memory for handoff and resumption. |
| Run evidence memory lifecycle | `.octon/state/evidence/runs/retention.json` and `.octon/framework/cognition/_meta/architecture/state/continuity/runs-retention.md` | Retention classes and lifecycle actions for run receipts/digests. |
