...
Related docs: [Foundational Planes Integration](/.octon/framework/cognition/_meta/architecture/state/continuity/three-planes-integration.md), [Continuity Plane](/.octon/framework/cognition/_meta/architecture/state/continuity/continuity-plane.md), [Cognition Governance](/.octon/framework/cognition/governance/README.md), [Cognition Runtime](/.octon/framework/cognition/runtime/README.md), [monorepo polyglot (normative)](../../_meta/architecture/monorepo-polyglot.md), [runtime architecture](/.octon/framework/cognition/_meta/architecture/runtime-architecture.md), [tooling integration](../../_meta/architecture/tooling-integration.md), [observability requirements](../../_meta/architecture/observability-requirements.md), [governance model](../../_meta/architecture/governance-model.md), [contracts registry](../../_meta/architecture/contracts-registry.md), [Artifact Surface](/.octon/framework/cognition/_meta/architecture/artifact-surface/README.md)
...
The Knowledge Plane is one of Octon's nine foundational planes:
...
See [Foundational Planes Integration](/.octon/framework/cognition/_meta/architecture/state/continuity/three-planes-integration.md) for complete boundary definitions.
...
The following belong to the **Continuity Plane** (see [Continuity Plane](/.octon/framework/cognition/_meta/architecture/state/continuity/continuity-plane.md)):
...
```json
{
  ...
  "links": {
    "pr": "https://github.com/octon/monorepo/pull/123",
    "build": "https://github.com/octon/monorepo/actions/runs/123456",
...
- **ContextOps (RAG)** in Octon is the domain of **IngestKit, IndexKit, SearchKit, and QueryKit**: they ingest, normalize, index, and retrieve knowledge with provenance, and they expose deterministic retrieval behavior to agents and flows.
...
## Alignment with Octon Principles
...
- Manage prompts close to agent configurations initially; a dedicated prompt‑templating layer (cross‑cutting; see `.octon/framework/cognition/_meta/architecture/slices-vs-layers.md`) can be added later if prompt complexity or reuse demands it.
