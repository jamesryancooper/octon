...
- `/.octon/framework/cognition/practices/methodology/sections/`
...
- Sidecar section indexes colocated with canonical docs:
  - `/.octon/framework/cognition/practices/methodology/README.index.yml`
  - `/.octon/framework/cognition/practices/methodology/implementation-guide.index.yml`
  - `/.octon/framework/cognition/_meta/architecture/README.index.yml`
  - `/.octon/framework/cognition/_meta/architecture/resources.index.yml`
