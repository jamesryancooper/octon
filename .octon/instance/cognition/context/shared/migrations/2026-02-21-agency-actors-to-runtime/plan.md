...
description: Clean-break migration plan for replacing `/.octon/framework/agency/actors/` with `/.octon/framework/agency/runtime/` as the sole runtime surface.
---
...
- Scope: `/.octon/framework/agency/**`, active references across docs/templates/validators, and migration governance artifacts.
...
- Delete:
  - `/.octon/framework/agency/actors/` directory.
- Replace call-sites:
...
- [x] No `/.octon/framework/agency/actors/` path remains on disk.
...
- `/.octon/state/evidence/migration/2026-02-21-agency-actors-to-runtime/evidence.md`
- `/.octon/instance/cognition/decisions/028-agency-runtime-surface-clean-break-rename.md`
