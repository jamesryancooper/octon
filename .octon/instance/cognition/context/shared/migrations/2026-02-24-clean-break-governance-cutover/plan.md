...
- Scope:
  ...
  - `/.octon/framework/engine/runtime/policy` and `/.octon/framework/engine/runtime/crates/policy_engine`
...
- Clean-break migration doctrine and rollback contract:
  - `/.octon/framework/cognition/practices/methodology/migrations/README.md`
- Decision authority:
  - `/.octon/instance/cognition/decisions/039-clean-break-governance-cutover-contract.md`
...
- Canonical onboarding execution path:
  - `/.octon/framework/orchestration/runtime/workflows/tasks/agent-led-happy-path.md`
...
- Runtime migration record:
  - `/.octon/instance/cognition/context/shared/migrations/2026-02-24-clean-break-governance-cutover/plan.md`
- Decision record:
  - `/.octon/instance/cognition/decisions/039-clean-break-governance-cutover-contract.md`
- Migration evidence bundle:
  - `/.octon/state/evidence/migration/2026-02-24-clean-break-governance-cutover/`
...
- `/.octon/state/evidence/migration/2026-02-24-clean-break-governance-cutover/evidence.md`
- `/.octon/state/evidence/migration/2026-02-24-clean-break-governance-cutover/validation.md`
