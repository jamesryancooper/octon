...
- workflow runtime path: `/.octon/framework/orchestration/runtime/workflows/audit/documentation-quality-gate/`
...
- workflow runtime path: `/.octon/framework/orchestration/runtime/workflows/audit/documentation-audit/`
...
- New components or files:
  - migration plan folder:
    - `/.octon/instance/cognition/context/shared/migrations/2026-02-21-documentation-audit-clean-break-rename/`
  - decision record:
