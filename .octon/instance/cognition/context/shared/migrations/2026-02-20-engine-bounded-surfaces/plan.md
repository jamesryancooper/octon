...
- Scope: `/.octon/framework/engine/**`, legacy `/.octon/runtime/**` removal, and all active references in scripts, manifests, workflows, docs, and validators.
...
- Engine operating standards:
  - `/.octon/framework/engine/practices/`
- Engine support namespaces:
  - `/.octon/framework/engine/_ops/`
  - `/.octon/framework/engine/_meta/`
...
- New components or files:
  ...
  - `/.octon/framework/engine/governance/compatibility-policy.md`
  - `/.octon/framework/engine/governance/release-gates.md`
  - `/.octon/framework/engine/practices/README.md`
  - `/.octon/framework/engine/practices/release-runbook.md`
  - `/.octon/framework/engine/practices/incident-operations.md`
  - `/.octon/framework/engine/practices/local-dev-validation.md`
  - `/.octon/framework/engine/_meta/architecture/README.md`
  - `/.octon/instance/cognition/decisions/026-engine-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
  - `/.octon/framework/engine/runtime/run`
  - `/.octon/framework/engine/runtime/run.cmd`
...
- `/.octon/state/evidence/migration/2026-02-20-engine-bounded-surfaces/evidence.md`
- `/.octon/instance/cognition/decisions/026-engine-bounded-surfaces-clean-break-migration.md`
