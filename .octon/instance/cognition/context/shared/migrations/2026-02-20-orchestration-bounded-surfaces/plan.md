...
- Scope: `/.octon/framework/orchestration/**` plus active references in harness docs, templates, scripts, runtime integrations, and CI workflows.

## 2) What Is Being Removed (Explicit)

- Legacy root runtime paths:
  - `/.octon/framework/orchestration/workflows/`
  - `/.octon/framework/orchestration/missions/`
- Legacy root governance paths:
  - `/.octon/framework/orchestration/incidents.md`
  - `/.octon/framework/orchestration/incident-response.md`
- Legacy template runtime paths:
  - `/.octon/framework/scaffolding/templates/octon/orchestration/workflows/`
  - `/.octon/framework/scaffolding/templates/octon/orchestration/missions/`
  - `/.octon/framework/scaffolding/templates/<legacy-docs-template>/orchestration/workflows/`
...
- Governance authority:
  - `/.octon/framework/orchestration/governance/incidents.md`
- Practices authority:
  - `/.octon/framework/orchestration/practices/`
- Template authority:
  - `/.octon/framework/scaffolding/templates/octon/orchestration/runtime/workflows/`
  - `/.octon/framework/scaffolding/templates/octon/orchestration/runtime/missions/`
  - `/.octon/framework/scaffolding/templates/<legacy-docs-template>/orchestration/runtime/workflows/`
...
- New components or files:
  ...
  - `/.octon/instance/cognition/decisions/022-orchestration-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
...
- `/.octon/state/evidence/migration/2026-02-20-orchestration-bounded-surfaces/evidence.md`
- `/.octon/instance/cognition/decisions/022-orchestration-bounded-surfaces-clean-break-migration.md`
