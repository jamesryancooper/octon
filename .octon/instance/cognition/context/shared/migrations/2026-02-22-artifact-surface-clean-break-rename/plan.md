...
- Motivation: Remove legacy optional-surface naming and align active
  ...
  terminology.
- Scope:
  - `/.octon/framework/cognition/_meta/architecture/artifact-surface/**`
...
- Optional surface path: `/.octon/framework/cognition/_meta/architecture/content-plane/`
...
- Optional surface path: `/.octon/framework/cognition/_meta/architecture/artifact-surface/`
...
- New runtime migration record:
  - `/.octon/instance/cognition/context/shared/migrations/2026-02-22-artifact-surface-clean-break-rename/plan.md`
- New decision record:
  - `/.octon/instance/cognition/decisions/037-artifact-surface-clean-break-rename.md`
- New migration evidence bundle:
  - `/.octon/state/evidence/migration/2026-02-22-artifact-surface-clean-break-rename/`
...
- `/.octon/state/evidence/migration/2026-02-22-artifact-surface-clean-break-rename/evidence.md`
- `/.octon/instance/cognition/decisions/037-artifact-surface-clean-break-rename.md`
