...
- Scope: `/.octon/framework/agency/**` plus all active references to agency contract paths in harness docs, templates, scripts, and validators.
...
- Legacy governance roots:
  - `/.octon/framework/agency/CONSTITUTION.md`
  - `/.octon/framework/agency/DELEGATION.md`
  - `/.octon/framework/agency/MEMORY.md`
- Legacy discovery links in `/.octon/framework/agency/manifest.yml` and dependent docs/scripts/templates.

## 3) What Is the New SSOT (Explicit)

- Runtime actor authority:
  - `/.octon/framework/agency/actors/agents/`
  - `/.octon/framework/agency/actors/assistants/`
  - `/.octon/framework/agency/actors/teams/`
...
- Discovery authority:
  - `/.octon/framework/agency/manifest.yml` registries -> `actors/*/registry.yml`
...
- New components/files:
  - `/.octon/framework/agency/actors/README.md`
  - `/.octon/framework/agency/governance/README.md`
...
- `/.octon/state/evidence/migration/2026-02-20-agency-bounded-surfaces/evidence.md`
- `/.octon/instance/cognition/decisions/021-bounded-surfaces-contract-and-agency-migration.md`
