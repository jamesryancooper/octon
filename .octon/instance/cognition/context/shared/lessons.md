...
| Skipping progress updates | Breaks session continuity | Always update `/.octon/state/continuity/repo/log.md` before session end |
...
3. Reference the relevant task or session in `/.octon/state/continuity/repo/log.md`
