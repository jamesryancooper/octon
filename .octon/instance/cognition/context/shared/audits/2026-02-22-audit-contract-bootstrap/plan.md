...
- Scope roots:
  ...
  - `/.octon/instance/cognition/context/shared/audits/`
  - `/.octon/state/evidence/validation/audits/`
- Explicit exclusions:
...
- `/.octon/state/evidence/validation/audits/2026-02-22-audit-contract-bootstrap/`
