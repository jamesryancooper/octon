...
|----------|---------|------------------|-------------|----------|
| `refine-prompt` | Transform rough prompts into clear, actionable instructions with codebase context | Yes (outputs/prompts/, /.octon/state/evidence/runs/skills/refine-prompt/) | Yes | "refine my prompt", "improve this prompt", "expand this prompt" |
| `synthesize-research` | Synthesize scattered research notes into coherent findings documents | Yes (outputs/drafts/, /.octon/state/evidence/runs/skills/synthesize-research/) | Yes | "synthesize my research", "consolidate findings", "summarize research notes" |
...
|------|---------------|------------------|----------|
| `.octon/framework/orchestration/runtime/workflows/_scaffold/template/` | 00-overview.md, 01-step.md, NN-verify.md, README.md | Scaffolding template | Draft |
| `.octon/framework/orchestration/runtime/workflows/workspace/create-workspace/` | 00-overview.md + 6 step files | Scaffold new .octon directory | Draft/Functional |
| `.octon/framework/orchestration/runtime/workflows/workspace/update-workspace/` | 00-overview.md + 5 step files | Align workspace with canonical definition | Draft/Functional |
| `.octon/framework/orchestration/runtime/workflows/workspace/evaluate-workspace/` | 00-overview.md + 3 step files | Assess token efficiency | Draft/Functional |
| `.octon/framework/orchestration/runtime/workflows/workspace/migrate-workspace/` | 00-overview.md + 4 step files | Migrate workspace structure | Draft |
| `.octon/framework/orchestration/runtime/workflows/workflows/create-workflow/` | 00-overview.md + 8 step files | Scaffold new workflow | Draft/Meta |
| `.octon/framework/orchestration/runtime/workflows/workflows/update-workflow/` | 00-overview.md + 5 step files | Modify existing workflow | Draft/Meta |
| `.octon/framework/orchestration/runtime/workflows/workflows/evaluate-workflow/` | 00-overview.md + 5 step files | Assess workflow quality | Draft/Meta |
| `.octon/framework/orchestration/runtime/workflows/refactor/` | 00-overview.md + 6 step files | Execute verified codebase refactor | Draft/Functional |
| `.octon/framework/orchestration/runtime/workflows/missions/create-mission/` | 00-overview.md | Scaffold new mission | Draft |
| `.octon/framework/orchestration/runtime/workflows/missions/complete-mission/` | 00-overview.md | Archive completed mission | Draft |
| `.octon/framework/orchestration/runtime/workflows/skills/create-skill/` | 00-overview.md + 6 step files | Scaffold new skill | Draft/Functional |
| `.octon/framework/orchestration/runtime/workflows/promote-from-scratchpad.md` | Single file | Promote scratchpad content | Placeholder |
...
| **Auditability** | Required run logs in `/.octon/state/evidence/runs/skills/<skill-id>/` | Required |
...
- The run log (`/.octon/state/evidence/runs/skills/<skill-id>/`) already captures execution trace
- A skill could explicitly output a "process report" as its primary artifact

**How it works in practice:**

```yaml
# In .octon/framework/capabilities/runtime/skills/registry.yml
skills:
  refactor-skill:
    outputs:
...
**Evidence:** Workflow frontmatter includes `checkpoints.storage: ".octon/state/control/workflows/checkpoints/"` - this pattern can be adopted by skills.
...
- Deprecate the workflows primitive (`.octon/framework/orchestration/runtime/workflows/`)
...
allowed-tools: Read Glob Grep Edit Write(outputs/*) Write(/.octon/state/evidence/runs/skills/*)
metadata:
  archetype: workflow
  checkpoints: true
---
...
1. **Create `refactor` skill** - Migrate `.octon/framework/orchestration/runtime/workflows/refactor/` to `.octon/framework/capabilities/runtime/skills/refactor/`
...
4. **Deprecate `.octon/framework/orchestration/runtime/workflows/`** - Move templates to `.octon/framework/capabilities/runtime/skills/_scaffold/template/`
...
|------|-------------|-------------|
| `.octon/framework/capabilities/_meta/architecture/comparison.md` | Update | Remove "workflows" from comparison table; note consolidation |
| `docs/architecture/workspaces/workflows.md` | Deprecate | Add deprecation notice, point to skills |
| `.octon/framework/capabilities/_meta/architecture/README.md` | Update | Add "workflow skills" archetype section |
| `.octon/framework/capabilities/_meta/architecture/archetypes.md` | Create | Document different skill archetypes (transform, workflow, etc.) |
| `.octon/framework/capabilities/runtime/skills/manifest.yml` | Update | Add new skills as they're migrated |
| `.octon/framework/capabilities/runtime/skills/registry.yml` | Update | Add new skill metadata |
...
- `.octon/framework/capabilities/runtime/skills/manifest.yml` - Current skill definitions
- `.octon/framework/capabilities/runtime/skills/registry.yml` - Extended skill metadata
- `.octon/framework/capabilities/runtime/skills/synthesis/refine-prompt/SKILL.md` - Example multi-phase skill
- `.octon/framework/capabilities/runtime/skills/synthesis/refine-prompt/references/phases.md` - Detailed phase documentation
- `.octon/framework/orchestration/runtime/workflows/refactor/` - Example workflow (candidate for migration)
- `.octon/framework/capabilities/_meta/architecture/` - Skills documentation
...
│                                                                 │
│  Location: .octon/instance/orchestration/missions/                      │
...
│                                                                 │
│  Location: .octon/framework/capabilities/runtime/skills/                                     │
...
```yaml
# .octon/instance/orchestration/missions/auth-migration/mission.yml
name: auth-migration
...
|------------------|------------|-----------|
| `.octon/framework/orchestration/runtime/workflows/refactor/` | `.octon/framework/capabilities/runtime/skills/refactor/` | Single-session, clear phases |
| `.octon/framework/orchestration/runtime/workflows/workspace/create-workspace/` | `.octon/framework/capabilities/runtime/skills/create-workspace/` | Single-session scaffolding |
| `.octon/framework/orchestration/runtime/workflows/workspace/update-workspace/` | `.octon/framework/capabilities/runtime/skills/update-workspace/` | Single-session update |
| `.octon/framework/orchestration/runtime/workflows/workspace/evaluate-workspace/` | `.octon/framework/capabilities/runtime/skills/evaluate-workspace/` | Single-session analysis |
| `.octon/framework/orchestration/runtime/workflows/skills/create-skill/` | `.octon/framework/capabilities/runtime/skills/create-skill/` | Single-session scaffolding |
...
| Deprecate | Reason |
|-----------|--------|
| `.octon/framework/orchestration/runtime/workflows/workflows/create-workflow/` | No longer creating workflows |
| `.octon/framework/orchestration/runtime/workflows/workflows/update-workflow/` | No longer maintaining workflows |
| `.octon/framework/orchestration/runtime/workflows/workflows/evaluate-workflow/` | No longer evaluating workflows |
| `.octon/framework/orchestration/runtime/workflows/_scaffold/template/` | Move to `.octon/framework/capabilities/runtime/skills/_scaffold/template/` |
...
|---------------|--------------|
| `.octon/framework/orchestration/runtime/workflows/missions/` (draft) | `.octon/instance/orchestration/missions/` (production) |
...
|-----------|---------|----------|
| **Skills** | Single-session composable capabilities | `.octon/framework/capabilities/runtime/skills/` |
| **Missions** | Durable multi-session orchestration | `.octon/instance/orchestration/missions/` |
| ~~Workflows~~ | **Deprecated** - consolidated into skills | ~~`.octon/framework/orchestration/runtime/workflows/`~~ |
...
6. Deprecate `.octon/framework/orchestration/runtime/workflows/` (except missions/)
...
| File | Change |
|------|--------|
| `.octon/framework/capabilities/_meta/architecture/comparison.md` | Add missions comparison |
...
| `.octon/instance/orchestration/missions/_scaffold/template/` | **Create** - Mission template |
