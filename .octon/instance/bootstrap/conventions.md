...
- Skills & Workflows: Use verbs from the [Verb Vocabulary](/.octon/framework/capabilities/practices/design-conventions.md#verb-vocabulary)
...
**Template:** `.octon/framework/scaffolding/runtime/templates/cursor-command.md`
