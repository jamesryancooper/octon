...
Related docs: [Monorepo polyglot (normative)](/.octon/cognition/_meta/architecture/monorepo-polyglot.md), [Architecture overview](/.octon/cognition/_meta/architecture/overview.md), [Monorepo layout](/.octon/cognition/_meta/architecture/monorepo-layout.md), [Repository blueprint](/.octon/cognition/_meta/architecture/repository-blueprint.md), [Tooling integration](/.octon/cognition/_meta/architecture/tooling-integration.md), [Contracts registry](/.octon/cognition/_meta/architecture/contracts-registry.md), [Agent roles](/.octon/cognition/_meta/architecture/agent-roles.md), [Runtime architecture](/.octon/cognition/_meta/architecture/runtime-architecture.md), [Runtime policy](/.octon/cognition/_meta/architecture/runtime-policy.md)
