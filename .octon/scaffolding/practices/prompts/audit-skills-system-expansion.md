...
- Target subsystem: `.octon/capabilities/runtime/skills`
- Optional comparison scope: `.octon/capabilities`, `.octon/orchestration`, `.octon/scaffolding`
- Optional severity bar for recommendations: only propose expansion for material gaps

## Instructions

1. Use `audit-domain-architecture` as the primary evaluator for `.octon/capabilities/runtime/skills`.
...
```text
Use /Users/jamesryancooper/Projects/octon/.octon/scaffolding/practices/prompts/audit-skills-system-expansion.md to evaluate whether .octon/capabilities/runtime/skills needs a new artifact or runtime feature, or whether existing manifests, registries, validators, and skill contracts are sufficient.
```
