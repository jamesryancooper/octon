...
3. Preserve the current authority split:
   - runtime state in `/.octon/orchestration/runtime/`
   - governance in `/.octon/orchestration/governance/`
   - operating guidance in `/.octon/orchestration/practices/`
   - durable evidence in `/.octon/continuity/`
...
3. `/.octon/orchestration/governance/incidents.md`
4. `/.octon/orchestration/governance/production-incident-runbook.md`
5. `/.octon/orchestration/practices/incident-lifecycle-standards.md`
6. `/.octon/orchestration/practices/queue-operations-standards.md`
7. `/.octon/orchestration/practices/watcher-operations.md`
8. `/.octon/orchestration/practices/automation-operations.md`
9. `/.octon/orchestration/practices/run-linkage-standards.md`
...
- `code`:
  - expected additions under `/.octon/orchestration/runtime/_ops/scripts/`
  - possible subordinate report generators under `/.octon/orchestration/runtime/`
- `tests`:
...
- `docs`:
  ...
  - possible runbook refinements under `/.octon/orchestration/governance/`
- `contracts`:
