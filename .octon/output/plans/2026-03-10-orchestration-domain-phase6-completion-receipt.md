...
- strengthened `.octon/orchestration/runtime/_ops/scripts/route-watcher-event.sh`
  so it now supports:
...
- strengthened `.octon/orchestration/runtime/_ops/scripts/emit-watcher-event.sh`
...
- added `.octon/orchestration/runtime/_ops/tests/test-watcher-routing-and-queue.sh`
...
- `bash -n .octon/orchestration/runtime/_ops/tests/test-watcher-routing-and-queue.sh`
- `bash .octon/orchestration/runtime/_ops/tests/test-watcher-routing-and-queue.sh`
