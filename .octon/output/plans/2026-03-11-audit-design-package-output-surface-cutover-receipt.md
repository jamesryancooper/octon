...
- `rationale`:
  - `audit-design-package` workflow-stage bundles were being written under `/.octon/output/reports/audits/`, which is reserved for bounded-audit evidence bundles.
...
- `tests`:
  - `/.octon/assurance/runtime/_ops/tests/test-design-package-workflow-runner.sh`
  - `/.octon/assurance/runtime/_ops/tests/test-validate-audit-convergence-contract.sh`
  - `/.github/workflows/harness-self-containment.yml`
- `docs`:
  - `/.octon/output/README.md`
  - `/.octon/output/reports/workflows/README.md`
  - `/.octon/orchestration/runtime/workflows/audit/audit-design-package/README.md`
  - `/.octon/orchestration/runtime/workflows/audit/audit-design-package/stages/01-configure.md`
  - `/.octon/orchestration/runtime/workflows/audit/audit-design-package/stages/08-report.md`
- `contracts`:
