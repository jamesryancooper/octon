...
**Directory:** `.octon/capabilities/skills/quality-gate/systematic-debugging/`
...
**Directory:** `.octon/capabilities/skills/quality-gate/audit-completion/`
...
**Directory:** `.octon/capabilities/skills/foundations/development-practices/test-driven-development/`
...
**Gap filled:** `.octon/ideation/` domain exists but has zero skills; `collaborator` skill set barely used (only `refine-prompt`).

**Directory:** `.octon/capabilities/skills/ideation/brainstorm-design/`
...
**Directory:** `.octon/capabilities/skills/orchestration/delegate-tasks/`
...
- `.octon/capabilities/skills/synthesis/spec-to-implementation/SKILL.md`
- `.octon/capabilities/skills/synthesis/spec-to-implementation/references/phases.md`
...
- `.octon/capabilities/skills/quality-gate/resolve-pr-comments/SKILL.md`
- `.octon/capabilities/skills/quality-gate/resolve-pr-comments/references/phases.md`
...
**Directory:** `.octon/orchestration/workflows/quality-gate/complete-branch/`
...
**File:** `.octon/capabilities/commands/setup-worktree.md`
...
| File | Changes |
|------|---------|
| `.octon/capabilities/skills/manifest.yml` | Add 5 new skill entries |
| `.octon/capabilities/skills/registry.yml` | Add 5 new skill registry entries |
| `.octon/capabilities/skills/capabilities.yml` | Add 2 new groups (ideation, orchestration), update quality-gate and foundations members |
| `.octon/orchestration/workflows/manifest.yml` | Add complete-branch entry + update quality-gate group members |
| `.octon/orchestration/workflows/registry.yml` | Add complete-branch entry |
| `.octon/capabilities/commands/manifest.yml` | Add setup-worktree entry |
