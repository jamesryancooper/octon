...
1. `/.octon/engine/governance/instruction-layer-precedence.md`
2. `/.octon/engine/runtime/spec/instruction-layer-manifest-v1.schema.json`
3. `/.octon/capabilities/governance/policy/deny-by-default.v2.yml`
4. `/.octon/engine/runtime/spec/policy-receipt-v1.schema.json`
5. `/.octon/capabilities/governance/policy/acp-provenance-fields.schema.json`
