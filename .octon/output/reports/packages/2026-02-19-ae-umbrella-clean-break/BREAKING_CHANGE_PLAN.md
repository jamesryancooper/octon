...
2. Update charter contract in `.octon/assurance/CHARTER.md` to the umbrella chain.
...
4. Update policy contract in `.octon/assurance/standards/weights/weights.yml`:
...
7. Regenerate AE artifacts under `.octon/output/assurance/` so no generated output contains old chain semantics.
