...
### 2. `.octon/assurance/standards/weights/weights.yml`
...
### 7. `.octon/assurance/README.md`
### 8. `.octon/assurance/DOCTRINE.md`
### 9. `.octon/assurance/governance/SUBSYSTEM_OVERRIDE_POLICY.md`
### 10. `.octon/assurance/standards/weights/weights.md`
### 11. `.octon/assurance/complete.md`
### 12. `.octon/assurance/session-exit.md`
...
### 14. `.octon/assurance/_ops/scripts/alignment-check.sh`
...
- `.octon/output/reports/packages/2026-02-18-quality-charter-qge-integration/` rename and content edits
