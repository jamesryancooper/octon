...
Scope: Root and `.octon/**` framing migration convergence for agent-first purpose, managed complexity, and system-governed model.
...
- Step 11 (historical ADR superseding annotations): PASS
  - Added superseding annotations to ADRs retaining legacy framing tokens:
    - `/.octon/cognition/runtime/decisions/009-manifest-discovery-and-validation.md`
    - `/.octon/cognition/runtime/decisions/017-assurance-clean-break-migration.md`
- Step 12 (regression guardrails): PASS
  - Added `/.octon/assurance/runtime/_ops/scripts/validate-framing-alignment.sh`.
...
- Step 13 (final convergence): PASS
  ...
  - `bash .octon/assurance/runtime/_ops/scripts/alignment-check.sh --profile harness` -> PASS (`errors=0`)
  - `bash .octon/assurance/runtime/_ops/scripts/compute-assurance-score.sh --weights .octon/assurance/governance/weights/weights.yml --scores .octon/assurance/governance/scores/scores.yml` -> PASS
...
1. `/.octon/cognition/runtime/decisions/009-manifest-discovery-and-validation.md`
2. `/.octon/cognition/runtime/decisions/017-assurance-clean-break-migration.md`
