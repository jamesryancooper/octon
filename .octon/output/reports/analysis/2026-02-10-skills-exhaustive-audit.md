...
- Validator baseline: `.octon/capabilities/skills/_scripts/validate-skills.sh` and `--strict` both passed
...
- **Severity:** important
- **Files:**
  - `.octon/capabilities/skills/meta/create-skill/SKILL.md:73`
  - `.octon/capabilities/skills/meta/create-skill/SKILL.md:74`
  - `.octon/capabilities/skills/meta/create-skill/references/io-contract.md:32`
  - `.octon/capabilities/skills/meta/create-skill/references/io-contract.md:52`
  - `.octon/capabilities/skills/meta/create-skill/references/io-contract.md:78`
  - `.octon/capabilities/skills/registry.yml:1083`
...
- **Severity:** important
- **Files:**
  - `.octon/capabilities/skills/_scripts/validate-skills.sh:14`
  - `.octon/capabilities/skills/_scripts/validate-skills.sh:42`
  - `.octon/capabilities/skills/_scripts/validate-skills.sh:2424`
  - `.octon/capabilities/skills/_scripts/validate-skills.sh:2428`
  - `.octon/capabilities/skills/_scripts/validate-skills.sh:1469`
...
- **Severity:** critical
- **Files:**
  - `.octon/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/python-api/contract-first-api/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/python-api/test-harness/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/python-api/dev-toolchain/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/python-api/infra-manifest/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/python-api/contributor-guide/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/swift-macos-app/data-layer/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/swift-macos-app/cli-interface/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/swift-macos-app/daemon-service/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/swift-macos-app/test-harness/SKILL.md:10`
  - `.octon/capabilities/skills/foundations/swift-macos-app/contributor-guide/SKILL.md:10`
...
- **Severity:** important
- **Files:**
  - `.octon/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md:18`
  - `.octon/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md:18`
...
- **Severity:** minor
- **Files:**
  - `.octon/capabilities/skills/foundations/react/composition-patterns/references/rules.md:1`
  - `.octon/capabilities/skills/foundations/react/best-practices/references/rules.md:1`
  - `.octon/capabilities/skills/foundations/react-native/best-practices/references/rules.md:1`
  - `.octon/capabilities/skills/foundations/postgres/best-practices/references/rules.md:1`
...
- **Severity:** critical
- **Files:**
  - `.octon/capabilities/skills/_scripts/setup-harness-links.sh:13`
  - `.octon/capabilities/skills/_scripts/setup-harness-links.sh:16`
  - `.octon/capabilities/skills/_scripts/setup-harness-links.sh:39`
  - `.octon/capabilities/skills/_scripts/setup-harness-links.sh:58`
  - `.octon/capabilities/skills/_scripts/setup-harness-links.sh:97`
- **Description:** Script computes repo root incorrectly and assumes flat skill directories.
- **Evidence:** Running script reports skills path as `.../.octon/.octon/capabilities/skills` and discovers none; single-skill mode fails for `create-skill`.
...
- **Severity:** important
- **Files:**
  - `.octon/capabilities/skills/_scripts/generate-reference-headers.sh:191`
  - `.octon/capabilities/skills/_scripts/generate-reference-headers.sh:205`
  - `.octon/capabilities/skills/_scripts/generate-reference-headers.sh:250`
...
- **Severity:** important
- **Files:**
  - `.octon/capabilities/skills/_state/logs/FORMAT.md:20`
  - `.octon/capabilities/skills/_state/logs/FORMAT.md:183`
  - `.octon/capabilities/skills/_state/logs/index.yml:10`
  - `.octon/capabilities/skills/_state/logs/index.yml:13`
...
- **Severity:** important
- **Files:**
  - `.octon/orchestration/workflows/meta/create-skill(x)/00-overview.md:68`
  - `.octon/orchestration/workflows/meta/create-skill(x)/00-overview.md:82`
  - `.octon/orchestration/workflows/meta/create-skill(x)/02-copy-template.md:21`
  - `.octon/orchestration/workflows/meta/create-skill(x)/02-copy-template.md:32`
  - `.octon/orchestration/workflows/meta/create-skill(x)/03-initialize-skill.md:51`
  - `.octon/orchestration/workflows/meta/create-skill(x)/06-report-success.md:27`
...
- **Severity:** important
- **Files:**
  - `.octon/cognition/analyses/workflows-vs-skills-analysis.md:190`
  - `.octon/cognition/analyses/workflows-vs-skills-analysis.md:558`
  - `.octon/cognition/context/decisions.md:53`
  - `.octon/cognition/decisions/001-octon-shared-foundation.md:59`
...
1. Fix `.octon/capabilities/skills/_scripts/setup-harness-links.sh` for correct root + manifest-path discovery.
...
1. Fix `.octon/capabilities/skills/_scripts/generate-reference-headers.sh` grouped-path resolution.
