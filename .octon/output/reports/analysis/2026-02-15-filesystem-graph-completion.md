...
- `bash .octon/capabilities/services/interfaces/filesystem-graph/impl/snapshot-build.sh --root . --set-current true`
...
- `discover.expand` from `dir:.octon/cognition/context`
