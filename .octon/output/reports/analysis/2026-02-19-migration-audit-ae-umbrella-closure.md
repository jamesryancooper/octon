...
3. Runtime verification:
   - `cargo test --manifest-path .octon/runtime/crates/Cargo.toml -p octon_assurance_tools` -> 7 passed.
   - `cargo build --manifest-path .octon/runtime/crates/Cargo.toml -p octon_assurance_tools` -> pass.
4. Gate verification:
