...
mod tests {
    ...
    fn seed_base(root: &Path) {
        for rel in [
            ".octon/orchestration/runtime/runs/by-surface/workflows",
            ".octon/orchestration/runtime/runs/by-surface/missions",
            ".octon/orchestration/runtime/runs/by-surface/automations",
            ".octon/orchestration/runtime/runs/by-surface/incidents",
            ".octon/orchestration/runtime/queue/pending",
            ".octon/orchestration/runtime/queue/claimed",
            ".octon/orchestration/runtime/queue/retry",
            ".octon/orchestration/runtime/queue/dead-letter",
            ".octon/orchestration/runtime/queue/receipts",
            ".octon/orchestration/runtime/watchers/example/state",
            ".octon/orchestration/runtime/automations/example/state",
            ".octon/orchestration/runtime/missions/example/context",
            ".octon/orchestration/runtime/incidents/inc-001",
            ".octon/orchestration/runtime/workflows/example/sample",
            ".octon/continuity/decisions/dec-001",
            ".octon/continuity/runs/run-001",
            ".octon/orchestration/governance",
        ] {
            fs::create_dir_all(root.join(rel)).expect("create fixture dirs");
        }
        fs::write(
            root.join(".octon/orchestration/runtime/queue/registry.yml"),
            "schema_version: orchestration-queue-registry-v1\n",
        )
        .expect("write queue registry");
        fs::write(
            root.join(".octon/orchestration/runtime/runs/index.yml"),
            "schema_version: orchestration-runs-index-v1\nruns: []\n",
        )
        .expect("write run index");
        fs::write(
            root.join(".octon/orchestration/runtime/incidents/index.yml"),
            "schema_version: orchestration-incidents-index-v1\nincidents: []\n",
        )
        .expect("write incident index");
        fs::write(
            root.join(".octon/orchestration/runtime/missions/registry.yml"),
            "schema_version: '1.0'\nactive: []\narchived: []\n",
        )
        .expect("write mission registry");
        fs::write(
            root.join(".octon/orchestration/runtime/watchers/example/watcher.yml"),
            "watcher_id: example\ntitle: Example Watcher\nowner: '@architect'\nstatus: active\n",
        )
        .expect("write watcher");
        fs::write(
            root.join(".octon/orchestration/runtime/watchers/example/state/health.json"),
            "{\n  \"status\": \"healthy\",\n  \"checked_at\": \"2026-03-11T10:00:00Z\"\n}\n",
        )
        .expect("write health");
        fs::write(
            root.join(".octon/orchestration/runtime/watchers/example/state/suppressions.json"),
            "{\n  \"suppressed\": [\"evt-old\"]\n}\n",
        )
        .expect("write suppressions");
        fs::write(
            root.join(".octon/orchestration/runtime/automations/example/automation.yml"),
            "automation_id: example\ntitle: Example Automation\nowner: '@architect'\nstatus: active\nworkflow_ref:\n  workflow_group: example\n  workflow_id: sample\n",
        )
        .expect("write automation");
        fs::write(
            root.join(".octon/orchestration/runtime/automations/example/state/counters.json"),
            "{\n  \"blocked\": 2\n}\n",
        )
        .expect("write counters");
        fs::write(
            root.join(".octon/orchestration/runtime/automations/example/state/status.json"),
            "{\n  \"status\": \"active\"\n}\n",
        )
        .expect("write automation status");
        fs::write(
            root.join(".octon/orchestration/runtime/missions/example/mission.yml"),
            "schema_version: mission-object-v1\nmission_id: example\ntitle: Example Mission\nsummary: Example mission.\nstatus: active\nowner: '@architect'\ncreated_at: '2026-03-10T00:00:00Z'\nactive_run_ids:\n  - run-001\n",
        )
        .expect("write mission");
        fs::write(
            root.join(".octon/orchestration/runtime/missions/example/tasks.json"),
            "{\n  \"tasks\": [\n    {\"id\": \"t1\", \"status\": \"blocked\"},\n    {\"id\": \"t2\", \"status\": \"open\"},\n    {\"id\": \"t3\", \"status\": \"done\"}\n  ]\n}\n",
        )
        .expect("write tasks");
        fs::write(
            root.join(".octon/continuity/decisions/dec-001/decision.json"),
            "{\n  \"decision_id\": \"dec-001\",\n  \"outcome\": \"allow\",\n  \"surface\": \"automations\",\n  \"action\": \"launch\",\n  \"actor\": \"example\",\n  \"summary\": \"Allowed.\",\n  \"run_id\": \"run-001\",\n  \"automation_id\": \"example\",\n  \"event_id\": \"evt-001\",\n  \"queue_item_id\": \"q-001\",\n  \"workflow_ref\": {\"workflow_group\": \"example\", \"workflow_id\": \"sample\"}\n}\n",
        )
        .expect("write decision");
        fs::write(
            root.join(".octon/orchestration/runtime/runs/run-001.yml"),
        ...
        .expect("write run");
        fs::write(
            root.join(".octon/orchestration/runtime/queue/pending/q-001.json"),
        ...
        .expect("write event");
        fs::write(
            root.join(".octon/orchestration/runtime/queue/receipts/q-001-ack-20260311T101600Z.json"),
            "{\n  \"queue_item_id\": \"q-001\",\n  \"handled_at\": \"2026-03-11T10:16:00Z\"\n}\n",
        )
        .expect("write receipt");
        fs::write(
            root.join(".octon/orchestration/runtime/incidents/inc-001/incident.yml"),
            "incident_id: inc-001\ntitle: Example Incident\nseverity: sev2\nstatus: closed\nowner: '@architect'\nsummary: Incident summary\nrun_ids:\n  - run-001\n",
        )
        .expect("write incident");
        fs::write(
            root.join(".octon/orchestration/runtime/incidents/inc-001/timeline.md"),
            "# Incident Timeline: inc-001\n\n- 2026-03-11T10:20:00Z: incident updated\n",
        )
        .expect("write timeline");
        fs::write(
            root.join(".octon/orchestration/runtime/incidents/inc-001/closure.md"),
            "# Incident Closure: inc-001\n\n- Closed At: `2026-03-11T10:30:00Z`\n- Closed By: `@architect`\n- Approval: `appr-001`\n\nClosed with evidence.\n\n## Remediation Evidence\n\n- Remediation Ref: `run:run-001`\n",
        )
        .expect("write closure");
        fs::write(
            root.join(".octon/orchestration/runtime/workflows/example/sample/workflow.yml"),
    ...
    fn incident_closure_readiness_reports_missing_evidence() {
        ...
        fs::remove_file(root.join(".octon/orchestration/runtime/incidents/inc-001/closure.md"))
