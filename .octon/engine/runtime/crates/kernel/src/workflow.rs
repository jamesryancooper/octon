...
const WORKFLOW_ROOT_REL: &str =
    ".octon/orchestration/runtime/workflows/audit/audit-design-proposal";
const REPORTS_ROOT_REL: &str = ".octon/output/reports/analysis";
const WORKFLOW_REPORTS_ROOT_REL: &str = ".octon/output/reports/workflows";
const STANDARD_DESIGN_PACKAGE_VALIDATOR_REL: &str =
    ".octon/assurance/runtime/_ops/scripts/validate-design-proposal.sh";
const DESIGN_PACKAGE_TEMPLATE_ROOT_REL: &str = ".octon/scaffolding/runtime/templates";
...
impl StaticProposalKind {
    ...
    fn validator_rel(self) -> &'static str {
        match self {
            Self::Migration => ".octon/assurance/runtime/_ops/scripts/validate-migration-proposal.sh",
            Self::Policy => ".octon/assurance/runtime/_ops/scripts/validate-policy-proposal.sh",
            Self::Architecture => ".octon/assurance/runtime/_ops/scripts/validate-architecture-proposal.sh",
        }
    }
...
pub fn run_create_design_package_from_octon_dir(
    ...
    if failure.is_none() {
        let stage04_input = write_create_stage_input(
            ...
            "validate-package",
            &format!(
                "# Validate Proposal\n\n- proposal_path: `{}`\n- validators:\n  - `bash .octon/assurance/runtime/_ops/scripts/validate-proposal-standard.sh --package {}`\n  - `bash .octon/assurance/runtime/_ops/scripts/validate-design-proposal.sh --package {}`\n",
                proposal_root.display(),
                proposal_rel,
                proposal_rel
            ),
...
fn run_design_proposal_validator_stack(
    ...
    run_validator_stack(
        ...
        bundle_root,
        &[
            ".octon/assurance/runtime/_ops/scripts/validate-proposal-standard.sh",
...
mod tests {
    ...
    fn seed_create_design_package_fixture(root: &Path) -> PathBuf {
        ...
        copy_tree(
            &source_root.join(".octon/scaffolding/runtime/templates"),
            &root.join(".octon/scaffolding/runtime/templates"),
        );
        copy_tree(
            &source_root.join(".octon/assurance/runtime/_ops/scripts"),
            &root.join(".octon/assurance/runtime/_ops/scripts"),
        );
    ...
    fn prepare_only_run_materializes_bundle_and_prompt_packets() {
        ...
        assert!(result
            .bundle_root
            .to_string_lossy()
            .contains(".octon/output/reports/workflows/"));
    ...
    fn failing_executor_writes_failure_receipts() {
        ...
        let bundles_root = root.join(".octon/output/reports/workflows");
        ...
        let result = run_create_design_package_from_octon_dir(
            ...
            RunCreateDesignPackageOptions {
                ...
                implementation_targets: vec![
                    ".octon/orchestration/runtime/example.md".to_string()
                ],
    ...
    fn create_design_package_scaffolds_experience_product_defaults() {
        ...
        let result = run_create_design_package_from_octon_dir(
            ...
            RunCreateDesignPackageOptions {
                ...
                promotion_scope: ProposalScope::OctonInternal,
                implementation_targets: vec![".octon/scaffolding/runtime/example.md".to_string()],
                include_contracts: None,
                include_conformance: None,
                include_canonicalization: None,
            },
