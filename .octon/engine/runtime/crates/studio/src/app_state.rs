...
fn render_ops_playbooks(root: &Path) -> String {
    let path = root.join(".octon/orchestration/practices/orchestration-failure-playbooks.md");
...
mod tests {
    ...
    fn operations_incident_blockers_and_playbooks_render() {
        ...
        write_file(
            &harness
                .root
                .join(".octon/orchestration/runtime/incidents/inc-001/incident.yml"),
            "incident_id: \"inc-001\"\ntitle: \"Example Incident\"\nseverity: \"sev2\"\nstatus: \"open\"\nowner: \"@architect\"\nsummary: \"Incident summary\"\n",
        );
        let _ = fs::remove_file(
            harness
                .root
                .join(".octon/orchestration/runtime/incidents/inc-001/closure.md"),
        );
        let mut state = AppState::load(harness.root_path()).expect("app state should load");
    ...
    fn write_fixture_harness(root: &Path) {
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/manifest.yml"),
            "workflows:\n  - id: alpha\n    path: alpha\n  - id: beta\n    path: beta\n",
        );
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/registry.yml"),
            "workflows:\n  alpha:\n    path: alpha\n  beta:\n    path: beta\n    depends_on:\n      - workflow: alpha\n",
        );
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/alpha/README.md"),
            "---\nname: Alpha Flow\ndescription: Alpha workflow for fixture tests.\nsteps:\n  - id: alpha-step\n    file: 01-alpha.md\n    description: Alpha step.\n---\n\n# Alpha\n",
        );
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/alpha/workflow.yml"),
            "schema_version: workflow-contract-v1\nname: alpha\ndescription: Alpha workflow for fixture tests.\nversion: 1.0.0\nentry_mode: human\nexecution_profile: core\nstages:\n  - id: alpha-step\n    asset: stages/01-alpha.md\n    kind: analysis\nartifacts: []\ndone_gate:\n  checks:\n    - Alpha complete\n",
        );
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/alpha/stages/01-alpha.md"),
            "---\nname: alpha-step\ndescription: Alpha step.\n---\n",
        );
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/beta/README.md"),
            "---\nname: Beta Flow\ndescription: Beta workflow with a missing step file.\nsteps:\n  - id: beta-step\n    file: 01-beta.md\n    description: Beta missing step.\n---\n\n# Beta\n",
        );
        write_file(
            &root.join(".octon/orchestration/runtime/workflows/beta/workflow.yml"),
        ...
        write_file(
            &root.join(".octon/orchestration/practices/orchestration-failure-playbooks.md"),
    ...
    fn write_fixture_audits(root: &Path) {
        write_file(
            &root.join(".octon/output/reports/operations/1001-1-studio-apply-audit.md"),
            "# Octon Studio Apply Audit\n\n- timestamp_unix_ms: 1001\n- status: applied\n- attempted_files: 1\n- applied_files: 1\n- rolled_back_files: 0\n- summary: Applied 1 staged edits.\n\n## Staged Edits\n- update | .octon/orchestration/runtime/workflows/alpha/README.md | Normalize README.md frontmatter defaults\n",
        );
        write_file(
            &root.join(".octon/output/reports/operations/1002-1-studio-apply-audit.md"),
            "# Octon Studio Apply Audit\n\n- timestamp_unix_ms: 1002\n- status: failed-rolled-back\n- attempted_files: 2\n- applied_files: 1\n- rolled_back_files: 1\n- summary: Apply failed and rolled back 1 file(s): synthetic write error\n\n## Staged Edits\n- create | .octon/orchestration/runtime/workflows/beta/stages/01-beta.md | Create missing step file\n",
        );
    }
