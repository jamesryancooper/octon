...
VALIDATE_SCRIPT=".octon/assurance/runtime/_ops/scripts/validate-orchestration-design-proposal.sh"
...
create_fixture_repo() {
  ...
  mkdir -p "$fixture_root/.octon/assurance/runtime/_ops/scripts" "$fixture_root/.proposals/.archive/design"
  cp "$REPO_ROOT/.octon/assurance/runtime/_ops/scripts/validate-orchestration-design-proposal.sh" \
    "$fixture_root/.octon/assurance/runtime/_ops/scripts/validate-orchestration-design-proposal.sh"
