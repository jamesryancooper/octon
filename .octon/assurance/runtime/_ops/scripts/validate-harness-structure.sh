...
DOMAIN_PROFILES_FILE="$OCTON_DIR/cognition/governance/domain-profiles.yml"
...
check_structure_tree_contract() {
  ...
  while IFS=$'\t' read -r kind path lineno; do
    ...
    if [[ "$path" != .octon* ]]; then
      fail "structure tree path must stay inside .octon in ${rel} (line ${lineno}): ${path}"
      continue
    fi
...
check_structure_docs_contract() {
  check_structure_tree_contract "$OCTON_DIR/README.md"
  check_structure_tree_contract "$OCTON_DIR/START.md"
}

check_subsystem_baseline() {
  local subsystem="$1"
  local root="$OCTON_DIR/$subsystem"
...
check_meta_namespace_layout() {
    ...
    while IFS= read -r child; do
      ...
      case "$name" in
        architecture|docs|evidence)
          ...
          ;;
        principles)
          if [[ "$rel" == ".octon/cognition/_meta" ]]; then
            pass "_meta namespace allowed: ${child#$ROOT_DIR/}"
          else
  ...
  done < <(find "$OCTON_DIR" -type d -name "_meta" | sort)
}
...
check_discovery_contracts() {
  require_file "$OCTON_DIR/agency/manifest.yml"
  require_file "$OCTON_DIR/agency/runtime/agents/registry.yml"
  require_file "$OCTON_DIR/agency/runtime/assistants/registry.yml"
  require_file "$OCTON_DIR/agency/runtime/teams/registry.yml"
  require_file "$OCTON_DIR/agency/governance/CONSTITUTION.md"
  require_file "$OCTON_DIR/agency/governance/DELEGATION.md"
  require_file "$OCTON_DIR/agency/governance/MEMORY.md"

  require_file "$OCTON_DIR/capabilities/runtime/commands/manifest.yml"
  require_file "$OCTON_DIR/capabilities/runtime/skills/manifest.yml"
  require_file "$OCTON_DIR/capabilities/runtime/services/manifest.yml"
  require_file "$OCTON_DIR/capabilities/runtime/services/manifest.runtime.yml"
  require_file "$OCTON_DIR/capabilities/runtime/services/registry.runtime.yml"
  require_file "$OCTON_DIR/capabilities/runtime/tools/manifest.yml"
  require_file "$OCTON_DIR/capabilities/governance/policy/deny-by-default.v2.yml"
  require_file "$OCTON_DIR/capabilities/practices/README.md"

  require_file "$OCTON_DIR/cognition/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/context/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/decisions/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/migrations/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/audits/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/analyses/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/knowledge/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/knowledge/graph/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/knowledge/sources/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/knowledge/queries/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/evidence/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/evaluations/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/evaluations/digests/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/evaluations/actions/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/projections/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/projections/definitions/index.yml"
  require_file "$OCTON_DIR/cognition/runtime/projections/materialized/index.yml"
  require_file "$OCTON_DIR/cognition/governance/index.yml"
  require_file "$OCTON_DIR/cognition/governance/principles/index.yml"
  require_file "$OCTON_DIR/cognition/governance/pillars/index.yml"
  require_file "$OCTON_DIR/cognition/governance/purpose/index.yml"
  require_file "$OCTON_DIR/cognition/governance/controls/README.md"
  require_file "$OCTON_DIR/cognition/governance/controls/index.yml"
  require_file "$OCTON_DIR/cognition/governance/controls/ra-acp-glossary.md"
  require_file "$OCTON_DIR/cognition/governance/controls/ra-acp-promotion-inputs-matrix.md"
  require_file "$OCTON_DIR/cognition/governance/controls/flag-metadata-contract.md"
  require_file "$OCTON_DIR/cognition/governance/controls/promotable-slice-decomposition.md"
  require_file "$OCTON_DIR/cognition/governance/exceptions/README.md"
  require_file "$OCTON_DIR/cognition/governance/exceptions/index.yml"
  require_file "$OCTON_DIR/cognition/governance/exceptions/waivers-and-exceptions.md"
  require_file "$OCTON_DIR/cognition/practices/index.yml"
  require_file "$OCTON_DIR/cognition/practices/operations/README.md"
  require_file "$OCTON_DIR/cognition/practices/operations/index.yml"
  require_file "$OCTON_DIR/cognition/practices/methodology/index.yml"
  require_file "$OCTON_DIR/cognition/practices/methodology/migrations/index.yml"
  require_file "$OCTON_DIR/cognition/practices/methodology/audits/index.yml"
  require_file "$OCTON_DIR/cognition/practices/methodology/templates/index.yml"
  require_file "$OCTON_DIR/cognition/practices/methodology/README.index.yml"
  require_file "$OCTON_DIR/cognition/practices/methodology/implementation-guide.index.yml"
  require_file "$OCTON_DIR/cognition/_meta/architecture/index.yml"
  require_file "$OCTON_DIR/cognition/_meta/architecture/artifact-surface/index.yml"
  require_file "$OCTON_DIR/cognition/_meta/architecture/README.index.yml"
  require_file "$OCTON_DIR/cognition/_meta/architecture/resources.index.yml"
  require_file "$OCTON_DIR/cognition/_meta/docs/index.yml"
  require_file "$OCTON_DIR/cognition/_meta/principles/index.yml"
  require_file "$OCTON_DIR/cognition/_meta/docs/intent-surface-atlas.md"
  require_file "$OCTON_DIR/cognition/governance/principles/principles.md"
  require_file "$OCTON_DIR/cognition/practices/methodology/README.md"
  require_file "$OCTON_DIR/cognition/_ops/principles/scripts/lint-principles-governance.sh"
  require_file "$OCTON_DIR/cognition/_ops/knowledge/scripts/validate-knowledge-runtime.sh"
  require_file "$OCTON_DIR/cognition/_ops/evaluations/scripts/validate-evaluations-runtime.sh"
  require_file "$OCTON_DIR/cognition/_ops/projections/scripts/validate-projections-runtime.sh"
  require_file "$OCTON_DIR/cognition/_ops/runtime/scripts/sync-runtime-artifacts.sh"
  require_file "$OCTON_DIR/cognition/_ops/runtime/scripts/validate-generated-runtime-artifacts.sh"

  require_file "$OCTON_DIR/orchestration/runtime/workflows/manifest.yml"
  require_file "$OCTON_DIR/orchestration/runtime/workflows/registry.yml"
  require_file "$OCTON_DIR/orchestration/runtime/missions/registry.yml"
  require_file "$OCTON_DIR/orchestration/runtime/automations/manifest.yml"
  require_file "$OCTON_DIR/orchestration/runtime/automations/registry.yml"
  require_file "$OCTON_DIR/orchestration/runtime/watchers/manifest.yml"
  require_file "$OCTON_DIR/orchestration/runtime/watchers/registry.yml"
  require_file "$OCTON_DIR/orchestration/runtime/queue/registry.yml"
  require_file "$OCTON_DIR/orchestration/runtime/queue/schema.yml"
  require_file "$OCTON_DIR/orchestration/runtime/runs/index.yml"
  require_file "$OCTON_DIR/orchestration/runtime/incidents/index.yml"
  require_file "$OCTON_DIR/orchestration/governance/incidents.md"
  require_file "$OCTON_DIR/orchestration/governance/production-incident-runbook.md"
  require_file "$OCTON_DIR/orchestration/governance/approver-authority-registry.json"
  require_file "$OCTON_DIR/orchestration/governance/automation-policy.md"
  require_file "$OCTON_DIR/orchestration/governance/queue-safety-policy.md"
  require_file "$OCTON_DIR/orchestration/governance/watcher-signal-policy.md"
  require_file "$OCTON_DIR/orchestration/practices/automation-authoring-standards.md"
  require_file "$OCTON_DIR/orchestration/practices/automation-operations.md"
  require_file "$OCTON_DIR/orchestration/practices/watcher-authoring-standards.md"
  require_file "$OCTON_DIR/orchestration/practices/watcher-operations.md"
  require_file "$OCTON_DIR/orchestration/practices/queue-operations-standards.md"
  require_file "$OCTON_DIR/orchestration/practices/run-linkage-standards.md"
  require_file "$OCTON_DIR/orchestration/practices/incident-lifecycle-standards.md"

  require_file "$OCTON_DIR/continuity/decisions/README.md"
  require_file "$OCTON_DIR/continuity/decisions/retention.json"
  require_file "$OCTON_DIR/continuity/decisions/approvals/README.md"

  require_file "$OCTON_DIR/assurance/governance/CHARTER.md"
  require_file "$OCTON_DIR/assurance/governance/weights/weights.yml"
  require_file "$OCTON_DIR/assurance/governance/scores/scores.yml"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/compute-assurance-score.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/assurance-gate.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-audit-convergence-contract.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-contract-governance.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-design-proposal.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-orchestration-design-proposal.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-tier-downgrade-policy.sh"
  require_file "$OCTON_DIR/assurance/practices/complete.md"
  require_file "$OCTON_DIR/assurance/practices/session-exit.md"
  require_file "$OCTON_DIR/output/reports/audits/README.md"
  require_file "$OCTON_DIR/output/reports/workflows/README.md"

  require_file "$OCTON_DIR/AGENTS.md"
  require_file "$OCTON_DIR/OBJECTIVE.md"
  require_file "$OCTON_DIR/cognition/runtime/context/intent.contract.yml"
  require_file "$OCTON_DIR/engine/runtime/spec/objective-brief-v1.schema.json"
  require_file "$OCTON_DIR/scaffolding/runtime/bootstrap/README.md"
  require_file "$OCTON_DIR/scaffolding/runtime/bootstrap/manifest.yml"
  require_file "$OCTON_DIR/scaffolding/runtime/bootstrap/AGENTS.md"
  require_file "$OCTON_DIR/scaffolding/runtime/bootstrap/init-project.sh"
  require_file "$OCTON_DIR/scaffolding/runtime/bootstrap/objectives/registry.txt"
  require_file "$OCTON_DIR/scaffolding/runtime/templates/manifest.schema.json"
  require_file "$OCTON_DIR/scaffolding/runtime/templates/design-proposal.schema.json"
  require_file "$OCTON_DIR/scaffolding/runtime/templates/README.md"
  require_file "$OCTON_DIR/scaffolding/runtime/_ops/scripts/sync-bootstrap-projection.sh"
  require_file "$OCTON_DIR/scaffolding/runtime/templates/audits/template.bounded-audit.md"
  require_file "$OCTON_DIR/scaffolding/runtime/_ops/scripts/init-project.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-bootstrap-ingress.sh"
  require_file "$OCTON_DIR/assurance/runtime/_ops/scripts/validate-bootstrap-projections.sh"
  require_file "$OCTON_DIR/scaffolding/governance/patterns/README.md"
  require_file "$OCTON_DIR/scaffolding/governance/patterns/design-proposal-standard.md"
  require_file "$OCTON_DIR/scaffolding/practices/README.md"
}

check_expected_internals() {
  require_dir "$OCTON_DIR/agency/runtime/agents"
  require_dir "$OCTON_DIR/agency/runtime/assistants"
  require_dir "$OCTON_DIR/agency/runtime/teams"
  require_dir "$OCTON_DIR/agency/governance"

  require_dir "$OCTON_DIR/capabilities/runtime"
  require_dir "$OCTON_DIR/capabilities/runtime/skills"
  require_dir "$OCTON_DIR/capabilities/runtime/commands"
  require_dir "$OCTON_DIR/capabilities/runtime/tools"
  require_dir "$OCTON_DIR/capabilities/runtime/services"
  require_dir "$OCTON_DIR/capabilities/governance"
  require_dir "$OCTON_DIR/capabilities/practices"

  require_dir "$OCTON_DIR/cognition/runtime"
  require_dir "$OCTON_DIR/cognition/runtime/context"
  require_dir "$OCTON_DIR/cognition/runtime/migrations"
  require_dir "$OCTON_DIR/cognition/runtime/audits"
  require_dir "$OCTON_DIR/cognition/runtime/decisions"
  require_dir "$OCTON_DIR/cognition/runtime/analyses"
  require_dir "$OCTON_DIR/cognition/runtime/knowledge"
  require_dir "$OCTON_DIR/cognition/runtime/knowledge/graph"
  require_dir "$OCTON_DIR/cognition/runtime/knowledge/sources"
  require_dir "$OCTON_DIR/cognition/runtime/knowledge/queries"
  require_dir "$OCTON_DIR/cognition/runtime/evidence"
  require_dir "$OCTON_DIR/cognition/runtime/evaluations"
  require_dir "$OCTON_DIR/cognition/runtime/evaluations/digests"
  require_dir "$OCTON_DIR/cognition/runtime/evaluations/actions"
  require_dir "$OCTON_DIR/cognition/runtime/projections"
  require_dir "$OCTON_DIR/cognition/runtime/projections/definitions"
  require_dir "$OCTON_DIR/cognition/runtime/projections/materialized"
  require_dir "$OCTON_DIR/cognition/governance"
  require_dir "$OCTON_DIR/cognition/governance/controls"
  require_dir "$OCTON_DIR/cognition/governance/exceptions"
  require_dir "$OCTON_DIR/cognition/governance/principles"
  require_dir "$OCTON_DIR/cognition/governance/pillars"
  require_dir "$OCTON_DIR/cognition/governance/purpose"
  require_dir "$OCTON_DIR/cognition/practices"
  require_dir "$OCTON_DIR/cognition/practices/operations"
  require_dir "$OCTON_DIR/cognition/practices/methodology"
  require_dir "$OCTON_DIR/cognition/practices/methodology/migrations"
  require_dir "$OCTON_DIR/cognition/practices/methodology/audits"
  require_dir "$OCTON_DIR/cognition/practices/methodology/templates"
  require_dir "$OCTON_DIR/cognition/_meta/architecture"
  require_dir "$OCTON_DIR/cognition/_meta/architecture/artifact-surface"
  require_dir "$OCTON_DIR/cognition/_meta/docs"
  require_dir "$OCTON_DIR/cognition/_meta/principles"
  require_dir "$OCTON_DIR/cognition/_ops"
  require_dir "$OCTON_DIR/cognition/_ops/principles"
  require_dir "$OCTON_DIR/cognition/_ops/principles/scripts"
  require_dir "$OCTON_DIR/cognition/_ops/knowledge"
  require_dir "$OCTON_DIR/cognition/_ops/knowledge/scripts"
  require_dir "$OCTON_DIR/cognition/_ops/evaluations"
  require_dir "$OCTON_DIR/cognition/_ops/evaluations/scripts"
  require_dir "$OCTON_DIR/cognition/_ops/projections"
  require_dir "$OCTON_DIR/cognition/_ops/projections/scripts"
  require_dir "$OCTON_DIR/cognition/_ops/runtime"
  require_dir "$OCTON_DIR/cognition/_ops/runtime/scripts"

  require_dir "$OCTON_DIR/orchestration/runtime/workflows"
  require_dir "$OCTON_DIR/orchestration/runtime/missions"
  require_dir "$OCTON_DIR/orchestration/runtime/automations"
  require_dir "$OCTON_DIR/orchestration/runtime/watchers"
  require_dir "$OCTON_DIR/orchestration/runtime/queue"
  require_dir "$OCTON_DIR/orchestration/runtime/runs"
  require_dir "$OCTON_DIR/orchestration/runtime/incidents"
  require_dir "$OCTON_DIR/orchestration/runtime/_coordination"
  require_dir "$OCTON_DIR/orchestration/runtime"
  require_dir "$OCTON_DIR/orchestration/governance"
  require_dir "$OCTON_DIR/orchestration/practices"

  require_dir "$OCTON_DIR/assurance/runtime"
  require_dir "$OCTON_DIR/assurance/runtime/_ops"
  require_dir "$OCTON_DIR/assurance/runtime/trust"
  require_dir "$OCTON_DIR/assurance/governance"
  require_dir "$OCTON_DIR/assurance/practices"
  require_dir "$OCTON_DIR/assurance/practices/standards"

  require_dir "$OCTON_DIR/scaffolding/runtime"
  require_dir "$OCTON_DIR/scaffolding/runtime/_ops"
  require_dir "$OCTON_DIR/scaffolding/runtime/_ops/scripts"
  require_dir "$OCTON_DIR/scaffolding/runtime/bootstrap"
  require_dir "$OCTON_DIR/scaffolding/runtime/templates"
  require_dir "$OCTON_DIR/scaffolding/runtime/templates/audits"
  require_dir "$OCTON_DIR/scaffolding/runtime/templates/octon/scaffolding/runtime/bootstrap"
  require_dir "$OCTON_DIR/scaffolding/governance"
  require_dir "$OCTON_DIR/scaffolding/governance/patterns"
  require_dir "$OCTON_DIR/scaffolding/practices"
  require_dir "$OCTON_DIR/scaffolding/practices/prompts"
  require_dir "$OCTON_DIR/scaffolding/practices/examples"

  require_file "$OCTON_DIR/assurance/practices/complete.md"
  require_file "$OCTON_DIR/assurance/practices/session-exit.md"

  require_file "$OCTON_DIR/continuity/log.md"
  require_file "$OCTON_DIR/continuity/tasks.json"
  require_file "$OCTON_DIR/continuity/entities.json"
  require_file "$OCTON_DIR/continuity/next.md"
  require_dir "$OCTON_DIR/continuity/runs"
  require_file "$OCTON_DIR/continuity/runs/README.md"
  require_file "$OCTON_DIR/continuity/runs/retention.json"

  require_dir "$OCTON_DIR/ideation/scratchpad"
  require_dir "$OCTON_DIR/ideation/projects"

  require_dir "$OCTON_DIR/output/reports"
  require_dir "$OCTON_DIR/output/reports/analysis"
  require_dir "$OCTON_DIR/output/reports/packages"
  require_dir "$OCTON_DIR/output/reports/operations"
  require_dir "$OCTON_DIR/output/reports/decisions"
  require_dir "$OCTON_DIR/output/reports/migrations"
  require_dir "$OCTON_DIR/output/reports/audits"
  require_dir "$OCTON_DIR/output/drafts"
  require_dir "$OCTON_DIR/output/artifacts"
}

check_cognition_decision_record_surface() {
  local runtime_dir="$OCTON_DIR/cognition/runtime/decisions"
...
check_cognition_migration_record_surface() {
  local policy_dir="$OCTON_DIR/cognition/practices/methodology/migrations"
  local runtime_dir="$OCTON_DIR/cognition/runtime/migrations"
...
check_cognition_audit_record_surface() {
  local policy_dir="$OCTON_DIR/cognition/practices/methodology/audits"
  local runtime_dir="$OCTON_DIR/cognition/runtime/audits"
...
check_output_reports_surface() {
  local reports_root="$OCTON_DIR/output/reports"
...
check_output_audit_evidence_surface() {
  local audits_reports_dir="$OCTON_DIR/output/reports/audits"
...
check_output_workflow_bundle_surface() {
  local workflows_reports_dir="$OCTON_DIR/output/reports/workflows"
...
check_output_decision_evidence_surface() {
  local decisions_reports_dir="$OCTON_DIR/output/reports/decisions"
...
check_cognition_discovery_indexes() {
  check_index_path_contract \
    "$OCTON_DIR/cognition/index.yml" \
    "$OCTON_DIR/cognition" \
    "cognition domain"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/index.yml" \
    "$OCTON_DIR/cognition/runtime" \
    "cognition runtime"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/context/index.yml" \
    "$OCTON_DIR/cognition/runtime/context" \
    "cognition runtime context"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/audits/index.yml" \
    "$OCTON_DIR/cognition/runtime/audits" \
    "cognition runtime audits" \
    true

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/analyses/index.yml" \
    "$OCTON_DIR/cognition/runtime/analyses" \
    "cognition runtime analyses"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/knowledge/index.yml" \
    "$OCTON_DIR/cognition/runtime/knowledge" \
    "cognition runtime knowledge"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/knowledge/graph/index.yml" \
    "$OCTON_DIR/cognition/runtime/knowledge/graph" \
    "cognition runtime knowledge graph"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/knowledge/sources/index.yml" \
    "$OCTON_DIR/cognition/runtime/knowledge/sources" \
    "cognition runtime knowledge sources"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/knowledge/queries/index.yml" \
    "$OCTON_DIR/cognition/runtime/knowledge/queries" \
    "cognition runtime knowledge queries"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/evidence/index.yml" \
    "$OCTON_DIR/cognition/runtime/evidence" \
    "cognition runtime evidence"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/evaluations/index.yml" \
    "$OCTON_DIR/cognition/runtime/evaluations" \
    "cognition runtime evaluations"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/evaluations/digests/index.yml" \
    "$OCTON_DIR/cognition/runtime/evaluations/digests" \
    "cognition runtime evaluation digests"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/evaluations/actions/index.yml" \
    "$OCTON_DIR/cognition/runtime/evaluations/actions" \
    "cognition runtime evaluation actions"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/projections/index.yml" \
    "$OCTON_DIR/cognition/runtime/projections" \
    "cognition runtime projections"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/projections/definitions/index.yml" \
    "$OCTON_DIR/cognition/runtime/projections/definitions" \
    "cognition runtime projection definitions"

  check_index_path_contract \
    "$OCTON_DIR/cognition/runtime/projections/materialized/index.yml" \
    "$OCTON_DIR/cognition/runtime/projections/materialized" \
    "cognition runtime projection materialized"

  check_index_path_contract \
    "$OCTON_DIR/cognition/governance/index.yml" \
    "$OCTON_DIR/cognition/governance" \
    "cognition governance"

  check_index_path_contract \
    "$OCTON_DIR/cognition/governance/principles/index.yml" \
    "$OCTON_DIR/cognition/governance/principles" \
    "cognition governance principles"

  check_index_path_contract \
    "$OCTON_DIR/cognition/governance/pillars/index.yml" \
    "$OCTON_DIR/cognition/governance/pillars" \
    "cognition governance pillars"

  check_index_path_contract \
    "$OCTON_DIR/cognition/governance/purpose/index.yml" \
    "$OCTON_DIR/cognition/governance/purpose" \
    "cognition governance purpose"

  check_index_path_contract \
    "$OCTON_DIR/cognition/governance/controls/index.yml" \
    "$OCTON_DIR/cognition/governance/controls" \
    "cognition governance controls"

  check_index_path_contract \
    "$OCTON_DIR/cognition/governance/exceptions/index.yml" \
    "$OCTON_DIR/cognition/governance/exceptions" \
    "cognition governance exceptions"

  check_index_path_contract \
    "$OCTON_DIR/cognition/practices/index.yml" \
    "$OCTON_DIR/cognition/practices" \
    "cognition practices"

  check_index_path_contract \
    "$OCTON_DIR/cognition/practices/operations/index.yml" \
    "$OCTON_DIR/cognition/practices/operations" \
    "cognition practices operations"

  check_index_path_contract \
    "$OCTON_DIR/cognition/practices/methodology/index.yml" \
    "$OCTON_DIR/cognition/practices/methodology" \
    "cognition methodology"

  check_index_path_contract \
    "$OCTON_DIR/cognition/practices/methodology/migrations/index.yml" \
    "$OCTON_DIR/cognition/practices/methodology/migrations" \
    "cognition methodology migrations"

  check_index_path_contract \
    "$OCTON_DIR/cognition/practices/methodology/audits/index.yml" \
    "$OCTON_DIR/cognition/practices/methodology/audits" \
    "cognition methodology audits"

  check_index_path_contract \
    "$OCTON_DIR/cognition/practices/methodology/templates/index.yml" \
    "$OCTON_DIR/cognition/practices/methodology/templates" \
    "cognition methodology templates"

  check_section_sidecar_contract \
    "$OCTON_DIR/cognition/practices/methodology/README.index.yml" \
    "$OCTON_DIR/cognition/practices/methodology" \
    "cognition methodology readme"

  check_section_sidecar_contract \
    "$OCTON_DIR/cognition/practices/methodology/implementation-guide.index.yml" \
    "$OCTON_DIR/cognition/practices/methodology" \
    "cognition methodology implementation guide"

  check_index_path_contract \
    "$OCTON_DIR/cognition/_meta/architecture/index.yml" \
    "$OCTON_DIR/cognition/_meta/architecture" \
    "cognition architecture"

  check_index_path_contract \
    "$OCTON_DIR/cognition/_meta/architecture/artifact-surface/index.yml" \
    "$OCTON_DIR/cognition/_meta/architecture/artifact-surface" \
    "cognition artifact-surface architecture"

  check_index_path_contract \
    "$OCTON_DIR/cognition/_meta/docs/index.yml" \
    "$OCTON_DIR/cognition/_meta/docs" \
    "cognition discovery docs"

  check_index_path_contract \
    "$OCTON_DIR/cognition/_meta/principles/index.yml" \
    "$OCTON_DIR/cognition/_meta/principles" \
    "cognition principles support docs"

  check_section_sidecar_contract \
    "$OCTON_DIR/cognition/_meta/architecture/README.index.yml" \
    "$OCTON_DIR/cognition/_meta/architecture" \
    "cognition architecture readme"

  check_section_sidecar_contract \
    "$OCTON_DIR/cognition/_meta/architecture/resources.index.yml" \
    "$OCTON_DIR/cognition/_meta/architecture" \
    "cognition architecture resources"
}

check_cognition_migration_index_cross_references() {
  local index_file="$OCTON_DIR/cognition/runtime/migrations/index.yml"
  local index_dir="$OCTON_DIR/cognition/runtime/migrations"
...
check_cognition_audit_index_cross_references() {
  local index_file="$OCTON_DIR/cognition/runtime/audits/index.yml"
  local index_dir="$OCTON_DIR/cognition/runtime/audits"
...
check_deprecated_agency_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/agency/actors"
    "$OCTON_DIR/agency/agents"
    "$OCTON_DIR/agency/assistants"
    "$OCTON_DIR/agency/teams"
    "$OCTON_DIR/agency/subagents"
    "$OCTON_DIR/agency/CONSTITUTION.md"
    "$OCTON_DIR/agency/DELEGATION.md"
    "$OCTON_DIR/agency/MEMORY.md"
  )
...
check_deprecated_capabilities_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/capabilities/commands"
    "$OCTON_DIR/capabilities/skills"
    "$OCTON_DIR/capabilities/tools"
    "$OCTON_DIR/capabilities/services"
    "$OCTON_DIR/capabilities/_ops/policy"
  )
...
check_deprecated_orchestration_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/orchestration/workflows"
    "$OCTON_DIR/orchestration/missions"
    "$OCTON_DIR/orchestration/incidents.md"
    "$OCTON_DIR/orchestration/incident-response.md"
  )
...
check_deprecated_assurance_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/assurance/CHARTER.md"
    "$OCTON_DIR/assurance/DOCTRINE.md"
    "$OCTON_DIR/assurance/CHANGELOG.md"
    "$OCTON_DIR/assurance/complete.md"
    "$OCTON_DIR/assurance/session-exit.md"
    "$OCTON_DIR/assurance/standards"
    "$OCTON_DIR/assurance/trust"
    "$OCTON_DIR/assurance/_ops/scripts"
    "$OCTON_DIR/assurance/_ops/state"
  )
...
check_deprecated_scaffolding_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/scaffolding/patterns"
    "$OCTON_DIR/scaffolding/templates"
    "$OCTON_DIR/scaffolding/prompts"
    "$OCTON_DIR/scaffolding/examples"
    "$OCTON_DIR/scaffolding/_ops/scripts"
  )
...
check_deprecated_cognition_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/cognition/principles"
    "$OCTON_DIR/cognition/pillars"
    "$OCTON_DIR/cognition/purpose"
    "$OCTON_DIR/cognition/methodology"
    "$OCTON_DIR/cognition/context"
    "$OCTON_DIR/cognition/decisions"
    "$OCTON_DIR/cognition/analyses"
    "$OCTON_DIR/cognition/knowledge-plane"
    "$OCTON_DIR/cognition/principles/_ops"
    "$OCTON_DIR/cognition/principles/_meta"
    "$OCTON_DIR/cognition/governance/principles/_meta/docs"
    "$OCTON_DIR/cognition/_meta/principles/ra-acp-glossary.md"
    "$OCTON_DIR/cognition/_meta/principles/ra-acp-promotion-inputs-matrix.md"
    "$OCTON_DIR/cognition/_meta/principles/flag-metadata-contract.md"
    "$OCTON_DIR/cognition/_meta/principles/promotable-slice-decomposition.md"
  )
...
check_deprecated_cognition_discovery_section_paths() {
  local deprecated
  deprecated=(
    "$OCTON_DIR/cognition/practices/methodology/sections"
    "$OCTON_DIR/cognition/_meta/architecture/sections"
  )
...
check_cognition_generated_runtime_artifacts() {
  local script="$OCTON_DIR/cognition/_ops/runtime/scripts/validate-generated-runtime-artifacts.sh"
  if [[ ! -f "$script" ]]; then
...
check_execution_profile_governance_surfaces() {
  ...
  local migrations_readme="$OCTON_DIR/cognition/practices/methodology/migrations/README.md"
  local migrations_doctrine="$OCTON_DIR/cognition/practices/methodology/migrations/doctrine.md"
  local migrations_invariants="$OCTON_DIR/cognition/practices/methodology/migrations/invariants.md"
  local migrations_exceptions="$OCTON_DIR/cognition/practices/methodology/migrations/exceptions.md"
  local migrations_ci_gates="$OCTON_DIR/cognition/practices/methodology/migrations/ci-gates.md"
  local migration_template="$OCTON_DIR/scaffolding/runtime/templates/migrations/template.clean-break-migration.md"
  local migration_instructions="$OCTON_DIR/agency/practices/clean-break-migration.instructions.md"
  local migration_prompt="$OCTON_DIR/scaffolding/practices/prompts/clean-break-migration.prompt.md"
  local workflows_readme="$OCTON_DIR/orchestration/runtime/workflows/README.md"
  ...
  local pr_standards="$OCTON_DIR/agency/practices/pull-request-standards.md"
  local compatibility_policy="$OCTON_DIR/engine/governance/compatibility-policy.md"
  local protocol_versioning="$OCTON_DIR/engine/governance/protocol-versioning.md"
  local release_gates="$OCTON_DIR/engine/governance/release-gates.md"
  local release_runbook="$OCTON_DIR/engine/practices/release-runbook.md"
  local local_dev_validation="$OCTON_DIR/engine/practices/local-dev-validation.md"
