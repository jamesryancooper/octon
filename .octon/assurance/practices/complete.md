...
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-harness-structure.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-contract-governance.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-continuity-memory.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-developer-context-policy.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-context-overhead-budget.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-audit-subsystem-health-alignment.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-audit-convergence-contract.sh` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/alignment-check.sh --profile harness` passes
- [ ] `bash .octon/assurance/runtime/_ops/scripts/validate-framing-alignment.sh` passes
- [ ] `audit-pre-release` workflow executed (or explicit rationale recorded for not running it)
- [ ] Contract coverage report exists at `.octon/output/assurance/results/contract-coverage-latest.md`
...
- [ ] `bash .octon/assurance/runtime/_ops/scripts/alignment-check.sh --profile commit-pr` passes

### For Assurance Weight Governance Changes

- [ ] `bash .octon/assurance/runtime/_ops/scripts/compute-assurance-score.sh --weights .octon/assurance/governance/weights/weights.yml --scores .octon/assurance/governance/scores/scores.yml` runs successfully
- [ ] `bash .octon/assurance/runtime/_ops/scripts/assurance-gate.sh --scorecard <generated-scorecard.yml> --weights .octon/assurance/governance/weights/weights.yml --scores .octon/assurance/governance/scores/scores.yml` passes (or warning rationale is recorded)
- [ ] Resolver generated `.octon/output/assurance/effective/<context>.md` and `.octon/output/assurance/results/<context>.md`
