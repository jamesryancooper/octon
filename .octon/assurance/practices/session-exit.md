...
- [ ] **Run native-first interop checks** (when interop files changed)
  ...
  - `bash .octon/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh --mode platform-core`
  - `bash .octon/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh --mode adapters` (if adapters changed)
  - `bash .octon/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh --mode conformance` (if adapters changed)
  - `bash .octon/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh --mode degradation` (if compaction/adapter behavior changed)
...
- [ ] Ensure flush evidence report exists in `.octon/output/reports/analysis/`
- [ ] If flush failed, verify ACP waiver evidence before proceeding

### If `.octon` architecture surfaces changed

- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/validate-harness-structure.sh`
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/validate-audit-subsystem-health-alignment.sh`
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/validate-audit-convergence-contract.sh`
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/validate-framing-alignment.sh`
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/validate-developer-context-policy.sh`
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/validate-context-overhead-budget.sh`
...
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/alignment-check.sh --profile commit-pr`
...
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/compute-assurance-score.sh --weights .octon/assurance/governance/weights/weights.yml --scores .octon/assurance/governance/scores/scores.yml`
- [ ] Run `bash .octon/assurance/runtime/_ops/scripts/assurance-gate.sh --scorecard <generated-scorecard.yml> --weights .octon/assurance/governance/weights/weights.yml --scores .octon/assurance/governance/scores/scores.yml`
- [ ] Verify `.octon/output/assurance/effective/<context>.md` and `.octon/output/assurance/results/<context>.md` were generated
