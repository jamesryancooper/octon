...
description: Lightweight, actionable baseline for data classification, threat modeling, secrets, redaction, and vulnerability management aligned to Octon gates.
---
