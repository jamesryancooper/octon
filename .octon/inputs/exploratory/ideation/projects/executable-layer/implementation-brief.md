...
1. **Load** WebAssembly component services from `.octon/framework/capabilities/services/<category>/<service>/`
...
12. **Reference KV service** at `.octon/framework/capabilities/services/interfaces/kv/` — fully buildable with `cargo component build`
