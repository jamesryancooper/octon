...
It now explicitly requires connector identity, operation contracts, capability
mappings, material-effect class, credential class, egress class, failure
taxonomy, trust dossiers, support-proof mapping, rollback/replay posture,
quarantine/drift state, and effect-token proof. It does not edit durable targets.
...
validator obligations, acceptance criteria, connector operation contract fields,
and rollback expectations are specified enough for an executable implementation
prompt.
