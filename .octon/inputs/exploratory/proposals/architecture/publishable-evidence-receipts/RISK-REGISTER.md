...
| --- | ---: | --- |
| Receipts could become vague summaries; mitigate by requiring claim scope, validation summary, outcome, limitations, redactions, and local evidence digest references. | High | Keep validators and acceptance criteria blocking until the risk is addressed. |
