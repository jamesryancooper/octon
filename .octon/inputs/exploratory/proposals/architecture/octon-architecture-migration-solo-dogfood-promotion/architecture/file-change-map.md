...
| --- | --- |
| `.octon/state/evidence/validation/proposals/octon-architecture-migration-solo-dogfood-promotion/**` | Sole direct durable target: equal-floor `O/S/V/Q` route/history/CAS/PR/mirror/cleanup/preservation protocol outputs, measurements, claim map, and handoff. |
