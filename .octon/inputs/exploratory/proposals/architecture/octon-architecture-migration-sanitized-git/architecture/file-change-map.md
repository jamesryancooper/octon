...
| --- | --- | --- | --- | --- | --- |
| .octon/framework/engine/runtime/crates/local_broker/src/adapters/git/ | No accepted broker Git module exists | Add closed adapter, request/result boundary, non-executing import, exact update, and observations | RP-05 | P0 | Isolates privileged Git from broker core and candidate state |
...
| .octon/framework/execution-roles/practices/git-github-autonomy-workflow-v1.md | Documents ambient and hosted helper behavior | State broker-only Git, expected-old fast-forward, and protected-PR fallback | RP-05 for primitive text | P1 | Aligns durable operating doctrine |
