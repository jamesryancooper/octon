...
readiness receipts, and fresh review-gate digests. The optional
`mechanism-detail-pages-and-operator-map` child exists but remains deferred and
does not block mandatory closeout unless a later accepted mutation marks it
required.
