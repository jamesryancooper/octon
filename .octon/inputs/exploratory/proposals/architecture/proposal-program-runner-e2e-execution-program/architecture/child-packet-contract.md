...
- Child implementation-grade completeness reviews pass before implementation
  prompt generation.
- Child proposal reviews are fresh, accepted, and explicitly authorize
  implementation prompt generation.
- Child executable implementation prompts require post-implementation
