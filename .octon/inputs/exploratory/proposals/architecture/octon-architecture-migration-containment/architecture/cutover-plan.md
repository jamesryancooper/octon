...
- The accepted ROD-006 no-Octon-direct-main posture is bound.
...
6. Refresh affected generated projections through their owners.
7. Capture the burden baseline and run negative controls.
8. Publish the RP-00 evidence bundle and conformance receipts.

Steps 2 through 5 are one clean-break containment transition. There is no
period in which both the unsafe route and its contained replacement are
accepted as supported autonomous paths.
...
- RP-01 receives the frozen launcher, authority-input, and policy inventory.
- RP-02 receives the credential and candidate-host exposure inventory.
- RP-05/RP-06 receive the GitHub writer, workflow, route, and check-producer
  inventory.
- RP-09 receives the trust-root inventory skeleton.
- RP-14 receives the claim-correction and burden baselines.

Handoffs cite retained evidence by reference and digest. They do not transfer
or duplicate source ownership.
