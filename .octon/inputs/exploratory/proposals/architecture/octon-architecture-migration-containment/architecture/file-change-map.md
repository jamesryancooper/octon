...
| `.octon/framework/product/contracts/default-work-unit.md` | Narrative projects the machine route. | Align operator-facing semantics and safe protected-PR bridge. | P0: prevents policy/document drift. |
