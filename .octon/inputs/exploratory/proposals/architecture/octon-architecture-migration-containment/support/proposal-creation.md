...
- creation_id: `octon-architecture-migration-containment-creation-20260712`
- created_at: `2026-07-12`
- creator: `codex proposal packet author`
- proposal_id: `octon-architecture-migration-containment`
- packet_path: `.octon/inputs/exploratory/proposals/architecture/octon-architecture-migration-containment`
...
contracts, provider state, control state, retained evidence, or generated
outputs. The receipt proves packet creation only. It does not approve review,
acceptance, implementation, publication, promotion, closeout, or archive.
