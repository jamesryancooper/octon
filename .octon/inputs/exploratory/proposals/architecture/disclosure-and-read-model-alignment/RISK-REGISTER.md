...
| --- | ---: | --- |
| Generated summaries could become de facto evidence; mitigate with explicit forbidden-consumer rules and generated non-authority validation. | High | Keep validators and acceptance criteria blocking until the risk is addressed. |
