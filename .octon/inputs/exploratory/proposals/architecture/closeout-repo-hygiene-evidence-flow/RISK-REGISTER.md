...
| --- | ---: | --- |
| Closeout could silently lose debugging detail; mitigate by retaining raw local evidence while publishing concise claim receipts. | High | Keep validators and acceptance criteria blocking until the risk is addressed. |
