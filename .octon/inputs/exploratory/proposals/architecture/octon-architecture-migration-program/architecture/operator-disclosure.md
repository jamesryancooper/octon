...
settled/retired lineage, and the operator has accepted the recommended bounded
postures for ROD-001, ROD-003, ROD-004, ROD-005, and ROD-006. No genuine
operator decision remains. Implementation mechanisms, provider conformance,
safely reversible measurement-adjusted values, and proof obligations stay
engineering/proof work. Support wording and optional-capability admission are
later evidence-gated promotion acceptances, not current design choices.
