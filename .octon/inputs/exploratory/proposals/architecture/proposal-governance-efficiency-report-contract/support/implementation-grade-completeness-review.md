...
The report contract is advisory and non-authorizing.
...
No evidence collection, scoring implementation, operator surface, lifecycle gate, cleanup, archive, branch mutation, or terminal proof is authorized by this packet.

## Final Route Recommendation

Review the child independently, then implement only the report contract and validator scope.
