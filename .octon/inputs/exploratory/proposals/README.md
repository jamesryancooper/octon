...
- active proposals live under `/.octon/inputs/exploratory/proposals/<kind>/<proposal_id>/`
- archived proposals live under `/.octon/inputs/exploratory/proposals/.archive/<kind>/<proposal_id>/`
