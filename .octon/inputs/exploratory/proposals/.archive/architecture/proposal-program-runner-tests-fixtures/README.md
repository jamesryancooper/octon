# Proposal Program Runner Tests And Fixtures

This accepted child proposal packet covers tests, fixtures, negative controls, and validation coverage for the parent
