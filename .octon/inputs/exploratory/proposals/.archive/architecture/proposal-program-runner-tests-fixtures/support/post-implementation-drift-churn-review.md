...
- Work Package wording found in the promoted assurance test target is fixture
  coverage for legacy naming detection, not a live lifecycle naming dependency
  or newly promoted work-package concept.
