...
The archived parent program deferred `mcp-integration-evaluation` as optional,
non-required, lab-only, and uncreated. This child packet owns the later
implementation and does not inherit implementation authority from the parent.
