...
worktree_hygiene_evidence: classify-proposal-worktree-hygiene.sh --target .octon/inputs/exploratory/proposals/architecture/escalation-policy-update --lifecycle proposal-program --run-id lifecycle-proposal-program-1780585581804-afdb21bb --format yaml
...
- Dependency-gate blockers resolved mechanically after
  evidence-and-receipt-hardening and runner-recovery-behavior verification
  receipts were present and validated.
- Route classification recorded as `boundary-change` because escalation
  responsibility boundaries, dependency handling, recovery contracts, and
