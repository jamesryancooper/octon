...
The archived parent program deferred
`external-workflow-engine-adapter-evaluation` as optional, non-required,
lab-only, and uncreated. This child packet owns the later implementation and
does not inherit implementation authority from the parent.
