...
- External workflow engines remain non-live and stage-only in this packet.
- Local Octon workflow, run, authorization, support, evidence, and closeout
  roots remain canonical.
...
Complete. The packet names all durable artifacts needed to prove the external
...
- No external engine workflow or run truth.
