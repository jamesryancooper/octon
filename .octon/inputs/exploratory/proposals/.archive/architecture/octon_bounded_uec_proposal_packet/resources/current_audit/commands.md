...
sed -n '1,220p' .octon/framework/orchestration/_meta/architecture/specification.md
sed -n '1,220p' .octon/framework/orchestration/practices/workflow-authoring-standards.md
sed -n '1,220p' .octon/framework/orchestration/practices/mission-lifecycle-standards.md
sed -n '1,220p' .octon/framework/orchestration/governance/incidents.md
sed -n '1,240p' .octon/framework/cognition/_meta/architecture/state/continuity/continuity-plane.md
sed -n '1,220p' .octon/state/evidence/runs/README.md
rg --files .design-packages/orchestration-domain-design-package | rg -v '\.md$'
[ -e .octon/state/evidence/decisions/repo ] && echo exists || echo missing
