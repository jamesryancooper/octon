...
packet_id: architectural-review-native-workflows
...
## Scope Implemented
Added canonical workflow contracts and stage docs for pre-integration, post-integration, current-state mechanism architecture review, and the canonical architecture-readiness-audit workflow route.
...
- `.octon/generated/proposals/artifacts/architecture/architectural-review-native-workflows/`
