...
retained_evidence_root: .octon/state/evidence/validation/proposals/durable-coordination-adapter-evaluation/2026-06-09T01-51-38Z/
parent_program: governed-workflow-runtime-transition-program

## Implementation Summary

Implemented durable coordination adapter evaluation as a lab-only child packet.
Durable outputs include the adapter lab evaluation record, retained lab proof,
non-live evaluation admission record, shared adapter boundary contract, and
validator coverage.
...
- `.octon/state/evidence/validation/proposals/durable-coordination-adapter-evaluation/2026-06-09T01-51-38Z/command-summary.tsv`
- `.octon/state/evidence/validation/proposals/durable-coordination-adapter-evaluation/2026-06-09T01-51-38Z/validation.md`

## Rollback

Remove durable coordination adapter evaluation-specific lab, admission, and
