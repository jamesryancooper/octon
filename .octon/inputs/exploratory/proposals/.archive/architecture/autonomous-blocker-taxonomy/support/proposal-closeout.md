...
worktree_hygiene_evidence: classify-proposal-worktree-hygiene.sh --target .octon/inputs/exploratory/proposals/architecture/autonomous-blocker-taxonomy --lifecycle proposal-program --run-id lifecycle-proposal-program-1780585581804-afdb21bb --format yaml
...
- Stale route classification evidence recorded in the implementation receipts;
  this child introduced a new blocker taxonomy surface and changed recovery
  boundaries through the program contract and validators.
