...
- Work Package wording found in the promoted validator script target is
  validator self-detection and failure-message vocabulary, not a live lifecycle
  naming dependency or newly promoted work-package concept.
