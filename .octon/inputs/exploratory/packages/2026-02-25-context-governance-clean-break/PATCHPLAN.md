...
1. `/.octon/framework/engine/governance/instruction-layer-precedence.md`
2. `/.octon/framework/engine/runtime/spec/instruction-layer-manifest-v1.schema.json`
3. `/.octon/framework/capabilities/governance/policy/deny-by-default.v2.yml`
4. `/.octon/framework/engine/runtime/spec/policy-receipt-v1.schema.json`
5. `/.octon/framework/capabilities/governance/policy/acp-provenance-fields.schema.json`
