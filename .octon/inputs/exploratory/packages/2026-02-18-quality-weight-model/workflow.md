...
1. Update subsystem measured scores in `.octon/framework/assurance/governance/scores/scores.yml`.
...
- `.octon/generated/assurance/scorecards/<YYYY-MM-DD>/<run-id>/`
...
1. CI publishes scorecard artifacts as build artifacts and (optionally) commits summary markdown under `.octon/generated/assurance/scorecards/`.
