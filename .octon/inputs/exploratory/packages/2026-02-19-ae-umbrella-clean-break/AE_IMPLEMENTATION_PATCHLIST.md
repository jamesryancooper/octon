...
### 1. `.octon/framework/assurance/CHARTER.md`
...
### 2. `.octon/framework/assurance/standards/weights/weights.yml`
...
### 3. `.octon/runtime/crates/assurance_tools/src/main.rs`
...
### 4. `.octon/runtime/crates/assurance_tools/src/main.rs`
...
### 5. `.octon/runtime/crates/assurance_tools/src/main.rs`
...
### 6. `.octon/runtime/crates/assurance_tools/src/main.rs`
...
### 7. `.octon/framework/assurance/README.md`
### 8. `.octon/framework/assurance/DOCTRINE.md`
### 9. `.octon/framework/assurance/governance/SUBSYSTEM_OVERRIDE_POLICY.md`
### 10. `.octon/framework/assurance/standards/weights/weights.md`
### 11. `.octon/framework/assurance/complete.md`
### 12. `.octon/framework/assurance/session-exit.md`
...
### 14. `.octon/framework/assurance/_ops/scripts/alignment-check.sh`
...
```bash
rg -n "QGE|legacy QGE label" .octon .github
```
...
- `.octon/inputs/exploratory/packages/2026-02-18-quality-charter-qge-integration/` rename and content edits
