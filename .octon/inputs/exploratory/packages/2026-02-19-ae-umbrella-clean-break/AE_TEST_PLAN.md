...
- add test module or integration tests under:
  `.octon/runtime/crates/assurance_tools/tests/`
...
- `.octon/runtime/crates/assurance_tools/tests/fixtures/umbrella/`
...
```bash
rg -n "trust|speed_of_development|ease_of_use" .octon/runtime/crates/assurance_tools/src/main.rs .octon/framework/assurance/standards/weights/weights.yml
...
1. `cargo test -p octon_assurance_tools`
