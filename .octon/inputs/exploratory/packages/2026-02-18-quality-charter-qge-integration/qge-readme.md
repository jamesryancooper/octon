...
- Evidence outputs are generated as local artifacts under `.octon/generated/assurance/`.
...
| `_ops/scripts/validate-audit-subsystem-health-alignment.sh` | Drift guardrail between `.octon` architecture and `audit-subsystem-health` | When `.octon` architecture surfaces change |
