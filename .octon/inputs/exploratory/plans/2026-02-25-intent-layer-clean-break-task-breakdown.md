...
```bash
bash .octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh --profile harness,agency,workflows,weights,intent-layer
# Alignment check summary: errors=0

bash .octon/framework/assurance/runtime/_ops/scripts/assurance-gate.sh --help >/dev/null
...
bash .octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh --profile harness,agency,workflows,weights
```
...
1. `.octon/framework/engine/runtime/spec/intent-contract-v1.schema.json`
...
```bash
test -f .octon/framework/engine/runtime/spec/intent-contract-v1.schema.json && \
...
1. `.octon/framework/engine/runtime/spec/policy-interface-v1.md`
2. `.octon/framework/engine/runtime/config/policy-interface.yml`
...
1. `.octon/framework/engine/runtime/spec/policy-receipt-v1.schema.json`
2. `.octon/framework/engine/runtime/spec/policy-digest-v1.md`
...
rg -n "intent|boundary|workflow mode|classification" .octon/framework/engine/runtime/spec/policy-digest-v1.md
```
...
1. `.octon/framework/capabilities/_ops/scripts/policy-receipt-write.sh`
...
1. `.octon/framework/agency/governance/delegation-boundaries-v1.yml`
2. `.octon/framework/agency/governance/delegation-boundaries-v1.schema.json`
...
```bash
test -f .octon/framework/agency/governance/delegation-boundaries-v1.yml && \
...
rg -n "delegation-boundaries-v1" .octon/framework/agency/governance/DELEGATION.md
```
...
1. `.octon/framework/capabilities/governance/policy/deny-by-default.v2.yml`
2. `.octon/framework/engine/runtime/config/policy.yml`
...
1. `.octon/framework/orchestration/governance/capability-map-v1.yml`
2. `.octon/framework/orchestration/governance/capability-map-v1.schema.json`
...
```bash
test -f .octon/framework/orchestration/governance/capability-map-v1.yml && \
...
rg -n "agent-ready|agent-augmented|human-only" .octon/framework/orchestration/governance/capability-map-v1.yml
```
...
2. `.octon/framework/orchestration/runtime/workflows/registry.yml`
3. `.octon/framework/orchestration/governance/README.md`
...
1. `.octon/framework/capabilities/governance/policy/deny-by-default.v2.yml`
2. `.octon/framework/engine/runtime/spec/policy-interface-v1.md`
...
1. `.octon/framework/assurance/runtime/_ops/scripts/validate-intent-layer.sh`
2. `.octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh`
...
```bash
bash .octon/framework/assurance/runtime/_ops/scripts/validate-intent-layer.sh && \
...
1. `.octon/framework/assurance/governance/scores/scores.yml`
2. `.octon/framework/assurance/governance/weights/weights.yml`
3. `.octon/framework/assurance/governance/CHARTER.md`
...
bash .octon/framework/assurance/runtime/_ops/scripts/compute-assurance-score.sh --help >/dev/null
```
...
1. `.octon/instance/cognition/decisions/044-intent-contract-and-boundary-enforcement.md`
2. `.octon/instance/cognition/decisions/045-capability-map-and-alignment-drift-gates.md`
3. `.octon/instance/cognition/decisions/index.yml`
...
```bash
test -f .octon/instance/cognition/decisions/044-intent-contract-and-boundary-enforcement.md && \
test -f .octon/instance/cognition/decisions/045-capability-map-and-alignment-drift-gates.md && \
...
1. `.octon/state/continuity/repo/log.md`
2. `.octon/state/continuity/repo/tasks.json`
3. `.octon/state/continuity/repo/next.md`
