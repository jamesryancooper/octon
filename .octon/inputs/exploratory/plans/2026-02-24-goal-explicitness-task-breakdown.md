...
2. Do not edit immutable charter: `/.octon/framework/cognition/governance/principles/principles.md`.
...
rg -nF "$CANON" \
  ...
  .octon/framework/agency/runtime/agents/architect/SOUL.md || true
```
...
1. `.octon/framework/agency/governance/CONSTITUTION.md`
...
```bash
CANON='Enable reliable agent execution that is deterministic enough to trust, observable enough to debug, and flexible enough to evolve.' && \
rg -nF "$CANON" .octon/framework/agency/governance/CONSTITUTION.md
```
...
1. `.octon/framework/agency/governance/DELEGATION.md`
...
```bash
CANON='Enable reliable agent execution that is deterministic enough to trust, observable enough to debug, and flexible enough to evolve.' && \
rg -nF "$CANON" .octon/framework/agency/governance/DELEGATION.md
```
...
1. `.octon/framework/agency/governance/MEMORY.md`
...
```bash
CANON='Enable reliable agent execution that is deterministic enough to trust, observable enough to debug, and flexible enough to evolve.' && \
rg -nF "$CANON" .octon/framework/agency/governance/MEMORY.md
```
...
1. `.octon/framework/agency/runtime/agents/architect/AGENT.md`
2. `.octon/framework/agency/runtime/agents/architect/SOUL.md`
...
1. `.octon/framework/cognition/governance/principles/principles.md` (read-only check)
2. Optional successor: `.octon/framework/cognition/governance/principles/principles-v2026-02-24.md`
3. Optional ADR in `.octon/instance/cognition/decisions/`
...
1. `.octon/README.md`
2. `.octon/instance/bootstrap/START.md`

Exact edit order:

1. Add canonical goal sentence in `.octon/README.md` Purpose/Overview.
2. Add canonical goal sentence in `.octon/instance/bootstrap/START.md` near top orientation.

Verification command:

```bash
CANON='Enable reliable agent execution that is deterministic enough to trust, observable enough to debug, and flexible enough to evolve.' && \
rg -nF "$CANON" .octon/README.md .octon/instance/bootstrap/START.md
```
...
1. `.octon/framework/agency/README.md`
2. `.octon/framework/capabilities/README.md`
3. `.octon/framework/capabilities/runtime/README.md`
4. `.octon/framework/cognition/README.md`
5. `.octon/framework/orchestration/README.md`
6. `.octon/framework/cognition/_meta/architecture/state/continuity/README.md`
7. `.octon/framework/engine/governance/README.md`
...
rg -nF "$CANON" \
  ...
  .octon/framework/cognition/_meta/architecture/state/continuity/README.md \
...
1. `.octon/framework/cognition/_meta/architecture/state/continuity/continuity-plane.md`
2. `.octon/state/evidence/runs/README.md`
3. `.octon/framework/cognition/_meta/architecture/state/continuity/runs-retention.md`
...
1. `.octon/framework/cognition/governance/purpose/convivial-purpose.md`
...
```bash
rg -n "five pillars|six pillars" .octon/framework/cognition/governance/purpose/convivial-purpose.md .octon/framework/cognition/governance/pillars/README.md
```
...
1. `.octon/framework/orchestration/runtime/workflows/_scaffold/template/WORKFLOW.md`
2. `.octon/framework/capabilities/runtime/skills/_scaffold/template/SKILL.md`
3. `.octon/framework/capabilities/runtime/services/_scaffold/template/SERVICE.md`
...
CANON='Enable reliable agent execution that is deterministic enough to trust, observable enough to debug, and flexible enough to evolve.' && \
rg -nF "$CANON" \
  .octon/framework/orchestration/runtime/workflows/_scaffold/template/WORKFLOW.md \
  .octon/framework/capabilities/runtime/skills/_scaffold/template/SKILL.md \
  .octon/framework/capabilities/runtime/services/_scaffold/template/SERVICE.md
```
...
1. `.octon/framework/orchestration/runtime/workflows/manifest.yml`
2. `.octon/framework/capabilities/runtime/skills/manifest.yml`
3. `.octon/framework/capabilities/runtime/services/manifest.yml`
4. `.octon/framework/capabilities/runtime/commands/manifest.yml`
...
1. `.octon/framework/scaffolding/runtime/templates/AGENTS.md`
2. `.octon/framework/scaffolding/runtime/templates/octon/START.md`
3. `.octon/framework/scaffolding/runtime/templates/octon/continuity/tasks.json`
4. `.octon/framework/scaffolding/runtime/templates/octon/agency/manifest.yml`
5. `.octon/framework/scaffolding/runtime/templates/octon/manifest.json` (template consistency fixes)
...
rg -nF "$CANON" \
  ...
  .octon/framework/scaffolding/runtime/templates/octon/continuity/tasks.json && \
rg -n "goal|alignment|assurance|runtime/agents" .octon/framework/scaffolding/runtime/templates/octon/manifest.json
```
...
1. `.octon/framework/assurance/runtime/_ops/scripts/validate-framing-alignment.sh`
...
1. `.octon/framework/assurance/runtime/_ops/scripts/validate-ssot-precedence-drift.sh`
...
```bash
bash .octon/framework/assurance/runtime/_ops/scripts/alignment-check.sh --profile framing,harness,agency,workflows,skills,services,weights
```
