...
Date: 2026-02-10
Source: `.octon/state/evidence/validation/analysis/2026-02-10-skills-subsystem-audit.md`
...
**File:** `.octon/framework/capabilities/skills/meta/build-mcp-server/SKILL.md`
...
**File:** `.octon/framework/capabilities/skills/foundations/python-api/SKILL.md` (line 43-50 area)

Change child skill table commands from `/scaffold-package` to `/python-scaffold-package`, etc.

**File:** `.octon/framework/capabilities/skills/foundations/swift-macos-app/SKILL.md` (line 46-55 area)
...
- `.octon/framework/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness.md`
- `.octon/framework/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness-rerun.md`
...
```bash
mv .octon/framework/capabilities/skills/runs/research-synthesizer .octon/framework/capabilities/skills/runs/synthesize-research
mv .octon/framework/capabilities/skills/configs/research-synthesizer .octon/framework/capabilities/skills/configs/synthesize-research
```
...
```
│  4. HARNESS REGISTRY (.octon/framework/capabilities/skills/registry.yml)                      │
...
```
│  4. REGISTRY (.octon/framework/capabilities/skills/registry.yml)                     │
...
The current diagram shows two separate blocks both pointing to `.octon/framework/capabilities/skills/` as if they were distinct directories ("Shared skill definitions" and "Harness-specific configuration"). Merge into a single accurate tree:
...
**File:** `.octon/framework/capabilities/skills/README.md` (add new section)
...
**File:** `.octon/framework/capabilities/skills/capabilities.yml` (add comment block)
...
```bash
bash .octon/framework/capabilities/skills/scripts/validate-skills.sh
```
