...
All in `.octon/framework/capabilities/services/conventions/`. Follow existing convention
...
**8. `.octon/framework/capabilities/services/capabilities.yml`**
...
**9. `.octon/framework/capabilities/services/_scaffold/template/SERVICE.md`**
...
**10. `.octon/framework/capabilities/services/README.md`**
...
- `.octon/framework/capabilities/services/conventions/run-records.md` — pattern for convention format
- `.octon/framework/capabilities/services/conventions/error-codes.md` — pattern for convention format
- `.octon/framework/capabilities/services/_scaffold/template/SERVICE.md` — template to update
- `.octon/framework/capabilities/services/capabilities.yml` — registry to update
- `.octon/framework/capabilities/services/README.md` — contents table to update
...
- [x] `.octon/framework/capabilities/services/conventions/rich-contracts.md`
- [x] `.octon/framework/capabilities/services/conventions/declarative-rules.md`
- [x] `.octon/framework/capabilities/services/conventions/fixtures.md`
- [x] `.octon/framework/capabilities/services/conventions/validation-tiers.md`
- [x] `.octon/framework/capabilities/services/conventions/implementation-generation.md`

### Phase 3

- [x] `.octon/framework/capabilities/services/capabilities.yml`
- [x] `.octon/framework/capabilities/services/_scaffold/template/SERVICE.md`
- [x] `.octon/framework/capabilities/services/README.md`
