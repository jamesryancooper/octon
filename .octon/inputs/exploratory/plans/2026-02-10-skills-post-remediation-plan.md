...
- `.octon/framework/capabilities/skills/platforms/vercel/deploy/SKILL.md` — line 14
...
- `.octon/framework/capabilities/skills/meta/create-skill/SKILL.md` — lines 66, 73
- `.octon/framework/capabilities/skills/meta/create-skill/references/io-contract.md` — lines 24, 31-38, 56-58, 34 (`behaviors.md`), 93 (`behaviors.md`)
- `.octon/framework/capabilities/skills/registry.yml` — lines 635-644, 655
...
4. **io-contract.md output structure (lines 31-38):** Update path from `.octon/framework/capabilities/skills/{{skill-name}}/` to `.octon/framework/capabilities/skills/<group>/{{skill-name}}/`. Replace `behaviors.md` with `phases.md` in the directory tree.
...
- `.octon/framework/capabilities/skills/scripts/validate-skills.sh` — check 3 (line 1946-1952)
...
- `docs/architecture/harness/skills/creation.md` line 151: `.octon/framework/capabilities/skills/<skill-name>/` → `.octon/framework/capabilities/skills/<group>/<skill-name>/`
...
1. Run `bash .octon/framework/capabilities/skills/scripts/validate-skills.sh` — should exit 0 with reduced warnings (target: < 72).
