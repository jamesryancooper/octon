...
- `.octon/framework/capabilities/services/interfaces/filesystem-graph/service.json`
- `.octon/framework/capabilities/services/interfaces/filesystem-graph/service.wasm`

2. Rust component scaffold:
- `.octon/framework/capabilities/services/interfaces/filesystem-graph/rust/Cargo.toml`
- `.octon/framework/capabilities/services/interfaces/filesystem-graph/rust/src/lib.rs`
- `.octon/framework/capabilities/services/interfaces/filesystem-graph/rust/wit/world.wit`

3. Runtime registration:
- Update `.octon/framework/capabilities/services/manifest.runtime.yml`
- Update `.octon/framework/capabilities/services/registry.runtime.yml`
