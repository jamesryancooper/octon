# Plan: `tools/` and `services/` Subsystems for `.octon/framework/capabilities/`
...
introduces two new subsystems under `.octon/framework/capabilities/` to make these
...
**Files to create:**
- `.octon/framework/capabilities/services/conventions/error-codes.md`
- `.octon/framework/capabilities/services/conventions/run-records.md`
- `.octon/framework/capabilities/services/conventions/observability.md`
- `.octon/framework/capabilities/services/conventions/idempotency.md`
...
### Files to create
- `.octon/framework/capabilities/tools/README.md`
- `.octon/framework/capabilities/tools/manifest.yml`
- `.octon/framework/capabilities/tools/registry.yml`
- `.octon/framework/capabilities/tools/capabilities.yml`
- `.octon/framework/capabilities/tools/_scaffold/template/TOOL.md`
- `.octon/framework/capabilities/tools/_ops/scripts/validate-tools.sh`
...
### Files to create
- `.octon/framework/capabilities/services/README.md`
- `.octon/framework/capabilities/services/manifest.yml`
- `.octon/framework/capabilities/services/registry.yml`
- `.octon/framework/capabilities/services/capabilities.yml`
- `.octon/framework/capabilities/services/_scaffold/template/SERVICE.md`
- `.octon/framework/capabilities/services/_scaffold/template/impl/.gitkeep`
- `.octon/framework/capabilities/services/_scaffold/template/schema/input.schema.json`
- `.octon/framework/capabilities/services/_scaffold/template/schema/output.schema.json`
- `.octon/framework/capabilities/services/_scaffold/template/references/examples.md`
- `.octon/framework/capabilities/services/_scaffold/template/references/errors.md`
- `.octon/framework/capabilities/services/_ops/scripts/validate-services.sh`
...
**`.octon/framework/capabilities/README.md`** — Expand from 3-subsystem to 4-subsystem
table. Add the 2x2 classification diagram. Update interaction model descriptions.

**`.octon/instance/bootstrap/catalog.md`** — Add `## Tools` section (pack table, usage example)
...
**`.octon/framework/capabilities/skills/_scaffold/template/SKILL.md`** — Add `allowed-services`
field to frontmatter template.

**`.octon/framework/capabilities/skills/_ops/scripts/validate-skills.sh`** — Add validation
for `pack:` prefix resolution in `allowed-tools` and `allowed-services` values
against `services/manifest.yml`.

**`.octon/instance/bootstrap/START.md`** — Update the structure tree to show `tools/` and
...
- `.octon/framework/capabilities/skills/_scaffold/template/SKILL.md`
- `.octon/framework/capabilities/skills/_ops/scripts/validate-skills.sh`
