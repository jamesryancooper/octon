...
- Backlog artifact: `.octon/inputs/exploratory/plans/2026-03-10-orchestration-domain-phase0-backlog.md`
...
- Evidence:
  - current implementation targets and deferred surfaces are recorded in
    `.octon/framework/orchestration/practices/orchestration-domain-implementation-agreement.md`
