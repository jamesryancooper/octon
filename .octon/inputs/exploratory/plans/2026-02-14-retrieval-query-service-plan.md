# Plan: Retrieval Query Service (`.octon/framework/capabilities/services/retrieval/query`)

## Context

`retrieval/query` currently exists only as a design guide:

- `.octon/framework/capabilities/services/retrieval/query/guide.md`

It is not yet a first-class service in the services subsystem:

- no `SERVICE.md`
- no typed schemas, rules, fixtures, or contract invariants
- no registry entry in `.octon/framework/capabilities/services/manifest.yml` and `.octon/framework/capabilities/services/registry.yml`
...
1. `.octon/framework/capabilities/services/retrieval/query/SERVICE.md`
2. `.octon/framework/capabilities/services/retrieval/query/schema/input.schema.json`
3. `.octon/framework/capabilities/services/retrieval/query/schema/output.schema.json`
4. `.octon/framework/capabilities/services/retrieval/query/rules/rules.yml`
5. `.octon/framework/capabilities/services/retrieval/query/contracts/invariants.md`
6. `.octon/framework/capabilities/services/retrieval/query/contracts/errors.yml`
7. `.octon/framework/capabilities/services/retrieval/query/compatibility.yml`
8. `.octon/framework/capabilities/services/retrieval/query/fixtures/positive.json`
9. `.octon/framework/capabilities/services/retrieval/query/fixtures/negative.json`
10. `.octon/framework/capabilities/services/retrieval/query/fixtures/edge.json`
11. `.octon/framework/capabilities/services/retrieval/query/references/examples.md`
12. `.octon/framework/capabilities/services/retrieval/query/references/errors.md`
13. `.octon/framework/capabilities/services/retrieval/query/impl/generated.manifest.json` (stub: `"status": "pending"`)
...
1. `.octon/framework/capabilities/services/retrieval/query/impl/query.sh` (shell entrypoint)
...
1. Add `query` service in `.octon/framework/capabilities/services/manifest.yml`.
2. Add `query` metadata in `.octon/framework/capabilities/services/registry.yml`.
   - Declare `integratesWith: [index]` (Query reads index artifacts).
3. Update `.octon/framework/capabilities/services/capabilities.yml`:
   - add `retrieval` to `service_categories`.
4. Add command docs:
   - `.octon/framework/capabilities/commands/query-ask.md`
   - `.octon/framework/capabilities/commands/query-retrieve.md`
   - `.octon/framework/capabilities/commands/query-explain.md`
5. Register commands in `.octon/framework/capabilities/commands/manifest.yml`.
...
1. Extend `.octon/framework/capabilities/services/_ops/scripts/validate-services.sh` coverage implicitly via manifest onboarding.
2. Extend `.octon/framework/capabilities/services/_ops/scripts/validate-service-independence.sh` `services-core` scan list to include `retrieval/query`.
...
4. Baseline report in:
   - `.octon/state/evidence/validation/analysis/<date>-query-baseline.md`
...
- `.octon/framework/capabilities/services/retrieval/query/`
