...
2. `.octon/framework/assurance/README.md`
3. `.octon/framework/assurance/DOCTRINE.md`
4. `.octon/README.md` (Assurance Engine section)
5. `.octon/framework/assurance/standards/weights/weights.md`
6. `.octon/framework/assurance/complete.md`
7. `.octon/framework/assurance/session-exit.md`
...
- optional: add `.octon/framework/assurance/CHANGELOG.md` if a standalone changelog is adopted
...
1. Pull updated `.octon/framework/assurance/` files and AE runtime crate changes.
