...
2. Set timeout in:
`/.octon/framework/capabilities/services/agent-platform/slow/service.json`
...
`/.octon/framework/capabilities/services/agent-platform/slow/rust/src/lib.rs`
...
- `cargo component check` in `/.octon/framework/capabilities/services/interfaces/kv/rust` passes.
