---
name: nextjs-app-router-runtime
description: >
...
# Nextjs App Router Runtime

Example extension-pack skill for proposal illustration only.

## When to Use

- The repository is using a Next.js App Router surface
- A task needs framework-specific runtime guidance
