...
Written to `.octon/output/reports/analysis/YYYY-MM-DD-pr-comments-resolved.md`.

### Execution Log

Written to `.octon/capabilities/runtime/skills/_ops/state/logs/resolve-pr-comments/{{run_id}}.md`.

### Log Index

Written to `.octon/capabilities/runtime/skills/_ops/state/logs/resolve-pr-comments/index.yml`.
