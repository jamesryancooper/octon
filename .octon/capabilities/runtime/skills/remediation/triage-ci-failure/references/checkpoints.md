...
checkpoints:
  strategy: phase
  storage: ".octon/capabilities/runtime/skills/_ops/state/runs/triage-ci-failure/{{run-id}}/"
  retention: session
...
- State is saved in `.octon/capabilities/runtime/skills/_ops/state/runs/triage-ci-failure/{{run-id}}/`.
