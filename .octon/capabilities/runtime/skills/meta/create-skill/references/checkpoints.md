...
checkpoints:
  strategy: phase
  storage: ".octon/capabilities/runtime/skills/_ops/state/runs/create-skill/{{run_id}}/"
  retention: session
...
- State lives in `.octon/capabilities/runtime/skills/_ops/state/runs/create-skill/{{run_id}}/`.
