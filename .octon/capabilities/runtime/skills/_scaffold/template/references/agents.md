...
#
# See: .octon/capabilities/_meta/architecture/reference-artifacts.md#agentsmd
#
agents:
...
- Sub-agents cannot write outside `.octon/capabilities/runtime/skills/` unless parent has explicit permission
