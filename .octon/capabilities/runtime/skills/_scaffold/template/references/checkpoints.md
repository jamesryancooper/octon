...
#
# See: .octon/capabilities/_meta/architecture/reference-artifacts.md#checkpointsmd
#
checkpoints:
  strategy: phase                    # phase | step | time-based
  storage: ".octon/capabilities/runtime/skills/_ops/state/runs/{{skill-id}}/{{run-id}}/"
...
```yaml
# .octon/capabilities/runtime/skills/_ops/state/runs/refactor/2026-01-22-scratch-to-scratchpad/checkpoint.yml
skill: refactor
version: "1.0.0"
status: in_progress
current_phase: 4
...
resume:
  ...
  last_completed: ".octon/cognition/runtime/context/tools.md"
```
...
│     - Continue from item 8: .octon/orchestration/runtime/workflows/example.md       │
