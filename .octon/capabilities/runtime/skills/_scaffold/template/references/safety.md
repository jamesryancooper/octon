...
#
# See: .octon/capabilities/_meta/architecture/reference-artifacts.md#domain-file-extraction-heuristics
#
safety:
  tool_policy:
  ...
  file_policy:
    write_scope:                   # Paths where writing is allowed
      - ".octon/output/{{category}}/**"     # Deliverables (final destination)
      - ".octon/capabilities/runtime/skills/_ops/state/runs/**"      # Execution state (session recovery)
      - ".octon/capabilities/runtime/skills/_ops/state/logs/**"      # Logs (always allowed)
...
| Tier        | Path                                      | Purpose              |
|-------------|-------------------------------------------|----------------------|
| **Tier 1**  | `.octon/output/{{category}}/**`              | Deliverables         |
| **Tier 1**  | `.octon/capabilities/runtime/skills/_ops/state/runs/{{skill-id}}/**`  | Execution state (session recovery) |
| **Tier 1**  | `.octon/capabilities/runtime/skills/_ops/state/logs/**`               | Execution logs       |
