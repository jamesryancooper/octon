...
2. **Record results:**
   ...
   - `.octon/orchestration/runtime/workflows/example.md` (1 match)
...
4. **Consolidate and deduplicate:**
   ...
   |------|-------------|----------------|
   | `.octon/START.md` | 4 | `old-name`, `/old-name/` |
   | `.octon/orchestration/runtime/workflows/example.md` | 1 | `old-name` |
...
1. **Create prioritized manifest:**
   ...
   **Total changes:** 47
   ...
   - [ ] Rename `.octon/ideation/.scratch/` → `.octon/ideation/scratchpad/`

   ### Phase 2: Config Files
   - [ ] `package.json` (1 change)

   ### Phase 3: Documentation & Code
   - [ ] `.octon/START.md` (4 changes)
   - [ ] `.octon/orchestration/runtime/workflows/example.md` (3 changes)
...
1. **Execute physical changes first:**
   ...
   ```bash
   mv .octon/ideation/.scratch .octon/ideation/scratchpad
   ```
...
4. **Execute continuity artifacts (APPEND ONLY):**
   ...
   **Completed:**
   - Renamed `.octon/ideation/.scratch/` to `.octon/ideation/scratchpad/`
...
2. **Generate suggested commit message:**
   ...
   - Updated 47 references across 12 files
   - Renamed directory `.octon/ideation/.scratch/` → `.octon/ideation/scratchpad/`
