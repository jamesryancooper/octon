...
- `.octon/capabilities/runtime/skills/_ops/state/runs/refactor/**` — Execution state (session recovery)
- `.octon/capabilities/runtime/skills/_ops/state/logs/refactor/**` — Execution logs
