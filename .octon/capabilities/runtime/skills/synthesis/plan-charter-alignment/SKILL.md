...
```text
/plan-charter-alignment charter_path=".octon/CHARTER.md" findings_source=".octon/output/reports/analysis/2026-03-05-charter-audit-2026-03-05-octon-root-charter.md"
```

With explicit scoring target:

```text
/plan-charter-alignment charter_path=".octon/CHARTER.md" findings_source="report.md" target_score="98"
```
...
- `.octon/output/plans/YYYY-MM-DD-charter-alignment-plan-<run-id>.md`
