  ...
  phases:
    - name: "Context Analysis"
      steps:
        ...
        - "Load project constraints from .octon/cognition/runtime/context/constraints.md"
    ...
    - name: "Output"
      steps:
        ...
        - "Save to .octon/scaffolding/practices/prompts/{{timestamp}}-refined.md"
...
3. **Load constraints**
   - Read `.octon/cognition/runtime/context/constraints.md` if present
...
2. **Save artifacts**
   - Write to `.octon/scaffolding/practices/prompts/{{timestamp}}-refined.md`
