...
examples:
  - input: "_ops/state/resources/synthesize-research/projects/auth-patterns/"
    ...
    output: ".octon/output/drafts/auth-patterns-synthesis.md"
  ...
  - input: "_ops/state/resources/synthesize-research/api-design/"
    ...
    output: ".octon/output/drafts/api-design-synthesis.md"
...
**Path:** `.octon/output/drafts/auth-patterns-synthesis.md`
...
**Path:** `.octon/output/drafts/api-design-synthesis.md`
...
**Path:** `.octon/output/drafts/quick-notes-synthesis.md`
