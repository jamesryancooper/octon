...
checkpoints:
  strategy: phase
  storage: ".octon/capabilities/runtime/skills/_ops/state/runs/spec-to-implementation/{{run-id}}/"
  retention: session
...
- State is stored in `.octon/capabilities/runtime/skills/_ops/state/runs/spec-to-implementation/{{run-id}}/`.
