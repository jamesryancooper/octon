...
decisions:
  - id: baseline-selection
    ...
    question: "Which baseline should this run use for contract intent and API design expectations?"
    branches:
      - condition: "contract_baseline_ref and/or api_design_baseline_ref exists and is readable"
        label: explicit_baseline
        next_phase: "Use referenced baselines for expected API-contract checks"
  ...
  - id: scope-discovery-strategy
    point: "Phase 1: Configure"
    question: "How are in-scope API-contract surfaces discovered?"
    branches:
...
default_path:
  [
    "Configure",
    "Contract Definition and Specification Coverage",
    "Implementation and Compatibility Conformance",
    "Versioning, Deprecation, and Evidence Readiness",
    "Self-Challenge",
    "Report",
  ]
---
...
- Prefer explicit contract and API-design baselines when available.
