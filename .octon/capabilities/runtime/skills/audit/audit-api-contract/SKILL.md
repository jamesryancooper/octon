...
```text
/audit-api-contract scope=".octon/capabilities/runtime/services/interfaces"
```

With explicit baseline references:

```text
/audit-api-contract scope=".octon" contract_baseline_ref=".octon/cognition/governance/principles/contract-first.md" api_design_baseline_ref=".octon/scaffolding/governance/patterns/api-design-guidelines.md"
```

With stricter threshold:

```text
/audit-api-contract scope=".octon/capabilities/runtime/services/interfaces" severity_threshold="high"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-api-contract-audit-<run-id>.md` -- Structured findings report
