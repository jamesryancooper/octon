...
```text
/audit-release-readiness scope=".octon" release_baseline_ref=".octon/cognition/practices/methodology/ci-cd-quality-gates.md" operations_baseline_ref=".octon/engine/practices/incident-operations.md"
```

With stricter threshold:

```text
/audit-release-readiness scope=".octon/capabilities/runtime/services" severity_threshold="high"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-audit-release-readiness-<run-id>.md` -- Structured findings report
