...
allowed-tools: Read Glob Grep Bash(gh *) Bash(bash .octon/agency/_ops/scripts/ci/audit-ci-latency.sh *) Write(../../../output/reports/*) Write(_ops/state/logs/*)
---
...
- `.octon/output/reports/YYYY-MM-DD-ci-latency-audit-<run-id>.md`
- `.octon/output/reports/YYYY-MM-DD-ci-latency-audit-<run-id>.json`
