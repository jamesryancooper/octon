...
checkpoints:
  strategy: phase
  storage: ".octon/capabilities/runtime/skills/_ops/state/runs/audit-migration/{{run-id}}/"
  retention: session
...
- Checkpoints are written under `.octon/capabilities/runtime/skills/_ops/state/runs/audit-migration/{{run-id}}/`.
