...
|-------|---------------------|---------|
| Direct old→new name references | Grep Sweep | `.workspace/context/` instead of `.octon/cognition/runtime/context/` |
...
migration:
  ...
  mappings:
    ...
    - old: "behaviors.md"
      new: "phases.md"
  exclusions: []
  scope: ".octon/capabilities/runtime/skills/"
```

### Invocation with Structure Diff

```
/audit-migration manifest="..." structure_spec=".octon/capabilities/_meta/architecture/README.md"
```
