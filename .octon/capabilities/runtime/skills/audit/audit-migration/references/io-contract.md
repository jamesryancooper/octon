...
| `file_filter` | text | No | — | Glob pattern to narrow scope within `scope` directory (e.g., ".octon/cognition/_meta/architecture/**") |
...
Written to `.octon/output/reports/analysis/YYYY-MM-DD-migration-audit.md`.
...
Written to `.octon/output/reports/analysis/YYYY-MM-DD-migration-audit-{partition}.md`.

The report header includes additional metadata:

```markdown
**Partition:** docs-architecture
**File Filter:** .octon/cognition/_meta/architecture/**
**Partition Mode:** Yes
...
Written to `.octon/capabilities/runtime/skills/_ops/state/logs/audit-migration/{{run_id}}-{partition}.md`.

### Execution Log

Written to `.octon/capabilities/runtime/skills/_ops/state/logs/audit-migration/{{run_id}}.md`.
...
## Output
- Report: .octon/output/reports/analysis/2026-02-08-migration-audit.md
```

### Log Index

Written to `.octon/capabilities/runtime/skills/_ops/state/logs/audit-migration/index.yml`:
...
/audit-migration manifest="..." structure_spec=".octon/cognition/_meta/architecture/README.md"

# Enable template smoke test layer
/audit-migration manifest="..." template_dir=".octon/scaffolding/runtime/templates/"
```

### With Partition (for parallel orchestration)

```text
# Audit only .octon/cognition/_meta/architecture/ files
/audit-migration manifest="..." partition="docs-architecture" file_filter=".octon/cognition/_meta/architecture/**"

# Audit only agency files
/audit-migration manifest="..." partition="agency-files" file_filter=".octon/agency/**"
