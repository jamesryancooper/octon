...
1. **Apply file filter:**
   ...
   2. Apply file_filter glob pattern (e.g., ".octon/cognition/_meta/architecture/**")
...
3. **Resolve each path relative to its containing file:**
   ...
   For a reference in `.octon/START.md`:
   - `cognition/runtime/context/decisions.md` → `.octon/cognition/runtime/context/decisions.md`
   - `../.octon/cognition/_meta/architecture/` → `.octon/cognition/_meta/architecture/`
...
6. **Write report:**
   ...
   Output to `.octon/output/reports/analysis/YYYY-MM-DD-migration-audit.md`:
...
7. **Write execution log:**
   ...
   **Principles enforced:** 7/7
   ...
   ## Report Location
   - .octon/output/reports/analysis/YYYY-MM-DD-migration-audit.md
   ```
