...
> **Authoritative Source:** Parameter definitions and output paths live in `.octon/capabilities/runtime/skills/registry.yml`.
...
- `.octon/output/reports/analysis/YYYY-MM-DD-ui-audit.md`
...
- `.octon/capabilities/runtime/skills/_ops/state/logs/audit-ui/{run_id}.md`
- `.octon/capabilities/runtime/skills/_ops/state/logs/audit-ui/index.yml`
