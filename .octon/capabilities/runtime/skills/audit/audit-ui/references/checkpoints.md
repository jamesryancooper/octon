...
checkpoints:
  strategy: phase
  storage: ".octon/capabilities/runtime/skills/_ops/state/runs/audit-ui/{{run-id}}/"
  retention: session
...
- Checkpoints are stored in `.octon/capabilities/runtime/skills/_ops/state/runs/audit-ui/{{run-id}}/`.
