...
```text
/audit-subsystem-health subsystem=".octon/capabilities/runtime/skills" docs=".octon/cognition/_meta/architecture"
```

### Phase 1: Configure

```
Subsystem: .octon/capabilities/runtime/skills
Schema reference: .octon/capabilities/runtime/skills/capabilities.yml (auto-detected)
Companion docs: .octon/cognition/_meta/architecture (19 files)
...
MEDIUM: Doc drift — .octon/capabilities/_meta/architecture/architecture.md describes "flat directory layout" but skills use group-based nesting
...
```
Report written to: .octon/output/reports/analysis/2026-02-10-subsystem-health-audit.md
...
```text
/audit-subsystem-health subsystem=".octon/capabilities/runtime/skills"
```
