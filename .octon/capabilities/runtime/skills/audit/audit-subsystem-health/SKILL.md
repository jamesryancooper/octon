...
```text
/audit-subsystem-health subsystem=".octon/capabilities/runtime/skills" schema_ref="capabilities.yml"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-subsystem-health-audit.md` -- Human-readable findings report
