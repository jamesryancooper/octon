...
```text
/audit-security-compliance scope=".octon/capabilities/runtime/services" policy_baseline_ref=".octon/assurance/practices/standards/security-and-privacy.md" control_baseline_ref=".octon/cognition/practices/methodology/security-baseline.md"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-security-compliance-audit-<run-id>.md` -- Structured findings report
