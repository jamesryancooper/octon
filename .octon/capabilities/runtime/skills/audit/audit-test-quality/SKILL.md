...
```text
/audit-test-quality scope=".octon" testing_baseline_ref=".octon/assurance/practices/standards/testing-strategy.md" quality_gate_baseline_ref=".octon/cognition/practices/methodology/ci-cd-quality-gates.md"
```

With stricter threshold:

```text
/audit-test-quality scope=".octon/capabilities/runtime/services" severity_threshold="high"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-test-quality-audit-<run-id>.md` -- Structured findings report
