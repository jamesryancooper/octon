...
Parameters are defined in `.octon/capabilities/runtime/skills/registry.yml`
...
Output paths are defined in `.octon/capabilities/runtime/skills/registry.yml`
(single source of truth).

Outputs are written to:

- `.octon/output/reports/YYYY-MM-DD-surface-architecture-audit-<run-id>.md`
