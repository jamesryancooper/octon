...
```text
/audit-data-governance scope=".octon" classification_baseline_ref=".octon/assurance/practices/standards/data-handling-and-retention.md" privacy_baseline_ref=".octon/assurance/practices/standards/security-and-privacy.md"
```

With stricter threshold:

```text
/audit-data-governance scope=".octon/capabilities/runtime/services" severity_threshold="high"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-data-governance-audit-<run-id>.md` -- Structured findings report
