...
description: >
  Bounded architecture-readiness audit for Octon whole-harness and
...
Bounded architecture-readiness audit for Octon control-plane and
...
- You need an implementation-readiness verdict for `/.octon/`
...
```text
/audit-architecture-readiness target_path=".octon/capabilities" severity_threshold="high"
```

With strict post-remediation gate:

```text
/audit-architecture-readiness target_path=".octon" post_remediation=true convergence_k="3"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-architecture-readiness-audit-<run-id>.md`
- `.octon/output/reports/analysis/YYYY-MM-DD-architecture-readiness-audit-<run-id>.json`
- `.octon/output/reports/audits/YYYY-MM-DD-<run-id>/`
