...
```text
/audit-domain-architecture domain_path=".octon/capabilities/runtime" criteria="modularity,discoverability,coupling,change-safety,testability"
```
...
```text
/audit-domain-architecture domain_path=".octon/orchestration" evidence_depth="deep" severity_threshold="medium"
```
...
```text
/audit-domain-architecture domain_path=".octon/cognition" criteria="octon-policy-compliance"
```
