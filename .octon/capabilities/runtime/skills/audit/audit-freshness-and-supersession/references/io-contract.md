...
- `.octon/output/reports/analysis/YYYY-MM-DD-freshness-and-supersession-audit.md`
...
- `.octon/capabilities/runtime/skills/_ops/state/logs/audit-freshness-and-supersession/{{run_id}}.md`
- `.octon/capabilities/runtime/skills/_ops/state/logs/audit-freshness-and-supersession/index.yml`
