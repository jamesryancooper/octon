...
```text
/audit-operational-readiness scope=".octon" operations_baseline_ref=".octon/cognition/practices/methodology/reliability-and-ops.md" incident_baseline_ref=".octon/engine/practices/incident-operations.md"
```

With stricter threshold:

```text
/audit-operational-readiness scope=".octon/capabilities/runtime/services" severity_threshold="high"
```
...
- `.octon/output/reports/analysis/YYYY-MM-DD-operational-readiness-audit-<run-id>.md` -- Structured findings report
