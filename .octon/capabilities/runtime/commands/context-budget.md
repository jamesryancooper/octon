...
/context-budget --limit <int> --used <int> --report .octon/output/reports/analysis/<date>-context-budget.md
```
...
- **Service:** `.octon/capabilities/runtime/services/interfaces/agent-platform/`
