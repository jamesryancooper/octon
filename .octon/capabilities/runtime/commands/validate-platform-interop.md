...
```bash
bash .octon/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh [--mode <mode>]
```
...
- **Validator:** `.octon/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh`
- **Allowlist:** `.octon/capabilities/runtime/services/_ops/state/provider-term-allowlist.tsv`
