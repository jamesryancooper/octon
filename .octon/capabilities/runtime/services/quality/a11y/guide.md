# A11y — Accessibility Checks (WCAG)
...
- **Octon alignment:** Advances Evidence‑First and Safe‑by‑Default by standardizing a11y contracts and emitting governance‑ready artifacts.
- **Integrates with:** Test (drives UI flows), Patch (PR checks/summaries), UI (surfaces issues).
...
- **Implementation Choices (opinionated):**
  ...
  - @axe-core/playwright: runs axe within Playwright-driven UI flows provided by Test.
