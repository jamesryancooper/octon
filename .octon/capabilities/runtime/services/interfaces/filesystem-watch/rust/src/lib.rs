...
const DEFAULT_STATE_DIR: &str = ".octon/engine/_ops/state/watch";
...
fn should_skip(path: &str, state_dir: &str) -> bool {
    ...
    const PREFIXES: [&str; 5] = [
        ".git",
        ".octon/engine/_ops/state/traces",
        ".octon/engine/_ops/state/build",
        ".octon/engine/_ops/state/snapshots",
        ".octon/engine/_ops/state/watch",
    ];
