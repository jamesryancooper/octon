...
SNAPSHOT_ROOT=".octon/capabilities/runtime/services/interfaces"
TARGET_NODE="file:.octon/capabilities/runtime/services/interfaces/filesystem-snapshot/SERVICE.md"
TARGET_DIR_NODE="dir:.octon/capabilities/runtime/services/interfaces/filesystem-snapshot"
HAS_RG=false
...
BUILD_OUT="$(run_op snapshot.build '{"root":".octon/capabilities/runtime/services/interfaces","state_dir":".octon/engine/_ops/state/snapshots","set_current":true}')"
...
assert_contains "$GET_NODE_OUT" '"node_id"[[:space:]]*:[[:space:]]*"file:.octon/capabilities/runtime/services/interfaces/filesystem-snapshot/SERVICE.md"' "kg.get-node missing expected node"
...
LOCKED_OUT="$(run_op snapshot.build '{"root":".octon/capabilities/runtime/services/interfaces","state_dir":".octon/engine/_ops/state/snapshots","set_current":false}')"
...
CLEANUP_OUT="$(run_op snapshot.build '{"root":".octon/capabilities/runtime/services/interfaces","state_dir":".octon/engine/_ops/state/snapshots","set_current":false}')"
...
LIMIT_OUT="$(run_op snapshot.build '{"root":".octon/capabilities/runtime/services/interfaces","state_dir":".octon/engine/_ops/state/snapshots","set_current":false,"max_files":1}')"
...
WATCH_OUT="$(run_op watch.poll '{"root":".octon/capabilities/runtime/services/interfaces","state_key":"filesystem-watch:integration","max_events":30,"max_files":100000}')"
