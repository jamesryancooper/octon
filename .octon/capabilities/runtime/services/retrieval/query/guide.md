...
- **Purpose:** Answer questions by routing across dense/keyword/graph stores, fusing/reranking results, and citing sources per Octon contracts.
...
- **Octon alignment:** advances interoperability and grounded outputs via consistent answer/evidence contracts and citations; exposes governance hooks so answers are evaluable by Eval.
