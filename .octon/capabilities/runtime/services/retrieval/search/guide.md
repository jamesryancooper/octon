...
- **Purpose:** Harvest external web/API sources into clean, LLM‑ready artifacts with provenance, advancing Octon’s interoperable, governed knowledge flows.
...
- **Octon alignment:** Ensures interoperability and provenance via consistent, reproducible snapshots with citations; exposes hooks so downstream gates can verify evidence.
