...
- **Octon default:** **Trunk-Based Development** with short-lived branches; open PRs against trunk with **Vercel Preview** links; status checks gate merges; rollbacks promote a known-good preview.
