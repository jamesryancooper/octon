...
- **Purpose:** Codifies repo/delivery policies (licenses, versions, paths, CODEOWNERS) and enforces AI-run gates aligned to Octon.
...
- **Octon alignment:** advances governance and safety gates via consistent policy contracts consumed by orchestration services; enforces ASVS/SSDF-aligned guardrails early.
...
- **Octon default:** Encode **ASVS v5** controls, **NIST SSDF** activities, branch protection, **CODEOWNERS**, and path policies that reflect hexagonal boundaries.
