...
This invokes the `create-skill` skill defined in `.octon/capabilities/runtime/skills/meta/create-skill/`.
...
| **Copy Template** | Copy `_scaffold/template/` to `.octon/capabilities/runtime/skills/<group>/<skill-name>/` |
...
Add the skill to `.octon/capabilities/runtime/skills/manifest.yml` for Tier 1 discovery:
...
Add extended metadata to `.octon/capabilities/runtime/skills/registry.yml`:
...
If the skill needs harness-specific I/O paths, add them to `.octon/capabilities/runtime/skills/registry.yml`:
...
# Or manually
ln -s ../../.octon/capabilities/runtime/skills/audit/your-skill-name .claude/skills/your-skill-name
ln -s ../../.octon/capabilities/runtime/skills/audit/your-skill-name .cursor/skills/your-skill-name
ln -s ../../.octon/capabilities/runtime/skills/audit/your-skill-name .codex/skills/your-skill-name
```
