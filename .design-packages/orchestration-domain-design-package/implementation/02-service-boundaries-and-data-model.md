...
| Launching Component -> Coordination Manager | lock acquisition request | sync | `normative/execution/concurrency-control-model.md`, `contracts/coordination-lock-contract.md` | lock schema and outcomes |
...
| Incident Manager -> Approval Resolver | approval + authority lookup | sync | `normative/governance/approval-and-override-contract.md`, `normative/governance/approver-authority-model.md` | approval and authority fields |
