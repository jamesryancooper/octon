...
**Scope**
This charter defines Harmony’s quality priorities and the rules Harmony uses to make trade-offs. It applies to Harmony’s subsystems (`agency/`, `capabilities/`, `orchestration/`, `cognition/`, `continuity/`, `quality/`, `runtime/`, `scaffolding/`, `output/`, `ideation/`) and to any repo adopting Harmony.
...
**Harmony is led by active quality weights and measurable scores:**
