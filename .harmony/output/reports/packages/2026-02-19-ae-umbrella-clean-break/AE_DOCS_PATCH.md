...
2. `.harmony/assurance/README.md`
3. `.harmony/assurance/DOCTRINE.md`
4. `.harmony/README.md` (Assurance Engine section)
5. `.harmony/assurance/standards/weights/weights.md`
6. `.harmony/assurance/complete.md`
7. `.harmony/assurance/session-exit.md`
...
- optional: add `.harmony/assurance/CHANGELOG.md` if a standalone changelog is adopted
...
## Downstream Migration Notes (`.harmony/` Consumers)

1. Pull updated `.harmony/assurance/` files and AE runtime crate changes.
