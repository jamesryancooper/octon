...
Audited all files under `.harmony/capabilities/skills/` across 14 dimensions from the audit plan.

Execution highlights:

- Ran baseline validator: `bash .harmony/capabilities/skills/scripts/validate-skills.sh` (exit `0`, "All checks passed")
...
- Affected files:
  - `.harmony/capabilities/skills/foundations/python-api/contract-first-api/SKILL.md`
  - `.harmony/capabilities/skills/foundations/python-api/contributor-guide/SKILL.md`
  - `.harmony/capabilities/skills/foundations/python-api/dev-toolchain/SKILL.md`
  - `.harmony/capabilities/skills/foundations/python-api/infra-manifest/SKILL.md`
  - `.harmony/capabilities/skills/foundations/python-api/scaffold-package/SKILL.md`
  - `.harmony/capabilities/skills/foundations/python-api/test-harness/SKILL.md`
  - `.harmony/capabilities/skills/foundations/swift-macos-app/cli-interface/SKILL.md`
  - `.harmony/capabilities/skills/foundations/swift-macos-app/contributor-guide/SKILL.md`
  - `.harmony/capabilities/skills/foundations/swift-macos-app/daemon-service/SKILL.md`
  - `.harmony/capabilities/skills/foundations/swift-macos-app/data-layer/SKILL.md`
  - `.harmony/capabilities/skills/foundations/swift-macos-app/scaffold-package/SKILL.md`
...
- Affected files:
  - `.harmony/capabilities/skills/registry.yml:654`
  - `.harmony/capabilities/skills/registry.yml:655`
  - `.harmony/capabilities/skills/registry.yml:656`
  - `.harmony/capabilities/skills/registry.yml:657`
  - `.harmony/capabilities/skills/registry.yml:908`
  - `.harmony/capabilities/skills/registry.yml:909`
  - `.harmony/capabilities/skills/registry.yml:910`
  - `.harmony/capabilities/skills/registry.yml:911`
- Remediation:
...
- Affected paths:
  - `.harmony/capabilities/skills/runs/research-synthesizer/`
  - `.harmony/capabilities/skills/configs/research-synthesizer/`
- Remediation:
...
- Affected files:
  - `.harmony/capabilities/skills/logs/FORMAT.md:33`
  - `.harmony/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness.md:1`
  - `.harmony/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness-rerun.md:1`
- Remediation:
...
- Affected files:
  - `.harmony/capabilities/skills/README.md:47`
  - `.harmony/capabilities/skills/README.md:48`
  - `.harmony/capabilities/skills/README.md:150`
  - `.harmony/capabilities/skills/README.md:151`
  - `.harmony/capabilities/skills/README.md:152`
- Remediation:
...
- Affected files:
  - `.harmony/capabilities/skills/foundations/python-api/SKILL.md:43`
  - `.harmony/capabilities/skills/foundations/swift-macos-app/SKILL.md:46`
- Notes:
...
1. Update `.harmony/capabilities/skills/README.md` to current architecture and schema terms.
