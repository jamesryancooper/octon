...
**X1. `.harmony/README.md:128` — Broken workflow path** [MEDIUM]

| Field | Value |
|-------|-------|
| File | `.harmony/README.md` |
| Line | 128 |
| Reference | `.harmony/orchestration/workflows/refactor/00-overview.md` |
| Correct path | `.harmony/orchestration/workflows/refactor(x)/00-overview.md` |
| Severity | MEDIUM |
...
**`.harmony/README.md:128`** — Update path from `refactor/00-overview.md` to `refactor(x)/00-overview.md`.
...
| `.harmony/output/reports/` | Historical output | 3 |
| `.harmony/capabilities/skills/archive/` | Archived content | 10+ |
