...
- `.harmony/orchestration/workflows/meta/create-skill(x)/**`
...
Evidence:
- `.harmony/capabilities/skills/README.md:5`
- `.harmony/capabilities/skills/README.md:74`
- `.harmony/capabilities/skills/README.md:107`
- `.harmony/capabilities/skills/README.md:240`
- `.harmony/capabilities/skills/README.md:455`
- `.harmony/capabilities/skills/_state/logs/FORMAT.md:335`
- `.harmony/capabilities/skills/_state/logs/FORMAT.md:336`
- `.harmony/capabilities/skills/_state/logs/FORMAT.md:337`
- `.harmony/capabilities/skills/synthesis/refine-prompt/references/errors.md:206`
- `.harmony/capabilities/skills/synthesis/synthesize-research/references/errors.md:251`
...
Evidence:
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:13`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:130`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:141`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:172`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:236`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:310`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:338`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:393`
- `.harmony/capabilities/skills/meta/create-skill/references/phases.md:249`
- `.harmony/capabilities/skills/_template/references/checkpoints.md:238`
- `.harmony/orchestration/workflows/meta/create-skill(x)/02-copy-template.md:23`
- `.harmony/orchestration/workflows/meta/create-skill(x)/03-initialize-skill.md:30`
- `.harmony/orchestration/workflows/meta/create-skill(x)/06-report-success.md:29`

Observed drift:
- Uses flat skill path examples (`.harmony/capabilities/skills/{{skill_name}}/`) instead of grouped paths.
...
Evidence:
- Validator overlap notes count: 81 pair overlaps from `.harmony/output/reports/.tmp/validate.normal.out`.
...
Evidence:
- Specified pattern: `.harmony/capabilities/skills/_state/logs/{{skill_id}}/{{timestamp}}-{{skill_id}}.md` at `.harmony/capabilities/skills/_state/logs/FORMAT.md:20`
- Specified timestamp format: `.harmony/capabilities/skills/_state/logs/FORMAT.md:23`
- Observed files:
  - `.harmony/capabilities/skills/_state/logs/audit-migration/2026-02-08-workspace-to-harness.md`
  - `.harmony/capabilities/skills/_state/logs/audit-migration/2026-02-08-workspace-to-harness-rerun.md`
