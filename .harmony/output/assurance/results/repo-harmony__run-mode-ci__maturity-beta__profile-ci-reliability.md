...
| `capabilities` | `operability` | `productivity` | 2 | 5 | 3 | 5 | 2 | 10 | .harmony/cognition/methodology/reliability-and-ops.md, .harmony/cognition/_meta/architecture/runtime-policy.md | Raise 'operability' from 3 to target 5. |
| `cognition` | `operability` | `productivity` | 2 | 5 | 3 | 5 | 2 | 10 | .harmony/cognition/methodology/reliability-and-ops.md, .harmony/cognition/_meta/architecture/runtime-policy.md | Raise 'operability' from 3 to target 5. |
