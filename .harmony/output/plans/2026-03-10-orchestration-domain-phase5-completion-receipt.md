...
- added deterministic schedule evaluation:
  - `.harmony/orchestration/runtime/_ops/scripts/evaluate-automation-schedule.py`
- added scheduled launch handling:
  - `.harmony/orchestration/runtime/_ops/scripts/launch-scheduled-automation-run.sh`
- validated DST spring-forward and fall-back behavior against the package
  scheduling scenarios

### Admission And Policy Enforcement

- strengthened `.harmony/orchestration/runtime/_ops/scripts/launch-automation-run.sh`
...
- added `.harmony/orchestration/runtime/_ops/tests/test-automation-policy-and-scheduling.sh`
...
- `bash -n .harmony/orchestration/runtime/_ops/scripts/launch-automation-run.sh`
- `bash -n .harmony/orchestration/runtime/_ops/scripts/launch-scheduled-automation-run.sh`
- `bash -n .harmony/orchestration/runtime/_ops/tests/test-automation-policy-and-scheduling.sh`
...
- `bash .harmony/orchestration/runtime/_ops/tests/test-first-end-to-end-slice.sh`
