...
- added continuity-owned approval artifact location guidance:
  - `.harmony/continuity/decisions/approvals/README.md`
- added runtime approval verification:
  - `.harmony/orchestration/runtime/_ops/scripts/verify-approval-artifact.sh`
...
- added the live runtime incidents surface:
  - `.harmony/orchestration/runtime/incidents/README.md`
  - `.harmony/orchestration/runtime/incidents/index.yml`
- added runtime incident lifecycle operations:
  - `.harmony/orchestration/runtime/_ops/scripts/manage-incident.sh`
- strengthened incident validation:
  - `.harmony/orchestration/runtime/incidents/_ops/scripts/validate-incidents.sh`
...
- `bash -n .harmony/orchestration/runtime/_ops/scripts/verify-approval-artifact.sh`
- `bash -n .harmony/orchestration/runtime/_ops/scripts/manage-incident.sh`
- `bash -n .harmony/orchestration/runtime/_ops/tests/test-incident-approval-control.sh`
- `bash .harmony/orchestration/runtime/incidents/_ops/scripts/validate-incidents.sh`
- `bash .harmony/orchestration/runtime/_ops/tests/test-incident-approval-control.sh`
