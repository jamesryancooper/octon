...
description: Canonical doctrine for bounded architecture analysis of one durable Harmony surface or surface unit.
...
Define the canonical bounded-audit rule set for evaluating one durable Harmony
...
- Use `audit-domain-architecture` for external critique of a whole Harmony
