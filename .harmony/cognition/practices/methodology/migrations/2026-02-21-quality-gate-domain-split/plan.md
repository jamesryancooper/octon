...
- New components or files:
  ...
  - Migration plan folder:
    - `/.harmony/cognition/practices/methodology/migrations/2026-02-21-quality-gate-domain-split/`
  - Decision record:
...
- `/.harmony/output/reports/2026-02-21-quality-gate-domain-split-migration-evidence.md`
- `/.harmony/cognition/runtime/decisions/029-quality-gate-domain-split-clean-break-migration.md`
