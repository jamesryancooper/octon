...
description: Scoring dimensions, hard gates, failure modes, and remediation expectations for Harmony architecture-readiness audits.
...
- `whole-harness` runs evaluate the full Harmony control plane and may include
