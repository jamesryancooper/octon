...
- New components or files:
  ...
  - `/.harmony/cognition/decisions/023-capabilities-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
...
- `/.harmony/output/reports/2026-02-20-capabilities-bounded-surfaces-migration-evidence.md`
- `/.harmony/cognition/decisions/023-capabilities-bounded-surfaces-clean-break-migration.md`
