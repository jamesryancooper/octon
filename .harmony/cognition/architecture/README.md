...
- `.harmony/agency/architecture/README.md`
...
See [workflows.md](/.harmony/orchestration/architecture/workflows.md) for the full implementation pattern.
...
- [Harness Workflows](/.harmony/orchestration/architecture/workflows.md) --- Multi-step procedures and the Universal Harness-Agnostic Pattern
- [Harness Commands](/.harmony/capabilities/architecture/commands.md) --- Harness-scoped atomic operations
- [Agency](/.harmony/agency/architecture/README.md) --- Canonical actor taxonomy, contracts, and architecture
- [Missions](/.harmony/orchestration/architecture/missions.md) --- Time-bounded sub-projects
- [Skills](/.harmony/capabilities/architecture/README.md) --- Composable capabilities with defined I/O

### Directory Documentation

- [Scratchpad](/.harmony/ideation/architecture/scratchpad.md) --- Human-led thinking space and idea funnel
- [Projects](/.harmony/ideation/architecture/projects.md) --- Human-led explorations that produce harness artifacts
- [Prompts](/.harmony/scaffolding/architecture/prompts.md) --- Reusable task templates
- [Templates](/.harmony/scaffolding/architecture/templates.md) --- Boilerplate for new content
- [Examples](/.harmony/scaffolding/architecture/examples.md) --- Reference patterns
- [Progress](/.harmony/continuity/architecture/progress.md) --- Session continuity tracking
- [Context](./context.md) --- Background knowledge
- [Checklists](/.harmony/quality/architecture/checklists.md) --- Quality gates
- [Scripts](/.harmony/scaffolding/architecture/scripts.md) --- Shell utilities for harness maintenance
