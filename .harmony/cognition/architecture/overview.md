...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [repository blueprint](./repository-blueprint.md), [monorepo layout](./monorepo-layout.md), [governance model](./governance-model.md), [runtime policy](/docs/architecture/runtime-policy.md), [observability requirements](./observability-requirements.md), [knowledge plane](./knowledge-plane/knowledge-plane.md), [kaizen subsystem](./kaizen-subsystem.md), [tooling integration](./tooling-integration.md), [agent roles](./agent-roles.md), [MAPE-K modeling](./mape-k-loop-modeling.md), [containerization profile](/docs/architecture/containerization-profile.md), [self-contained modules and repos](/docs/architecture/self-contained-repos.md)
