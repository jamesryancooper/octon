...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [agent roles](./agent-roles.md), [kaizen subsystem](./kaizen-subsystem.md), [knowledge plane](./knowledge-plane.md), [contracts registry](./contracts-registry.md), [python runtime workspace](./python-runtime-workspace.md)
