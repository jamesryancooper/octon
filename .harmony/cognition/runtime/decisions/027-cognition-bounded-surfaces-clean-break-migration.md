...
- `/.harmony/cognition/runtime/` for runtime cognition artifacts
- `/.harmony/cognition/governance/` for normative cognition contracts
- `/.harmony/cognition/practices/` for operating methodology
- `/.harmony/cognition/_ops/` for mutable cognition operational scripts/state
- `/.harmony/cognition/_meta/` for non-structural architecture/reference documentation
