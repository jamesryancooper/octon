...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [MAPE-K modeling](./mape-k-loop-modeling.md), [kaizen subsystem](./kaizen-subsystem.md), [governance model](./governance-model.md), [knowledge plane](../../runtime/knowledge-plane/knowledge-plane.md), [contracts registry](./contracts-registry.md), [python runtime workspace example](/.harmony/scaffolding/practices/examples/stack-profiles/python-runtime-workspace.md), [execution service roles](../../../capabilities/runtime/services/execution/service-roles.md)
