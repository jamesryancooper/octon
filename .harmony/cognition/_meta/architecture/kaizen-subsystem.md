...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [overview](./overview.md), [tooling integration](./tooling-integration.md), [governance model](./governance-model.md), [knowledge plane](../../runtime/knowledge-plane/knowledge-plane.md), [contracts registry](./contracts-registry.md)
