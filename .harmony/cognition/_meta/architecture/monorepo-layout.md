...
See also `.harmony/capabilities/runtime/services/execution/service-roles.md` for how PlanKit, AgentKit, FlowKit, and the LangGraph runtime map onto these physical locations.
