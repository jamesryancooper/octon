...
|------|---------------|------------------|----------|
| `.harmony/workflows/_template/` | 00-overview.md, 01-step.md, NN-verify.md, README.md | Scaffolding template | Draft |
| `.harmony/workflows/workspace/create-workspace/` | 00-overview.md + 6 step files | Scaffold new .workspace directory | Draft/Functional |
| `.harmony/workflows/workspace/update-workspace/` | 00-overview.md + 5 step files | Align workspace with canonical definition | Draft/Functional |
| `.harmony/workflows/workspace/evaluate-workspace/` | 00-overview.md + 3 step files | Assess token efficiency | Draft/Functional |
| `.harmony/workflows/workspace/migrate-workspace/` | 00-overview.md + 4 step files | Migrate workspace structure | Draft |
| `.harmony/workflows/workflows/create-workflow/` | 00-overview.md + 8 step files | Scaffold new workflow | Draft/Meta |
| `.harmony/workflows/workflows/update-workflow/` | 00-overview.md + 5 step files | Modify existing workflow | Draft/Meta |
| `.harmony/workflows/workflows/evaluate-workflow/` | 00-overview.md + 5 step files | Assess workflow quality | Draft/Meta |
| `.harmony/workflows/refactor/` | 00-overview.md + 6 step files | Execute verified codebase refactor | Draft/Functional |
| `.harmony/workflows/missions/create-mission/` | 00-overview.md | Scaffold new mission | Draft |
| `.harmony/workflows/missions/complete-mission/` | 00-overview.md | Archive completed mission | Draft |
| `.harmony/workflows/skills/create-skill/` | 00-overview.md + 6 step files | Scaffold new skill | Draft/Functional |
| `.harmony/workflows/promote-from-scratchpad.md` | Single file | Promote scratchpad content | Placeholder |
...
```yaml
# In .workspace/skills/registry.yml
skill_mappings:
  refactor-skill:
    outputs:
...
**Evidence:** Workflow frontmatter includes `checkpoints.storage: ".workspace/progress/checkpoints/"` - this pattern can be adopted by skills.
...
- Deprecate the workflows primitive (`.harmony/workflows/`)
...
1. **Create `refactor` skill** - Migrate `.harmony/workflows/refactor/` to `.harmony/skills/refactor/`
...
4. **Deprecate `.harmony/workflows/`** - Move templates to `.harmony/skills/_template/`
...
| `.harmony/skills/manifest.yml` | Update | Add new skills as they're migrated |
| `.harmony/skills/registry.yml` | Update | Add new skill metadata |
...
- `.harmony/skills/refine-prompt/SKILL.md` - Example multi-phase skill
- `.harmony/skills/refine-prompt/references/behaviors.md` - Detailed phase documentation
- `.harmony/workflows/refactor/` - Example workflow (candidate for migration)
...
|------------------|------------|-----------|
| `.harmony/workflows/refactor/` | `.harmony/skills/refactor/` | Single-session, clear phases |
| `.harmony/workflows/workspace/create-workspace/` | `.harmony/skills/create-workspace/` | Single-session scaffolding |
| `.harmony/workflows/workspace/update-workspace/` | `.harmony/skills/update-workspace/` | Single-session update |
| `.harmony/workflows/workspace/evaluate-workspace/` | `.harmony/skills/evaluate-workspace/` | Single-session analysis |
| `.harmony/workflows/skills/create-skill/` | `.harmony/skills/create-skill/` | Single-session scaffolding |
...
| Deprecate | Reason |
|-----------|--------|
| `.harmony/workflows/workflows/create-workflow/` | No longer creating workflows |
| `.harmony/workflows/workflows/update-workflow/` | No longer maintaining workflows |
| `.harmony/workflows/workflows/evaluate-workflow/` | No longer evaluating workflows |
| `.harmony/workflows/_template/` | Move to `.harmony/skills/_template/` |
...
|---------------|--------------|
| `.harmony/workflows/missions/` (draft) | `.harmony/missions/` (production) |
...
|-----------|---------|----------|
| **Skills** | Single-session composable capabilities | `.harmony/skills/` |
| **Missions** | Durable multi-session orchestration | `.harmony/missions/` |
| ~~Workflows~~ | **Deprecated** - consolidated into skills | ~~`.harmony/workflows/`~~ |
...
6. Deprecate `.harmony/workflows/` (except missions/)
