...
- Promotion evidence/receipt minimums: [RA/ACP Promotion Inputs Matrix](../../_meta/principles/ra-acp-promotion-inputs-matrix.md)
...
- `.harmony/cognition/governance/principles/autonomous-control-points.md`
- `.harmony/cognition/governance/principles/deny-by-default.md`
