...
- [x] Finalize `.harmony/cognition/governance/principles/principles.md` as production guidance (no draft status)
- [x] Reconcile `.harmony/cognition/governance/principles/README.md` as the canonical index
...
|---|---|---|
| Audit and gap reconciliation | `.harmony/cognition/governance/principles/README.md` (Audit Snapshot) | Completed |
| Production principles reference | `.harmony/cognition/governance/principles/principles.md` | Completed |
| Full principle index + pillar map | `.harmony/cognition/governance/principles/README.md` | Completed |
| Quality attributes cross-reference | `.harmony/cognition/governance/principles/README.md` | Completed |
| Methodology guarantee alignment check | `.harmony/cognition/governance/principles/README.md` | Completed |
| New core guides | `.harmony/cognition/governance/principles/*.md` (new files) | Completed |
| New agentic guides | `.harmony/cognition/governance/principles/*.md` (new files) | Completed |
...
- Every principle listed in `.harmony/cognition/governance/principles/principles.md` has a detailed guide in `.harmony/cognition/governance/principles/`.
