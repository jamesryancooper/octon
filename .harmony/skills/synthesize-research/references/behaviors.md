...
behavior:
  phases:
    ...
    - name: "Output"
      steps:
        - "Write synthesis to .workspace/drafts/{{topic}}-synthesis.md"
        - "Write run log to logs/runs/{{timestamp}}-synthesize-research.md"
  goals:
