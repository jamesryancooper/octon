...
`bash .harmony/assurance/runtime/_ops/scripts/validate-proposal-standard.sh --package "<target-package>"`

If the target proposal contains `design-proposal.yml`, this step must also run:

`bash .harmony/assurance/runtime/_ops/scripts/validate-design-proposal.sh --package "<target-package>"`
