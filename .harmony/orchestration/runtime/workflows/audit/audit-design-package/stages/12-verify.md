...
# Step 12: Verify Design Package Audit Completion

## Conditional Standard-Governed Package Gate

If the target package contains `design-package.yml`, this step must also run:

`bash .harmony/assurance/runtime/_ops/scripts/validate-design-package-standard.sh --package "<target-package>"`
