...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/audit/audit-architecture-readiness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/audit/audit-architecture-readiness/workflow.yml`.

## Parameters

- `target_path` (folder, required=true): Harmony target path to audit: either .harmony or one top-level bounded-surface domain
...
- [ ] Bounded-audit bundle exists at `.harmony/output/reports/audits/YYYY-MM-DD-<slug>/`
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/audit/audit-architecture-readiness/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/audit/audit-architecture-readiness/stages/`
