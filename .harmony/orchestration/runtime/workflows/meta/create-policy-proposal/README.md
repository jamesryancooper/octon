...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/meta/create-policy-proposal`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/meta/create-policy-proposal/workflow.yml`.
...
- `create_policy_proposal_workflow_summary` -> `../../../../../.harmony/output/reports/{{date}}-create-policy-proposal.md`: Top-level workflow summary with proposal identity, validator outcome, and next steps
- `create_policy_proposal_workflow_bundle` -> `../../../../../.harmony/output/reports/workflows/{{date}}-create-policy-proposal-{{proposal_id}}/`: Workflow execution bundle containing stage receipts, validation state, scaffold inventory, and validator evidence
- `create_policy_proposal_validator_log` -> `../../../../../.harmony/output/reports/workflows/{{date}}-create-policy-proposal-{{proposal_id}}/standard-validator.log`: Captured stdout and stderr from the proposal validator stack
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/meta/create-policy-proposal/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/meta/create-policy-proposal/stages/`
