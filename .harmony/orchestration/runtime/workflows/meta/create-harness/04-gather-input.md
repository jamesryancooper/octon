---
title: Gather Input
description: Collect user context for harness customization.
---
...
| "What must be verified before work is complete?" | `assurance/practices/complete.md` quality gates |
| "Any prerequisites to work here?" (deps, env vars) | `START.md` boot sequence |

## Idempotency

**Check:** Is user input already gathered?
- [ ] Checkpoint file exists: `checkpoints/create-harness/<target>/04-input.complete`
...
**Marker:** `checkpoints/create-harness/<target>/04-input.complete`
