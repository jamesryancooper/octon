...
- **Harmony alignment:** Advances Interoperability and Provenance with consistent metadata contracts and deterministic chunking; exposes Guard hooks and defers policy/eval gates downstream.
