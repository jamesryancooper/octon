...
Core execution behavior must run inside Harmony harness constraints without
requiring Python.
...
- `bash .harmony/capabilities/runtime/services/execution/_ops/scripts/validate-execution-fixtures.sh`
