...
rendering, and diagramming Harmony spec artifacts. It is implemented in-house
...
```bash
cat <<'JSON' | .harmony/capabilities/runtime/services/planning/spec/impl/spec.sh
{"command":"validate","targetPath":".harmony","dryRun":true}
JSON
```
