...
**Harmony-aligned.** MCP is an adapter on your hexagonal boundary. It exposes existing service operations as **tools** and large data as **resources** for agents (local or remote) without changing your core comms stack.
