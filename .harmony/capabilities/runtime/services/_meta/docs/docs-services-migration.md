...
- Target: `.harmony/capabilities/runtime/services`
...
- Full markdown content deleted from `docs/services/**` has been integrated under `.harmony/capabilities/runtime/services/**`.
- Canonical references were updated from `docs/services/...` to `.harmony/capabilities/runtime/services/...` in active harness docs.
