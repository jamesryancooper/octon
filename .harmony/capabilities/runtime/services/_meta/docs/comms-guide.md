...
**Harmony-aligned.** Monolith-first, hexagonal boundaries, deterministic services. Services communicate via **typed direct calls**, **artifacts/manifests**, and **events**. This guide is the contract for service-to-service comms.
