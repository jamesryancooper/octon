...
```bash
bash .harmony/engine/runtime/run tool interfaces/filesystem-discovery discover.start \
...
```bash
bash .harmony/engine/runtime/run tool interfaces/filesystem-discovery kg.neighbors \
