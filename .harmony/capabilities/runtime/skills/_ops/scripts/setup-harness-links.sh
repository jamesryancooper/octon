...
# Creates symlinks from harness skill folders to skills in .harmony/capabilities/runtime/skills/
#
...
create_skill_link() {
    ...
    local target="../../.harmony/capabilities/runtime/skills/$skill_path"
