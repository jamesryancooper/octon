...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/refine-prompt/{{run-id}}/"
  retention: session
...
- Checkpoints live in `.harmony/capabilities/runtime/skills/_ops/state/runs/refine-prompt/{{run-id}}/`.
