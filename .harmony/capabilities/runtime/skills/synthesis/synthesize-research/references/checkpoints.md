...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/synthesize-research/{{run-id}}/"
  retention: session
...
- Checkpoint files are stored under `.harmony/capabilities/runtime/skills/_ops/state/runs/synthesize-research/{{run-id}}/`.
