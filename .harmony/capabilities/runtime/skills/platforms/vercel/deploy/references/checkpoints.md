...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/vercel-deploy/{{run-id}}/"
  retention: session
...
- State is stored under `.harmony/capabilities/runtime/skills/_ops/state/runs/vercel-deploy/{{run-id}}/`.
