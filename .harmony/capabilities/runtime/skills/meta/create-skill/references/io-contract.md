...
```
.harmony/capabilities/runtime/skills/<group>/{{skill_name}}/
├── SKILL.md
├── references/
│   ├── phases.md
│   ├── io-contract.md
...
```
.harmony/capabilities/runtime/skills/_ops/state/runs/create-skill/{{run_id}}/
...
```
.claude/skills/{{skill_name}} -> ../../.harmony/capabilities/runtime/skills/<group>/{{skill_name}}
.cursor/skills/{{skill_name}} -> ../../.harmony/capabilities/runtime/skills/<group>/{{skill_name}}
.codex/skills/{{skill_name}} -> ../../.harmony/capabilities/runtime/skills/<group>/{{skill_name}}
```
...
| `Write(/.harmony/capabilities/runtime/skills/*)` | Create skill directory and files |
