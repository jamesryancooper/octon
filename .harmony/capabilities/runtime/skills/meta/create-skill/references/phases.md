...
- Create `.harmony/capabilities/runtime/skills/<group>/<skill_name>/`.
...
- Run `.harmony/capabilities/runtime/skills/_ops/scripts/validate-skills.sh <skill_name>`.
- If validation passes, run `.harmony/capabilities/runtime/skills/_ops/scripts/setup-harness-links.sh <skill_name>` to refresh host adapter links when needed.
