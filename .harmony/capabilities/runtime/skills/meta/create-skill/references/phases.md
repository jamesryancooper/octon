...
behavior:
  phases:
    ...
    - name: "Copy Template"
      steps:
        - "Create directory .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/"
...
3. **Uniqueness Check (Blocking)**
   ...
   - Read `.harmony/capabilities/runtime/skills/manifest.yml`
...
1. **Create Directory**
   ...
   ```bash
   mkdir -p .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/references
   mkdir -p .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/scripts
   mkdir -p .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/assets
   ```

2. **Copy Core Files**

   - `.harmony/capabilities/runtime/skills/_scaffold/template/SKILL.md` → `.harmony/capabilities/runtime/skills/<group>/{{skill_name}}/SKILL.md`
...
4. **Create Symlinks in Harness Folders**
   ...
   ```bash
   ln -s ../../.harmony/capabilities/runtime/skills/<group>/{{skill_name}} .claude/skills/{{skill_name}}
   ln -s ../../.harmony/capabilities/runtime/skills/<group>/{{skill_name}} .cursor/skills/{{skill_name}}
   ln -s ../../.harmony/capabilities/runtime/skills/<group>/{{skill_name}} .codex/skills/{{skill_name}}
   ```

### Verification

- Directory `.harmony/capabilities/runtime/skills/<group>/{{skill_name}}/` exists
...
1. **Add row to catalog.md**
   ...
   ```markdown
   | [{{skill_name}}](/.harmony/capabilities/runtime/skills/<group>/{{skill_name}}/SKILL.md) | `/{{skill_name}}` | [TODO: Description] |
   ```
...
1. **Display Summary**
   ...
   **Location:** `.harmony/capabilities/runtime/skills/<group>/{{skill_name}}/`
...
3. **Write Run Log**
   ...
   **Completed:** {{end-timestamp}}
   ...
   - .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/SKILL.md
   - .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/references/phases.md
   - .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/references/io-contract.md
   - .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/references/safety.md
   - .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/references/examples.md
   - .harmony/capabilities/runtime/skills/<group>/{{skill_name}}/references/validation.md
   ```
