...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/create-skill/{{run_id}}/"
  retention: session
...
- State lives in `.harmony/capabilities/runtime/skills/_ops/state/runs/create-skill/{{run_id}}/`.
