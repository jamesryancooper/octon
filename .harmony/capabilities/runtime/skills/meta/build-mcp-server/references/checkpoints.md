...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/build-mcp-server/{{run-id}}/"
  retention: session
...
- State is persisted in `.harmony/capabilities/runtime/skills/_ops/state/runs/build-mcp-server/{{run-id}}/`.
