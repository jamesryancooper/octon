...
Written to `.harmony/capabilities/runtime/skills/_ops/state/logs/build-mcp-server/{{run_id}}.md`.

### Log Index

Written to `.harmony/capabilities/runtime/skills/_ops/state/logs/build-mcp-server/index.yml`.
