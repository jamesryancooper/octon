...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/triage-ci-failure/{{run-id}}/"
  retention: session
...
- State is saved in `.harmony/capabilities/runtime/skills/_ops/state/runs/triage-ci-failure/{{run-id}}/`.
