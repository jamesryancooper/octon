...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/refactor/{{run-id}}/"
  retention: session
...
- State is stored in `.harmony/capabilities/runtime/skills/_ops/state/runs/refactor/{{run-id}}/`.
