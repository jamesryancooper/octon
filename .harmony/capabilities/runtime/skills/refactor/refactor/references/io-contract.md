...
All execution state artifacts are written to `.harmony/capabilities/runtime/skills/_ops/state/runs/refactor/{{refactor-id}}/` for session recovery:
...
Logs are written to `.harmony/capabilities/runtime/skills/_ops/state/logs/refactor/`:
