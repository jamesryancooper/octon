...
- `.harmony/capabilities/runtime/skills/_ops/state/runs/refactor/**` — Execution state (session recovery)
- `.harmony/capabilities/runtime/skills/_ops/state/logs/refactor/**` — Execution logs
