...
allowed-tools: Read Glob Grep Bash(gh *) Bash(bash .harmony/agency/_ops/scripts/ci/audit-ci-latency.sh *) Write(../../../output/reports/*) Write(_ops/state/logs/*)
---
...
- `.harmony/output/reports/YYYY-MM-DD-ci-latency-audit-<run-id>.md`
- `.harmony/output/reports/YYYY-MM-DD-ci-latency-audit-<run-id>.json`
