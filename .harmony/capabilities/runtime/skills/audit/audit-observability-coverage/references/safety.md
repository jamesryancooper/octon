...
safety:
  ...
  forbidden:
    ...
    - "Reporting coverage claims without path-level evidence"
...
2. If baseline contract reference is unreadable, attempt evidence baseline fallback and mark reduced confidence.
