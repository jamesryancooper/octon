...
Representative examples for the release-readiness-audit skill.
...
```text
/release-readiness-audit scope=".harmony/capabilities/runtime/services" deployment_artifacts_glob="**/SERVICE.md,**/compatibility.yml"
```
...
```text
/release-readiness-audit scope=".harmony" post_remediation=true severity_threshold="high" convergence_k="3"
```
