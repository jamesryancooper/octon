...
```text
/audit-operational-readiness scope=".harmony/capabilities/runtime/services" ownership_artifacts_glob="**/SERVICE.md,**/*ownership*.md"
```
...
```text
/audit-operational-readiness scope=".harmony" post_remediation=true severity_threshold="high" convergence_k="3"
```
