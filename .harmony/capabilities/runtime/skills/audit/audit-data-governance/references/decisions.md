...
decisions:
  - id: baseline-selection
    ...
    question: "Which baseline should this run use for governance intent?"
    branches:
      - condition: "classification_baseline_ref and/or privacy_baseline_ref exists and is readable"
        label: explicit_baseline
        next_phase: "Use referenced baselines for expected governance checks"
  ...
  - id: scope-discovery-strategy
    point: "Phase 1: Configure"
    question: "How are in-scope data-governance surfaces discovered?"
    branches:
...
default_path:
  [
    "Configure",
    "Classification and Retention Coverage",
    "Lineage and Contract Traceability",
    "Privacy Safeguards and Evidence Readiness",
    "Self-Challenge",
    "Report",
  ]
---
...
- Prefer explicit classification/privacy baselines when available.
