...
```text
/audit-data-governance scope=".harmony/capabilities/runtime/services" contract_artifacts_glob="**/services/**/SERVICE.md"
```
...
```text
/audit-data-governance scope=".harmony" post_remediation=true severity_threshold="high" convergence_k="3"
```
