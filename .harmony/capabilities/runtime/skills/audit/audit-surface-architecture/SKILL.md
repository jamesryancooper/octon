...
description: >
  Bounded architecture audit for one durable Harmony surface or surface unit.
...
- The target is a whole Harmony domain or a planned domain:
...
```text
/audit-surface-architecture surface_path=".harmony/capabilities/runtime/skills/audit/audit-api-contract"
```

For a methodology surface:

```text
/audit-surface-architecture surface_path=".harmony/cognition/practices/methodology/audits/README.md"
```
...
Parameters are defined in `.harmony/capabilities/runtime/skills/registry.yml`
...
Output paths are defined in `.harmony/capabilities/runtime/skills/registry.yml`
(single source of truth).

Outputs are written to:

- `.harmony/output/reports/YYYY-MM-DD-surface-architecture-audit-<run-id>.md`
- `.harmony/output/reports/audits/YYYY-MM-DD-<run-id>/`
- `_ops/state/logs/audit-surface-architecture/`
...
- `surface_path` is missing, unreadable, or outside `/.harmony/`
