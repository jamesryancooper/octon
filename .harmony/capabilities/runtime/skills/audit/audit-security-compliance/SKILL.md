...
```text
/audit-security-compliance scope=".harmony/capabilities/runtime/services"
```

With explicit baseline references:

```text
/audit-security-compliance scope=".harmony/capabilities/runtime/services" policy_baseline_ref=".harmony/assurance/practices/standards/security-and-privacy.md" control_baseline_ref=".harmony/cognition/practices/methodology/security-baseline.md"
```

With stricter threshold:

```text
/audit-security-compliance scope=".harmony" severity_threshold="high"
```
...
- `.harmony/output/reports/analysis/YYYY-MM-DD-security-compliance-audit-<run-id>.md` -- Structured findings report
- `.harmony/output/reports/audits/YYYY-MM-DD-<run-id>/` -- Authoritative bounded-audit bundle
- `_ops/state/logs/audit-security-compliance/` -- Execution logs with index
