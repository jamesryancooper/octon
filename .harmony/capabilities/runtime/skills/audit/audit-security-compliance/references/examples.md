...
```text
/audit-security-compliance scope=".harmony" policy_baseline_ref=".harmony/assurance/practices/standards/security-and-privacy.md" control_baseline_ref=".harmony/cognition/practices/methodology/security-baseline.md"
```
...
```text
/audit-security-compliance scope=".harmony/capabilities/runtime/services" post_remediation=true severity_threshold="high" convergence_k="3"
```
