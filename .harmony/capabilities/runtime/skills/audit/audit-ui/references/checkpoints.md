...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/audit-ui/{{run-id}}/"
  retention: session
...
- Checkpoints are stored in `.harmony/capabilities/runtime/skills/_ops/state/runs/audit-ui/{{run-id}}/`.
