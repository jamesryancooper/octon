...
- `Test Strategy and Coverage Topology` findings must be grounded in strategy and test-surface artifacts.
- `Contract and Integration Assurance` findings must cite contract, integration, and dependency evidence.
- `Determinism, Flake Control, and Gate Evidence` findings must cite reproducibility controls and quality-gate evidence artifacts.
