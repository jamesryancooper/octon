...
```text
/audit-test-quality scope=".harmony/capabilities/runtime/services/interfaces" contract_integration_artifacts_glob="**/contracts/**,**/compatibility.yml"
```
...
```text
/audit-test-quality scope=".harmony" post_remediation=true severity_threshold="high" convergence_k="3"
```
