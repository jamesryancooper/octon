...
```text
/audit-api-contract scope=".harmony"
```
...
```text
/audit-api-contract scope=".harmony/capabilities/runtime/services/interfaces" spec_artifacts_glob="**/contracts/**,**/schema/**/*.json"
```
...
```text
/audit-api-contract scope=".harmony" post_remediation=true severity_threshold="high" convergence_k="3"
```
