...
io:
  inputs:
    ...
    - name: contract_baseline_ref
      type: file
      required: false
      default: ".harmony/cognition/governance/principles/contract-first.md"
      description: "Primary contract-first baseline reference"
    - name: api_design_baseline_ref
      type: file
      required: false
      default: ".harmony/scaffolding/governance/patterns/api-design-guidelines.md"
  ...
  outputs:
    ...
    - name: run_log
      path: "_ops/state/logs/audit-api-contract/{{run_id}}.md"
      format: markdown
      determinism: unique
      description: "Execution log for this API-contract audit run"
    - name: log_index
      path: "_ops/state/logs/audit-api-contract/index.yml"
      format: yaml
