...
| `docs` | folder | No | `.harmony/cognition/_meta/architecture` | Companion architecture docs root for cross-reference checks |
...
- `.harmony/capabilities/runtime/skills/_ops/state/logs/audit-cross-subsystem-coherence/{{run_id}}.md`
- `.harmony/capabilities/runtime/skills/_ops/state/logs/audit-cross-subsystem-coherence/index.yml`
