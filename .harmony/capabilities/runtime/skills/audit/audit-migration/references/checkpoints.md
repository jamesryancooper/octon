...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/audit-migration/{{run-id}}/"
  retention: session
...
- Checkpoints are written under `.harmony/capabilities/runtime/skills/_ops/state/runs/audit-migration/{{run-id}}/`.
