...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/resolve-pr-comments/{{run-id}}/"
  retention: session
...
- Checkpoints are stored in `.harmony/capabilities/runtime/skills/_ops/state/runs/resolve-pr-comments/{{run-id}}/`.
