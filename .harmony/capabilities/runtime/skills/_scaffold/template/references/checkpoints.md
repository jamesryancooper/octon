...
checkpoints:
  ...
  storage: ".harmony/capabilities/runtime/skills/_ops/state/runs/{{skill-id}}/{{run-id}}/"
...
```yaml
# .harmony/capabilities/runtime/skills/_ops/state/runs/refactor/2026-01-22-scratch-to-scratchpad/checkpoint.yml
skill: refactor
version: "1.0.0"
status: in_progress
current_phase: 4
