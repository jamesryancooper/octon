...
allowed-tools: Read Glob Bash(vercel *) WebFetch Write(../../output/reports/*) Write(logs/*)
---
...
- `.harmony/capabilities/skills/logs/deploy-status/` - Execution logs and run index
