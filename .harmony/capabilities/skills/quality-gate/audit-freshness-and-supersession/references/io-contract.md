...
| `artifact_globs` | text | No | `cognition/context/**/*.md,cognition/decisions/**/*.md,output/plans/**/*.md,output/reports/**/*.md` | Comma-separated globs of artifact families |
...
- `.harmony/capabilities/skills/_ops/state/logs/audit-freshness-and-supersession/{{run_id}}.md`
- `.harmony/capabilities/skills/_ops/state/logs/audit-freshness-and-supersession/index.yml`
