...
**Subsystem**
: A self-contained component of the harness with its own config files, definition files, and conventions. Example: `.harmony/capabilities/skills/` is the skills subsystem.
