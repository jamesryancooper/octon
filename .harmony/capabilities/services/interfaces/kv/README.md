...
- `.harmony/capabilities/services/manifest.runtime.yml` - Tier 1 discovery (`interfaces/kv`).
- `.harmony/capabilities/services/registry.runtime.yml` - Tier 2 metadata (owner, risk, state path).
...
From `.harmony/capabilities/services/interfaces/kv/rust/`:
