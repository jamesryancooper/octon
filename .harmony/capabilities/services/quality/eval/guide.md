...
- **Harmony alignment:** advances governance and consistency by enforcing interoperable contracts and policy‑aware gates across services; ensures evaluable outputs before merge.
...
- **Harmony default:** Include security/static checks (**CodeQL**, **Semgrep**), license/SBOM, secret scanning, and contract tests from **Test** as required gates.
