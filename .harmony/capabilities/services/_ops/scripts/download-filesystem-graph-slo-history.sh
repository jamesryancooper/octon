#!/usr/bin/env bash
# download-filesystem-graph-slo-history.sh - fetch recent SLO summary artifacts from CI runs.

set -o pipefail

workflow="filesystem-graph-runtime.yml"
artifact_name="filesystem-graph-slo-summary"
limit="20"
out_dir=""
repo=""
allow_empty="0"
