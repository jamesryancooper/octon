...
AGENT_ONLY_POLICY_FILE="$HARMONY_DIR/capabilities/_ops/policy/agent-only-governance.yml"
AGENT_ONLY_VALIDATOR="$HARMONY_DIR/capabilities/_ops/scripts/validate-agent-only-governance.sh"
POLICY_V2_FILE="$HARMONY_DIR/capabilities/_ops/policy/deny-by-default.v2.yml"
POLICY_RUNNER="$HARMONY_DIR/capabilities/_ops/scripts/run-harmony-policy.sh"
TODAY="$(date +%F)"
