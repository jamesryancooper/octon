...
- Full markdown content deleted from `docs/services/**` has been integrated under `.harmony/capabilities/services/**`.
- Canonical references were updated from `docs/services/...` to `.harmony/capabilities/services/...` in active harness docs.
