...
```bash
bash .harmony/capabilities/services/_ops/scripts/validate-service-independence.sh [--mode <mode>]
```
...
- **Validator:** `.harmony/capabilities/services/_ops/scripts/validate-service-independence.sh`
- **Allowlist:** `.harmony/capabilities/services/_ops/state/provider-term-allowlist.tsv`
