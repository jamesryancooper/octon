...
```text
/validate-session-policy --file .harmony/capabilities/services/interfaces/agent-platform/fixtures/native-session-policy.json
```
...
- **Schema:** `.harmony/capabilities/services/interfaces/agent-platform/schema/session-policy.schema.json`
