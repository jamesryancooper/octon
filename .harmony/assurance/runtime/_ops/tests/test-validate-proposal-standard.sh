...
VALIDATE_SCRIPT=".harmony/assurance/runtime/_ops/scripts/validate-proposal-standard.sh"
...
create_fixture_repo() {
  ...
  cp "$REPO_ROOT/.harmony/assurance/runtime/_ops/scripts/validate-proposal-standard.sh" \
    "$fixture_root/.harmony/assurance/runtime/_ops/scripts/validate-proposal-standard.sh"
  printf '%s\n' "$fixture_root"
}
