...
ENGINE_POLICY_LIB="$HARMONY_DIR/engine/runtime/crates/policy_engine/src/lib.rs"
ENGINE_POLICY_CLI="$HARMONY_DIR/engine/runtime/crates/policy_engine/src/bin/policy.rs"
ENGINE_POLICY_SPEC="$HARMONY_DIR/engine/runtime/spec/policy-interface-v1.md"
CAPABILITIES_OPS_DIR="$HARMONY_DIR/capabilities/_ops/scripts"
