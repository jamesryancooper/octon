...
main() {
  ...
  local intent_schema="$HARMONY_DIR/engine/runtime/spec/intent-contract-v1.schema.json"
  local boundary_contract="$HARMONY_DIR/agency/governance/delegation-boundaries-v1.yml"
  local boundary_schema="$HARMONY_DIR/agency/governance/delegation-boundaries-v1.schema.json"
  local capability_map="$HARMONY_DIR/orchestration/governance/capability-map-v1.yml"
  local capability_map_schema="$HARMONY_DIR/orchestration/governance/capability-map-v1.schema.json"
  local policy_receipt_schema="$HARMONY_DIR/engine/runtime/spec/policy-receipt-v1.schema.json"
  local policy_interface_spec="$HARMONY_DIR/engine/runtime/spec/policy-interface-v1.md"
  local policy_file="$HARMONY_DIR/capabilities/governance/policy/deny-by-default.v2.yml"
  local receipt_writer="$HARMONY_DIR/capabilities/_ops/scripts/policy-receipt-write.sh"
