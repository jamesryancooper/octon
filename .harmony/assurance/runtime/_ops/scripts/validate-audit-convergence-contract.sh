...
METHODOLOGY_DIR="$HARMONY_DIR/cognition/practices/methodology/audits"
RUNTIME_DIR="$HARMONY_DIR/cognition/runtime/audits"
REPORTS_DIR="$HARMONY_DIR/output/reports/audits"
