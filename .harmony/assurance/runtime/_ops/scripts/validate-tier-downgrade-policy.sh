...
AUTO_TIER_DOC="$HARMONY_DIR/cognition/practices/methodology/auto-tier-assignment.md"
RISK_TIERS_DOC="$HARMONY_DIR/cognition/practices/methodology/risk-tiers.md"
CI_GATES_DOC="$HARMONY_DIR/cognition/practices/methodology/ci-cd-quality-gates.md"
