...
Add documentation explaining **why** Harmony uses documentation-based archetypes for skills, including the design rationale, pros/cons analysis, and guidance on using tags for semantic categories.
...
|----------|-------------------|---------|
| Documentation-based | "How much context to load?" | Harmony |
...
- Why this approach fits Harmony
...
- [ ] `.harmony/skills/README.md` mentions tags for semantic categories
