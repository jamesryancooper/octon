...
Related docs: [Monorepo polyglot (normative)](/.harmony/cognition/architecture/monorepo-polyglot.md), [Architecture overview](/.harmony/cognition/architecture/overview.md), [Monorepo layout](/.harmony/cognition/architecture/monorepo-layout.md), [Repository blueprint](/.harmony/cognition/architecture/repository-blueprint.md), [Tooling integration](/.harmony/cognition/architecture/tooling-integration.md), [Contracts registry](/.harmony/cognition/architecture/contracts-registry.md), [Agent roles](/.harmony/cognition/architecture/agent-roles.md), [Runtime architecture](/.harmony/cognition/architecture/runtime-architecture.md), [Runtime policy](/.harmony/cognition/architecture/runtime-policy.md)
