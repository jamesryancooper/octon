...
STATE_DIR="\${REPO_ROOT}/.git/.harmony-autonomy-hooks"
LOCK_DIR="\${STATE_DIR}/cleanup.lock"
STAMP_FILE="\${STATE_DIR}/last-run-epoch"
LOG_FILE="\${STATE_DIR}/cleanup.log"
THROTTLE_SECONDS="\${HARMONY_AUTONOMY_HOOK_THROTTLE_SECONDS:-120}"
...
main() {
  ...
  echo "[OK] Installed Harmony autonomy cleanup hooks under ${hooks_dir}."
}
