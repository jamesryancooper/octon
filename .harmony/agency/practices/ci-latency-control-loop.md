...
- Canonical Harmony workflow: `/evaluate-ci-latency`
- Shared policy: `.harmony/agency/practices/standards/ci-latency-policy.json`
- Shared wrapper: `.harmony/agency/_ops/scripts/ci/audit-ci-latency.sh`
...
- No `.harmony/orchestration/runtime/automations/*` entry yet; GitHub Actions is the periodic executor in this phase
