...
```text
/audit-domain-architecture domain_path=".octon/framework/orchestration" criteria="modularity,discoverability,coupling,operability,change-safety,testability"
```
