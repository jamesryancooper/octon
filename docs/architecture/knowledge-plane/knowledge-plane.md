...
- Manage prompts close to agent configurations initially; a dedicated prompt‑templating layer (cross‑cutting; see `docs/architecture/slices-vs-layers.md`) can be added later if prompt complexity or reuse demands it.
