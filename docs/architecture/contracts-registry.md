...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [overview](./overview.md), [repository blueprint](./repository-blueprint.md), [monorepo layout](./monorepo-layout.md), [tooling integration](./tooling-integration.md), [knowledge plane](./knowledge-plane.md)
