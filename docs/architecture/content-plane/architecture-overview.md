...
| [Continuity Plane](../continuity-plane/continuity-plane.md) | "What did we decide?" | Decisions, handoffs, progress, backlogs |
| [Knowledge Plane](../knowledge-plane/knowledge-plane.md) | "What is the system?" | Specs, contracts, code, tests, traces |

See [Three Planes Integration](../continuity-plane/three-planes-integration.md) for cross-plane architecture.
