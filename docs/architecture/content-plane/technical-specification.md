...
> **Note**: `.continuity/` is the storage location for the **Continuity Plane** — one of Harmony's three architectural planes. See [Continuity Plane](../continuity-plane/continuity-plane.md) for full specification.
...
(Cross-plane join; see [Three Planes Integration](../continuity-plane/three-planes-integration.md))
...
HCP SHOULD assume four roles aligned with the [Continuity Plane](../continuity-plane/continuity-plane.md) agent coordination model:
...
Continuity artifacts and templates exist under `.continuity/` and MUST be validated alongside Content Plane artifacts. See [Continuity Plane](../continuity-plane/continuity-plane.md) for session lifecycle and handoff protocols.
