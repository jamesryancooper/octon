...
| File | What to Add |
|------|-------------|
| `io-contract.md` | Input names, types, output paths |
| `safety.md` | Tool permissions, behavioral boundaries |
| `triggers.md` | Commands, natural language triggers |
...
### 3. Update Shared Registry

Add triggers and routing metadata to `.harmony/skills/registry.yml`:
...
- [Registry](./registry.md) — Registry format and routing
