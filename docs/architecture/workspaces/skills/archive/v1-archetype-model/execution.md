...
> **Note:** For Complex archetype skills, see [Design Conventions](./design-conventions.md) for the recommended log structure using `logs/{{skill-id}}/` with multi-level indexes.
