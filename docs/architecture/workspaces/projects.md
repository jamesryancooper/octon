...
A project is a **scaled-down workspace** for human-led exploration:
...
Projects can leverage workspace resources while maintaining human-led control.
...
Unlike a separate "promotion" workflow, projects live in the workspace so findings flow directly to their destinations.
