...
{
  "schema_version": "1.1",
  "goal": "High-level objective this workspace serves",
  "tasks": [
    {
      "id": "task-001",
...
- MUST be a single sentence describing the workspace's objective
- SHOULD be referenced when prioritizing tasks
- MAY be updated if the workspace's purpose evolves
