...
- **Decision.**
  - Create `@harmony/ui-kit` package leveraging shadcn/ui with Tailwind v4 tokens defined in `packages/config` preset.
...
- **Links.**
  - Spec: `docs/specs/shadcn-ui-kit-spec.md`.
  - Future PRs: PR1 (presets), PR2 (ui-kit bootstrap), PR3–PR9 (rollout per plan).
