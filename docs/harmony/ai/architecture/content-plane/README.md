...
**Related Planes:**
- [Continuity Plane](../continuity-plane/continuity-plane.md) — Process knowledge (decisions, handoffs)
- [Knowledge Plane](../knowledge-plane/knowledge-plane.md) — System knowledge (specs, code, tests)
- [Three Planes Integration](../continuity-plane/three-planes-integration.md) — Cross-plane architecture
...
| **Continuity Artifacts** | `.continuity/` | [Continuity Plane](../continuity-plane/continuity-plane.md) | Backlog, plans, handoffs, decisions with lifecycle rules |
| **Runtime Content** | Server DB (optional) | Content Plane (runtime) | Live overrides, personalization, session state |

> **Note**: Continuity artifacts (`.continuity/`) are managed by the Continuity Plane with specialized lifecycle rules. See [Continuity Plane](../continuity-plane/continuity-plane.md) for details on decision records, handoffs, and progress tracking.
