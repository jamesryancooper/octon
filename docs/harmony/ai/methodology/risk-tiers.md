...
For the human-facing summary, see [../../human/RISK-TIERS.md](../../human/RISK-TIERS.md).
...
|------|------|------------|----------|---------------|
| **T1** | Trivial | 2-3 min | Standard gates | Auto-mergeable with human approval |
| **T2** | Standard | 15-20 min | Standard + threat analysis + preview | Single reviewer |
| **T3** | Elevated | 30-60 min | Full analysis + staged approval | Navigator + security review |
...
| Navigator review | ✅ | Second reviewer |
...
4. **Navigator approval** (second reviewer)
...
tier_bump_down:
  ...
  requires_approval:
    from_t2_to_t1: false
    from_t3_to_t2: true  # Navigator approval
    from_t3_to_t1: true  # Navigator + security approval
```
