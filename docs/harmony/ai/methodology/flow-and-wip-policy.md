...
description: Harmony's Kanban policy for two developers, including board columns, WIP limits, tiered risk classification, and Definitions of Ready/Done/Safe/Small.
---
...
- AI-generated full spec present with:
  ...
  - Staged rollout plan
- **Spec approved by owner and navigator before build**
...
- Navigator approval (security review)
