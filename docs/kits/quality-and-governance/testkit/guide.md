...
- **Harmony alignment:** advances consistent contracts and safe trunk-based flow by gating PRs with deterministic tests; aligns with Lean AI-Accelerated gates for hexagonal boundaries.
