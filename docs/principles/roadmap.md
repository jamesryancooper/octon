...
- [x] Finalize `docs/principles.md` as production guidance (no draft status)
- [x] Reconcile `docs/principles/README.md` as the canonical index
...
|---|---|---|
| Audit and gap reconciliation | `docs/principles/README.md` (Audit Snapshot) | Completed |
| Production principles reference | `docs/principles.md` | Completed |
| Full principle index + pillar map | `docs/principles/README.md` | Completed |
| Quality attributes cross-reference | `docs/principles/README.md` | Completed |
| Methodology guarantee alignment check | `docs/principles/README.md` | Completed |
| New core guides | `docs/principles/*.md` (new files) | Completed |
| New agentic guides | `docs/principles/*.md` (new files) | Completed |
...
- Every principle listed in `docs/principles.md` has a detailed guide in `docs/principles/`.
