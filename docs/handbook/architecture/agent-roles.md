...
- Policy Compliance: checklist outcome for configured rules and guardrails.
...
- Store verification artifacts keyed by commit/PR; retain failure history to identify flakiness and trends.
